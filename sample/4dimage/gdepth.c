...
//EMAX5A begin x1 mapdist=0
  while (loop--) {                                                /* mapped to WHILE() on BR[15][0][0] stage#0 */
    ...
    mop(OP_LDUWR,  1, &BR[4][0][1], r0, (Ull)yzm_xm_m4, MSK_D0, (Ull)acci_yzm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#4 */
    mop(OP_LDUWR,  1, &BR[4][0][0], r0, (Ull)yzm_xm_p4, MSK_D0, (Ull)acci_yzm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#4 */
    mop(OP_LDUWR,  1, &BR[4][1][1], r0, (Ull)yzm_xz_m4, MSK_D0, (Ull)acci_yzm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#4 */
    mop(OP_LDUWR,  1, &BR[4][1][0], r0, (Ull)yzm_xz_p4, MSK_D0, (Ull)acci_yzm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#4 */
    mop(OP_LDUWR,  1, &BR[4][2][1], r0, (Ull)yzm_xp_m4, MSK_D0, (Ull)acci_yzm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#4 */
    mop(OP_LDUWR,  1, &BR[4][2][0], r0, (Ull)yzm_xp_p4, MSK_D0, (Ull)acci_yzm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#4 */
    ...
    mop(OP_LDUWR,  1, &BR[5][0][1], r0, (Ull)ymm_xm_m4, MSK_D0, (Ull)acci_ymm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#5 */
    mop(OP_LDUWR,  1, &BR[5][0][0], r0, (Ull)ymm_xm_p4, MSK_D0, (Ull)acci_ymm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#5 */
    mop(OP_LDUWR,  1, &BR[5][2][1], r0, (Ull)ymm_xp_m4, MSK_D0, (Ull)acci_ymm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#5 */
    mop(OP_LDUWR,  1, &BR[5][2][0], r0, (Ull)ymm_xp_p4, MSK_D0, (Ull)acci_ymm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#5 */
    ...
    mop(OP_LDUWR,  1, &BR[6][0][1], r0, (Ull)ypm_xm_m4, MSK_D0, (Ull)acci_ypm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#6 */
    mop(OP_LDUWR,  1, &BR[6][0][0], r0, (Ull)ypm_xm_p4, MSK_D0, (Ull)acci_ypm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#6 */
    mop(OP_LDUWR,  1, &BR[6][2][1], r0, (Ull)ypm_xp_m4, MSK_D0, (Ull)acci_ypm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#6 */
    mop(OP_LDUWR,  1, &BR[6][2][0], r0, (Ull)ypm_xp_p4, MSK_D0, (Ull)acci_ypm, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#6 */
    ...
    mop(OP_LDUWR,  1, &BR[7][0][1], r0, (Ull)yzz_xm_m4, MSK_D0, (Ull)acci_yzz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#7 */
    mop(OP_LDUWR,  1, &BR[7][0][0], r0, (Ull)yzz_xm_p4, MSK_D0, (Ull)acci_yzz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#7 */
    mop(OP_LDUWR,  1, &BR[7][1][1], r0, (Ull)yzz_xz_m4, MSK_D0, (Ull)acci_yzz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#7 */
    mop(OP_LDUWR,  1, &BR[7][1][0], r0, (Ull)yzz_xz_p4, MSK_D0, (Ull)acci_yzz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#7 */
    mop(OP_LDUWR,  1, &BR[7][2][1], r0, (Ull)yzz_xp_m4, MSK_D0, (Ull)acci_yzz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#7 */
    mop(OP_LDUWR,  1, &BR[7][2][0], r0, (Ull)yzz_xp_p4, MSK_D0, (Ull)acci_yzz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#7 */
    ...
    mop(OP_LDUWR,  1, &BR[8][0][1], r0, (Ull)ymz_xm_m4, MSK_D0, (Ull)acci_ymz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#8 */
    mop(OP_LDUWR,  1, &BR[8][0][0], r0, (Ull)ymz_xm_p4, MSK_D0, (Ull)acci_ymz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#8 */
    mop(OP_LDUWR,  1, &BR[8][2][1], r0, (Ull)ymz_xp_m4, MSK_D0, (Ull)acci_ymz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#8 */
    mop(OP_LDUWR,  1, &BR[8][2][0], r0, (Ull)ymz_xp_p4, MSK_D0, (Ull)acci_ymz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#8 */
    ...
    mop(OP_LDUWR,  1, &BR[9][0][1], r0, (Ull)ypz_xm_m4, MSK_D0, (Ull)acci_ypz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#9 */
    mop(OP_LDUWR,  1, &BR[9][0][0], r0, (Ull)ypz_xm_p4, MSK_D0, (Ull)acci_ypz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#9 */
    mop(OP_LDUWR,  1, &BR[9][2][1], r0, (Ull)ypz_xp_m4, MSK_D0, (Ull)acci_ypz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#9 */
    mop(OP_LDUWR,  1, &BR[9][2][0], r0, (Ull)ypz_xp_p4, MSK_D0, (Ull)acci_ypz, 7240, 0, 0, (Ull)NULL, 7240);          /* stage#9 */
    ...
    mop(OP_LDUWR,  1, &BR[10][0][1], r0, (Ull)yzp_xm_m4, MSK_D0, (Ull)acci_yzp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#10 */
    mop(OP_LDUWR,  1, &BR[10][0][0], r0, (Ull)yzp_xm_p4, MSK_D0, (Ull)acci_yzp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#10 */
    mop(OP_LDUWR,  1, &BR[10][1][1], r0, (Ull)yzp_xz_m4, MSK_D0, (Ull)acci_yzp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#10 */
    mop(OP_LDUWR,  1, &BR[10][1][0], r0, (Ull)yzp_xz_p4, MSK_D0, (Ull)acci_yzp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#10 */
    mop(OP_LDUWR,  1, &BR[10][2][1], r0, (Ull)yzp_xp_m4, MSK_D0, (Ull)acci_yzp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#10 */
    mop(OP_LDUWR,  1, &BR[10][2][0], r0, (Ull)yzp_xp_p4, MSK_D0, (Ull)acci_yzp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#10 */
    ...
    mop(OP_LDUWR,  1, &BR[11][0][1], r0, (Ull)ymp_xm_m4, MSK_D0, (Ull)acci_ymp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#11 */
    mop(OP_LDUWR,  1, &BR[11][0][0], r0, (Ull)ymp_xm_p4, MSK_D0, (Ull)acci_ymp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#11 */
    mop(OP_LDUWR,  1, &BR[11][2][1], r0, (Ull)ymp_xp_m4, MSK_D0, (Ull)acci_ymp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#11 */
    mop(OP_LDUWR,  1, &BR[11][2][0], r0, (Ull)ymp_xp_p4, MSK_D0, (Ull)acci_ymp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#11 */
    ...
    mop(OP_LDUWR,  1, &BR[12][0][1], r0, (Ull)ypp_xm_m4, MSK_D0, (Ull)acci_ypp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#12 */
    mop(OP_LDUWR,  1, &BR[12][0][0], r0, (Ull)ypp_xm_p4, MSK_D0, (Ull)acci_ypp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#12 */
    mop(OP_LDUWR,  1, &BR[12][2][1], r0, (Ull)ypp_xp_m4, MSK_D0, (Ull)acci_ypp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#12 */
    mop(OP_LDUWR,  1, &BR[12][2][0], r0, (Ull)ypp_xp_p4, MSK_D0, (Ull)acci_ypp, 7240, 0, 0, (Ull)NULL, 7240);         /* stage#12 */
    ...
    mop(OP_LDUWR,  1, &BR[15][1][1], (Ull)(sadi++), 0LL, MSK_D0, (Ull)sadi_base, 1528, 0, 1, (Ull)NULL, 1528);              /* stage#15 */
