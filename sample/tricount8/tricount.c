...
/*printf("LDRQ: data=%08.8x addr=%08.8x LDDMQ:%08.8x %08.8x %08.8x %08.8x\n", (Uint)BR[0][0][3], (Uint)(r0-1), (Uint)BR[1][1][3], (Uint)BR[1][1][2], (Uint)BR[1][1][1], (Uint)BR[1][1][0]);*/
...
/*printf("TR0 %d %08.8x %08.8x %08.8x %08.8x\n", (Uint)ex0, (Uint)r3[3], (Uint)r3[2], (Uint)r3[1], (Uint)r3[0]);*/
...
void *find_unvisited(struct param_unvisited *param)
{
  ...
  for (i=param->from; i<=param->to; i++) {
    if (!vertex[MAXVERTICES-1-i].parent) {
