...
/*@1,0*/ mop(OP_LDUBR, 1,  &BR[1][0][1],  t0[CHIP], 0,   MSK_D0, t0t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@1,0*/ mop(OP_LDUBR, 1,  &BR[1][0][0],  t0[CHIP], 1,   MSK_D0, t0t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@1,1*/ mop(OP_LDUBR, 1,  &BR[1][1][1],  t0[CHIP], 2,   MSK_D0, t0t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@1,1*/ mop(OP_LDUBR, 1,  &BR[1][1][0],  t0[CHIP], 3,   MSK_D0, t0t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@1,2*/ mop(OP_LDUBR, 1,  &BR[1][2][1],  t0[CHIP], 4,   MSK_D0, t0t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@1,2*/ mop(OP_LDUBR, 1,  &BR[1][2][0],  t0[CHIP], 5,   MSK_D0, t0t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@1,3*/ mop(OP_LDUBR, 1,  &BR[1][3][1],  t0[CHIP], 6,   MSK_D0, t0t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@1,3*/ mop(OP_LDUBR, 1,  &BR[1][3][0],  t0[CHIP], 7,   MSK_D0, t0t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
...
/*@8,0*/ mop(OP_LDUBR, 1,  &BR[8][0][1],  t1[CHIP], 0,   MSK_D0, t1t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@8,0*/ mop(OP_LDUBR, 1,  &BR[8][0][0],  t1[CHIP], 1,   MSK_D0, t1t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@8,1*/ mop(OP_LDUBR, 1,  &BR[8][1][1],  t1[CHIP], 2,   MSK_D0, t1t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@8,1*/ mop(OP_LDUBR, 1,  &BR[8][1][0],  t1[CHIP], 3,   MSK_D0, t1t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@8,2*/ mop(OP_LDUBR, 1,  &BR[8][2][1],  t1[CHIP], 4,   MSK_D0, t1t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@8,2*/ mop(OP_LDUBR, 1,  &BR[8][2][0],  t1[CHIP], 5,   MSK_D0, t1t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@8,3*/ mop(OP_LDUBR, 1,  &BR[8][3][1],  t1[CHIP], 6,   MSK_D0, t1t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@8,3*/ mop(OP_LDUBR, 1,  &BR[8][3][0],  t1[CHIP], 7,   MSK_D0, t1t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
...
/*@15,0*/mop(OP_LDUBR, 1,  &BR[15][0][1], t2[CHIP], 0,   MSK_D0, t2t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@15,0*/mop(OP_LDUBR, 1,  &BR[15][0][0], t2[CHIP], 1,   MSK_D0, t2t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@15,1*/mop(OP_LDUBR, 1,  &BR[15][1][1], t2[CHIP], 2,   MSK_D0, t2t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@15,1*/mop(OP_LDUBR, 1,  &BR[15][1][0], t2[CHIP], 3,   MSK_D0, t2t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@15,2*/mop(OP_LDUBR, 1,  &BR[15][2][1], t2[CHIP], 4,   MSK_D0, t2t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@15,2*/mop(OP_LDUBR, 1,  &BR[15][2][0], t2[CHIP], 5,   MSK_D0, t2t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@15,3*/mop(OP_LDUBR, 1,  &BR[15][3][1], t2[CHIP], 6,   MSK_D0, t2t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@15,3*/mop(OP_LDUBR, 1,  &BR[15][3][0], t2[CHIP], 7,   MSK_D0, t2t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
...
/*@22,0*/mop(OP_LDUBR, 1,  &BR[22][0][1], t3[CHIP], 0,   MSK_D0, t3t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@22,0*/mop(OP_LDUBR, 1,  &BR[22][0][0], t3[CHIP], 1,   MSK_D0, t3t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@22,1*/mop(OP_LDUBR, 1,  &BR[22][1][1], t3[CHIP], 2,   MSK_D0, t3t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@22,1*/mop(OP_LDUBR, 1,  &BR[22][1][0], t3[CHIP], 3,   MSK_D0, t3t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@22,2*/mop(OP_LDUBR, 1,  &BR[22][2][1], t3[CHIP], 4,   MSK_D0, t3t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@22,2*/mop(OP_LDUBR, 1,  &BR[22][2][0], t3[CHIP], 5,   MSK_D0, t3t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@22,3*/mop(OP_LDUBR, 1,  &BR[22][3][1], t3[CHIP], 6,   MSK_D0, t3t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@22,3*/mop(OP_LDUBR, 1,  &BR[22][3][0], t3[CHIP], 7,   MSK_D0, t3t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
...
/*@29,0*/mop(OP_LDUBR, 1,  &BR[29][0][1], t4[CHIP], 0,   MSK_D0, t4t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@29,0*/mop(OP_LDUBR, 1,  &BR[29][0][0], t4[CHIP], 1,   MSK_D0, t4t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@29,1*/mop(OP_LDUBR, 1,  &BR[29][1][1], t4[CHIP], 2,   MSK_D0, t4t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@29,1*/mop(OP_LDUBR, 1,  &BR[29][1][0], t4[CHIP], 3,   MSK_D0, t4t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@29,2*/mop(OP_LDUBR, 1,  &BR[29][2][1], t4[CHIP], 4,   MSK_D0, t4t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@29,2*/mop(OP_LDUBR, 1,  &BR[29][2][0], t4[CHIP], 5,   MSK_D0, t4t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@29,3*/mop(OP_LDUBR, 1,  &BR[29][3][1], t4[CHIP], 6,   MSK_D0, t4t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@29,3*/mop(OP_LDUBR, 1,  &BR[29][3][0], t4[CHIP], 7,   MSK_D0, t4t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
...
/*@36,0*/mop(OP_LDUBR, 1,  &BR[36][0][1], t5[CHIP], 0,   MSK_D0, t5t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@36,0*/mop(OP_LDUBR, 1,  &BR[36][0][0], t5[CHIP], 1,   MSK_D0, t5t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@36,1*/mop(OP_LDUBR, 1,  &BR[36][1][1], t5[CHIP], 2,   MSK_D0, t5t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@36,1*/mop(OP_LDUBR, 1,  &BR[36][1][0], t5[CHIP], 3,   MSK_D0, t5t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@36,2*/mop(OP_LDUBR, 1,  &BR[36][2][1], t5[CHIP], 4,   MSK_D0, t5t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@36,2*/mop(OP_LDUBR, 1,  &BR[36][2][0], t5[CHIP], 5,   MSK_D0, t5t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@36,3*/mop(OP_LDUBR, 1,  &BR[36][3][1], t5[CHIP], 6,   MSK_D0, t5t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@36,3*/mop(OP_LDUBR, 1,  &BR[36][3][0], t5[CHIP], 7,   MSK_D0, t5t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
...
/*@43,0*/mop(OP_LDUBR, 1,  &BR[43][0][1], t6[CHIP], 0,   MSK_D0, t6t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@43,0*/mop(OP_LDUBR, 1,  &BR[43][0][0], t6[CHIP], 1,   MSK_D0, t6t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@43,1*/mop(OP_LDUBR, 1,  &BR[43][1][1], t6[CHIP], 2,   MSK_D0, t6t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@43,1*/mop(OP_LDUBR, 1,  &BR[43][1][0], t6[CHIP], 3,   MSK_D0, t6t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@43,2*/mop(OP_LDUBR, 1,  &BR[43][2][1], t6[CHIP], 4,   MSK_D0, t6t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@43,2*/mop(OP_LDUBR, 1,  &BR[43][2][0], t6[CHIP], 5,   MSK_D0, t6t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@43,3*/mop(OP_LDUBR, 1,  &BR[43][3][1], t6[CHIP], 6,   MSK_D0, t6t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@43,3*/mop(OP_LDUBR, 1,  &BR[43][3][0], t6[CHIP], 7,   MSK_D0, t6t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
...
/*@50,0*/mop(OP_LDUBR, 1,  &BR[50][0][1], t7[CHIP], 0,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@50,0*/mop(OP_LDUBR, 1,  &BR[50][0][0], t7[CHIP], 1,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@50,1*/mop(OP_LDUBR, 1,  &BR[50][1][1], t7[CHIP], 2,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@50,1*/mop(OP_LDUBR, 1,  &BR[50][1][0], t7[CHIP], 3,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@50,2*/mop(OP_LDUBR, 1,  &BR[50][2][1], t7[CHIP], 4,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@50,2*/mop(OP_LDUBR, 1,  &BR[50][2][0], t7[CHIP], 5,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@50,3*/mop(OP_LDUBR, 1,  &BR[50][3][1], t7[CHIP], 6,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@50,3*/mop(OP_LDUBR, 1,  &BR[50][3][0], t7[CHIP], 7,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
...
/*@57,0*/mop(OP_LDUBR, 1,  &BR[57][0][1], t8[CHIP], 0,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@57,0*/mop(OP_LDUBR, 1,  &BR[57][0][0], t8[CHIP], 1,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@57,1*/mop(OP_LDUBR, 1,  &BR[57][1][1], t8[CHIP], 2,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@57,1*/mop(OP_LDUBR, 1,  &BR[57][1][0], t8[CHIP], 3,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@57,2*/mop(OP_LDUBR, 1,  &BR[57][2][1], t8[CHIP], 4,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@57,2*/mop(OP_LDUBR, 1,  &BR[57][2][0], t8[CHIP], 5,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@57,3*/mop(OP_LDUBR, 1,  &BR[57][3][1], t8[CHIP], 6,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
/*@57,3*/mop(OP_LDUBR, 1,  &BR[57][3][0], t8[CHIP], 7,   MSK_D0, t7t[CHIP],    dwi,  0,   0,   (Ull)NULL,  dwi);
