main()
{
  ...
  for (i=1; i<63; i++) {
    ...
    printf("\tmop(OP_LDUWR,  1, &BR[%d][0][1],  (Ull)b%02.2d0, (Ull)ofs, MSK_W0, (Ull)b%02.2d, M, 0, 0, (Ull)NULL, M);            /* stage#%d */\n", i+1, i, i, i+1);
    printf("\tmop(OP_LDUWR,  1, &BR[%d][0][0],  (Ull)b%02.2d1, (Ull)ofs, MSK_W0, (Ull)b%02.2d, M, 0, 0, (Ull)NULL, M);            /* stage#%d */\n", i+1, i, i, i+1);
    printf("\tmop(OP_LDUWR,  1, &BR[%d][1][1],  (Ull)b%02.2d2, (Ull)ofs, MSK_W0, (Ull)b%02.2d, M, 0, 0, (Ull)NULL, M);            /* stage#%d */\n", i+1, i, i, i+1);
    printf("\tmop(OP_LDUWR,  1, &BR[%d][1][0],  (Ull)b%02.2d3, (Ull)ofs, MSK_W0, (Ull)b%02.2d, M, 0, 0, (Ull)NULL, M);            /* stage#%d */\n", i+1, i, i, i+1);
    printf("\n");
  }
}
