...
/-EMAX5AS-/ for (INIT1=1,LOOP1=""8"",rofs=""0-256*4""; LOOP1--; INIT1=0) {
/-EMAX5AS-/ for (INIT0=1,LOOP0=""256 -(i+1)"",cofs=""0""; LOOP0--; INIT0=0) {
/-EMAX5AS-/ exe(0x16, &cofs, INIT0?cofs:cofs, 0, 4LL, 0, 0LL, 0, 0x01, 0x00000000ffffffffLL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x16, &rofs, rofs, 0, INIT0?256*4:0, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
...
/-EMAX5AS-/
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x1a, &cc0, l00[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[2][2][1], top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[2][0][1], d00[CHIP], oofs, 12, d00w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[2][1][1], d00[CHIP], rofs, 12, d00w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[2][0], BR[2][0][1], 0, BR[2][1][1], 0, BR[2][2][1], 0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc0, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[2][0], oofs, d00[CHIP], 14, d00w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc1, l01[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[3][2][1], top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[3][0][1], d01[CHIP], oofs, 12, d01w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[3][1][1], d01[CHIP], rofs, 12, d01w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[3][0], BR[3][0][1], 0, BR[3][1][1], 0, BR[3][2][1], 0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc1, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[3][0], oofs, d01[CHIP], 14, d01w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc0, l02[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[4][2][1], top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[4][0][1], d02[CHIP], oofs, 12, d02w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[4][1][1], d02[CHIP], rofs, 12, d02w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[4][0], BR[4][0][1], 0, BR[4][1][1], 0, BR[4][2][1], 0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc0, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[4][0], oofs, d02[CHIP], 14, d02w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc1, l03[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[5][2][1], top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[5][0][1], d03[CHIP], oofs, 12, d03w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[5][1][1], d03[CHIP], rofs, 12, d03w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[5][0], BR[5][0][1], 0, BR[5][1][1], 0, BR[5][2][1], 0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc1, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[5][0], oofs, d03[CHIP], 14, d03w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc0, l04[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[6][2][1], top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[6][0][1], d04[CHIP], oofs, 12, d04w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[6][1][1], d04[CHIP], rofs, 12, d04w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[6][0], BR[6][0][1], 0, BR[6][1][1], 0, BR[6][2][1], 0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc0, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[6][0], oofs, d04[CHIP], 14, d04w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc1, l05[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[7][2][1], top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[7][0][1], d05[CHIP], oofs, 12, d05w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[7][1][1], d05[CHIP], rofs, 12, d05w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[7][0], BR[7][0][1], 0, BR[7][1][1], 0, BR[7][2][1], 0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc1, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[7][0], oofs, d05[CHIP], 14, d05w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc0, l06[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[8][2][1], top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[8][0][1], d06[CHIP], oofs, 12, d06w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[8][1][1], d06[CHIP], rofs, 12, d06w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[8][0], BR[8][0][1], 0, BR[8][1][1], 0, BR[8][2][1], 0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc0, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[8][0], oofs, d06[CHIP], 14, d06w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc1, l07[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[9][2][1], top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[9][0][1], d07[CHIP], oofs, 12, d07w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[9][1][1], d07[CHIP], rofs, 12, d07w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[9][0], BR[9][0][1], 0, BR[9][1][1], 0, BR[9][2][1], 0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc1, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[9][0], oofs, d07[CHIP], 14, d07w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc0, l08[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[10][2][1],top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[10][0][1],d08[CHIP], oofs, 12, d08w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[10][1][1],d08[CHIP], rofs, 12, d08w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[10][0], BR[10][0][1],0, BR[10][1][1], 0, BR[10][2][1],0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc0, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[10][0], oofs, d08[CHIP], 14, d08w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc1, l09[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[11][2][1],top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[11][0][1],d09[CHIP], oofs, 12, d09w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[11][1][1],d09[CHIP], rofs, 12, d09w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[11][0], BR[11][0][1],0, BR[11][1][1], 0, BR[11][2][1],0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc1, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[11][0], oofs, d09[CHIP], 14, d09w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc0, l10[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[12][2][1],top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[12][0][1],d10[CHIP], oofs, 12, d10w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[12][1][1],d10[CHIP], rofs, 12, d10w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[12][0], BR[12][0][1],0, BR[12][1][1], 0, BR[12][2][1],0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc0, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[12][0], oofs, d10[CHIP], 14, d10w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc1, l11[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[13][2][1],top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[13][0][1],d11[CHIP], oofs, 12, d11w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[13][1][1],d11[CHIP], rofs, 12, d11w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[13][0], BR[13][0][1],0, BR[13][1][1], 0, BR[13][2][1],0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc1, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[13][0], oofs, d11[CHIP], 14, d11w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc0, l12[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[14][2][1],top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[14][0][1],d12[CHIP], oofs, 12, d12w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[14][1][1],d12[CHIP], rofs, 12, d12w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[14][0], BR[14][0][1],0, BR[14][1][1], 0, BR[14][2][1],0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc0, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[14][0], oofs, d12[CHIP], 14, d12w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc1, l13[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[15][2][1],top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[15][0][1],d13[CHIP], oofs, 12, d13w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[15][1][1],d13[CHIP], rofs, 12, d13w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[15][0], BR[15][0][1],0, BR[15][1][1], 0, BR[15][2][1],0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc1, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[15][0], oofs, d13[CHIP], 14, d13w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc0, l14[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[16][2][1],top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[16][0][1],d14[CHIP], oofs, 12, d14w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[16][1][1],d14[CHIP], rofs, 12, d14w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[16][0], BR[16][0][1],0, BR[16][1][1], 0, BR[16][2][1],0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc0, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[16][0], oofs, d14[CHIP], 14, d14w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x1a, &cc1, l15[CHIP], 0, 256, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[17][2][1],top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[17][0][1],d15[CHIP], oofs, 12, d15w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[17][1][1],d15[CHIP], rofs, 12, d15w[CHIP], len2,0, 1, ((void *)0), len2);
/-EMAX5AS-/ exe(0x11, &AR[17][0], BR[17][0][1],0, BR[17][1][1], 0, BR[17][2][1],0, 0x00, 0LL, 0x00, 0);
/-EMAX5AS-/ cex(0x01, &ex0, 0, 0, 0, cc1, 0xaaaa);
/-EMAX5AS-/ mop(0x12,ex0, &AR[17][0], oofs, d15[CHIP], 14, d15w[CHIP], len2, 0, 1, ((void *)0), len2);
/-EMAX5AS-/
/-EMAX5AS-/ }
/-EMAX5AS-/ }
/-EMAX5AS-/ }
...
/-EMAX5AB-/ inv_x2 0
/-EMAX5AS-/ for (CHIP=0; CHIP<1; CHIP++) {
/-EMAX5AS-/ for (INIT0=1,LOOP0=""jc"",cofs=""0-4""; LOOP0--; INIT0=0) {
/-EMAX5AS-/ exe(0x16, &cofs, cofs, 0, 4LL, 0, 0LL, 0, 0x01, 0x00000000ffffffffLL, 0x00, 0LL);
/-EMAX5AS-/
/-EMAX5AS-/
/-EMAX5AS-/
/-EMAX5AS-/
...
/-EMAX5AS-/
/-EMAX5AS-/
/-EMAX5AS-/ mop(OP_LDUWR, 1, &Ajk, top, cofs, 12, topw, len, 0, 0, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[1][3][1], t000[CHIP], cofs, 12, t000w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d000[CHIP], 0, 12, d000w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[1][3][1], 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d000[CHIP], 14, d000w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[2][3][1], t010[CHIP], cofs, 12, t010w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d010[CHIP], 0, 12, d010w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[2][3][1], 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d010[CHIP], 14, d010w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[3][3][1], t020[CHIP], cofs, 12, t020w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d020[CHIP], 0, 12, d020w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[3][3][1], 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d020[CHIP], 14, d020w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[4][3][1], t030[CHIP], cofs, 12, t030w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d030[CHIP], 0, 12, d030w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[4][3][1], 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d030[CHIP], 14, d030w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[5][3][1], t040[CHIP], cofs, 12, t040w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d040[CHIP], 0, 12, d040w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[5][3][1], 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d040[CHIP], 14, d040w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[6][3][1], t050[CHIP], cofs, 12, t050w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d050[CHIP], 0, 12, d050w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[6][3][1], 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d050[CHIP], 14, d050w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[7][3][1], t060[CHIP], cofs, 12, t060w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d060[CHIP], 0, 12, d060w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[7][3][1], 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d060[CHIP], 14, d060w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[8][3][1], t070[CHIP], cofs, 12, t070w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d070[CHIP], 0, 12, d070w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[8][3][1], 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d070[CHIP], 14, d070w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[9][3][1], t080[CHIP], cofs, 12, t080w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d080[CHIP], 0, 12, d080w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[9][3][1], 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d080[CHIP], 14, d080w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[10][3][1],t090[CHIP], cofs, 12, t090w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d090[CHIP], 0, 12, d090w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[10][3][1],0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d090[CHIP], 14, d090w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[11][3][1],t100[CHIP], cofs, 12, t100w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d100[CHIP], 0, 12, d100w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[11][3][1],0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d100[CHIP], 14, d100w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[12][3][1],t110[CHIP], cofs, 12, t110w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d110[CHIP], 0, 12, d110w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[12][3][1],0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d110[CHIP], 14, d110w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[13][3][1],t120[CHIP], cofs, 12, t120w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d120[CHIP], 0, 12, d120w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[13][3][1],0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d120[CHIP], 14, d120w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[14][3][1],t130[CHIP], cofs, 12, t130w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d130[CHIP], 0, 12, d130w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[14][3][1],0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d130[CHIP], 14, d130w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[15][3][1],t140[CHIP], cofs, 12, t140w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d140[CHIP], 0, 12, d140w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[15][3][1],0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d140[CHIP], 14, d140w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[16][3][1],t150[CHIP], cofs, 12, t150w[CHIP], len, 0, 1, ((void *)0), len);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &b000, d150[CHIP], 0, 12, d150w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ exe(0x11, &b000, b000, 0, Ajk, 0, BR[16][3][1],0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 1, &b000, 0, d150[CHIP], 14, d150w[CHIP], 1, 0, 1, ((void *)0), 1);
/-EMAX5AS-/ }
/-EMAX5AS-/ }
/-EMAX5AE-/
/-EMAX5AD-/
...
/-EMAX5AB-/ inv_x3 0
/-EMAX5AS-/ for (CHIP=0; CHIP<1; CHIP++) {
/-EMAX5AS-/ for (INIT0=1,LOOP0=""jc"",cofs=""jc*4""; LOOP0--; INIT0=0) {
/-EMAX5AS-/ exe(0x16, &cofs, cofs, 0, -4, 0, 0LL, 0, 0x01, 0x00000000ffffffffLL, 0x00, 0LL);
/-EMAX5AS-/
/-EMAX5AS-/
/-EMAX5AS-/
/-EMAX5AS-/
