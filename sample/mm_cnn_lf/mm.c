...
//EMAX5A begin mm mapdist=0
	...
	mop(OP_LDUWR,  1, &BR[1][0][1],  (Ull)b000, (Ull)ofs, MSK_W0, (Ull)b00, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#1 */
	mop(OP_LDUWR,  1, &BR[1][0][0],  (Ull)b001, (Ull)ofs, MSK_W0, (Ull)b00, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#1 */
	mop(OP_LDUWR,  1, &BR[1][1][1],  (Ull)b002, (Ull)ofs, MSK_W0, (Ull)b00, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#1 */
	mop(OP_LDUWR,  1, &BR[1][1][0],  (Ull)b003, (Ull)ofs, MSK_W0, (Ull)b00, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#1 */
	mop(OP_LDUWR,  1, &BR[1][2][1],  (Ull)c000, (Ull)ofs, MSK_W0, (Ull)c00, M/2, 0, 1, (Ull)NULL, M/2);            /* stage#1 */
	mop(OP_LDUWR,  1, &BR[1][2][0],  (Ull)c001, (Ull)ofs, MSK_W0, (Ull)c00, M/2, 0, 1, (Ull)NULL, M/2);            /* stage#1 */
	mop(OP_LDUWR,  1, &BR[1][3][1],  (Ull)c002, (Ull)ofs, MSK_W0, (Ull)c00, M/2, 0, 1, (Ull)NULL, M/2);            /* stage#1 */
	mop(OP_LDUWR,  1, &BR[1][3][0],  (Ull)c003, (Ull)ofs, MSK_W0, (Ull)c00, M/2, 0, 1, (Ull)NULL, M/2);            /* stage#1 */
	...
	mop(OP_LDUWR,  1, &BR[2][0][1],  (Ull)b010, (Ull)ofs, MSK_W0, (Ull)b01, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#2 */
	mop(OP_LDUWR,  1, &BR[2][0][0],  (Ull)b011, (Ull)ofs, MSK_W0, (Ull)b01, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#2 */
	mop(OP_LDUWR,  1, &BR[2][1][1],  (Ull)b012, (Ull)ofs, MSK_W0, (Ull)b01, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#2 */
	mop(OP_LDUWR,  1, &BR[2][1][0],  (Ull)b013, (Ull)ofs, MSK_W0, (Ull)b01, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#2 */
	...
	mop(OP_LDUWR,  1, &BR[3][0][1],  (Ull)b020, (Ull)ofs, MSK_W0, (Ull)b02, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#3 */
	mop(OP_LDUWR,  1, &BR[3][0][0],  (Ull)b021, (Ull)ofs, MSK_W0, (Ull)b02, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#3 */
	mop(OP_LDUWR,  1, &BR[3][1][1],  (Ull)b022, (Ull)ofs, MSK_W0, (Ull)b02, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#3 */
	mop(OP_LDUWR,  1, &BR[3][1][0],  (Ull)b023, (Ull)ofs, MSK_W0, (Ull)b02, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#3 */
	...
	mop(OP_LDUWR,  1, &BR[4][0][1],  (Ull)b030, (Ull)ofs, MSK_W0, (Ull)b03, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#4 */
	mop(OP_LDUWR,  1, &BR[4][0][0],  (Ull)b031, (Ull)ofs, MSK_W0, (Ull)b03, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#4 */
	mop(OP_LDUWR,  1, &BR[4][1][1],  (Ull)b032, (Ull)ofs, MSK_W0, (Ull)b03, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#4 */
	mop(OP_LDUWR,  1, &BR[4][1][0],  (Ull)b033, (Ull)ofs, MSK_W0, (Ull)b03, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#4 */
	...
	mop(OP_LDUWR,  1, &BR[5][0][1],  (Ull)b040, (Ull)ofs, MSK_W0, (Ull)b04, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#5 */
	mop(OP_LDUWR,  1, &BR[5][0][0],  (Ull)b041, (Ull)ofs, MSK_W0, (Ull)b04, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#5 */
	mop(OP_LDUWR,  1, &BR[5][1][1],  (Ull)b042, (Ull)ofs, MSK_W0, (Ull)b04, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#5 */
	mop(OP_LDUWR,  1, &BR[5][1][0],  (Ull)b043, (Ull)ofs, MSK_W0, (Ull)b04, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#5 */
	...
	mop(OP_LDUWR,  1, &BR[6][0][1],  (Ull)b050, (Ull)ofs, MSK_W0, (Ull)b05, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#6 */
	mop(OP_LDUWR,  1, &BR[6][0][0],  (Ull)b051, (Ull)ofs, MSK_W0, (Ull)b05, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#6 */
	mop(OP_LDUWR,  1, &BR[6][1][1],  (Ull)b052, (Ull)ofs, MSK_W0, (Ull)b05, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#6 */
	mop(OP_LDUWR,  1, &BR[6][1][0],  (Ull)b053, (Ull)ofs, MSK_W0, (Ull)b05, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#6 */
	...
	mop(OP_LDUWR,  1, &BR[7][0][1],  (Ull)b060, (Ull)ofs, MSK_W0, (Ull)b06, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#7 */
	mop(OP_LDUWR,  1, &BR[7][0][0],  (Ull)b061, (Ull)ofs, MSK_W0, (Ull)b06, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#7 */
	mop(OP_LDUWR,  1, &BR[7][1][1],  (Ull)b062, (Ull)ofs, MSK_W0, (Ull)b06, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#7 */
	mop(OP_LDUWR,  1, &BR[7][1][0],  (Ull)b063, (Ull)ofs, MSK_W0, (Ull)b06, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#7 */
	...
	mop(OP_LDUWR,  1, &BR[8][0][1],  (Ull)b070, (Ull)ofs, MSK_W0, (Ull)b07, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#8 */
	mop(OP_LDUWR,  1, &BR[8][0][0],  (Ull)b071, (Ull)ofs, MSK_W0, (Ull)b07, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#8 */
	mop(OP_LDUWR,  1, &BR[8][1][1],  (Ull)b072, (Ull)ofs, MSK_W0, (Ull)b07, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#8 */
	mop(OP_LDUWR,  1, &BR[8][1][0],  (Ull)b073, (Ull)ofs, MSK_W0, (Ull)b07, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#8 */
	...
	mop(OP_LDUWR,  1, &BR[9][0][1],  (Ull)b080, (Ull)ofs, MSK_W0, (Ull)b08, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#9 */
	mop(OP_LDUWR,  1, &BR[9][0][0],  (Ull)b081, (Ull)ofs, MSK_W0, (Ull)b08, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#9 */
	mop(OP_LDUWR,  1, &BR[9][1][1],  (Ull)b082, (Ull)ofs, MSK_W0, (Ull)b08, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#9 */
	mop(OP_LDUWR,  1, &BR[9][1][0],  (Ull)b083, (Ull)ofs, MSK_W0, (Ull)b08, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#9 */
	...
	mop(OP_LDUWR,  1, &BR[10][0][1],  (Ull)b090, (Ull)ofs, MSK_W0, (Ull)b09, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#10 */
	mop(OP_LDUWR,  1, &BR[10][0][0],  (Ull)b091, (Ull)ofs, MSK_W0, (Ull)b09, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#10 */
	mop(OP_LDUWR,  1, &BR[10][1][1],  (Ull)b092, (Ull)ofs, MSK_W0, (Ull)b09, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#10 */
	mop(OP_LDUWR,  1, &BR[10][1][0],  (Ull)b093, (Ull)ofs, MSK_W0, (Ull)b09, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#10 */
	...
	mop(OP_LDUWR,  1, &BR[11][0][1],  (Ull)b100, (Ull)ofs, MSK_W0, (Ull)b10, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#11 */
	mop(OP_LDUWR,  1, &BR[11][0][0],  (Ull)b101, (Ull)ofs, MSK_W0, (Ull)b10, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#11 */
	mop(OP_LDUWR,  1, &BR[11][1][1],  (Ull)b102, (Ull)ofs, MSK_W0, (Ull)b10, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#11 */
	mop(OP_LDUWR,  1, &BR[11][1][0],  (Ull)b103, (Ull)ofs, MSK_W0, (Ull)b10, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#11 */
	...
	mop(OP_LDUWR,  1, &BR[12][0][1],  (Ull)b110, (Ull)ofs, MSK_W0, (Ull)b11, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#12 */
	mop(OP_LDUWR,  1, &BR[12][0][0],  (Ull)b111, (Ull)ofs, MSK_W0, (Ull)b11, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#12 */
	mop(OP_LDUWR,  1, &BR[12][1][1],  (Ull)b112, (Ull)ofs, MSK_W0, (Ull)b11, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#12 */
	mop(OP_LDUWR,  1, &BR[12][1][0],  (Ull)b113, (Ull)ofs, MSK_W0, (Ull)b11, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#12 */
	...
	mop(OP_LDUWR,  1, &BR[13][0][1],  (Ull)b120, (Ull)ofs, MSK_W0, (Ull)b12, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#13 */
	mop(OP_LDUWR,  1, &BR[13][0][0],  (Ull)b121, (Ull)ofs, MSK_W0, (Ull)b12, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#13 */
	mop(OP_LDUWR,  1, &BR[13][1][1],  (Ull)b122, (Ull)ofs, MSK_W0, (Ull)b12, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#13 */
	mop(OP_LDUWR,  1, &BR[13][1][0],  (Ull)b123, (Ull)ofs, MSK_W0, (Ull)b12, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#13 */
	...
	mop(OP_LDUWR,  1, &BR[14][0][1],  (Ull)b130, (Ull)ofs, MSK_W0, (Ull)b13, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#14 */
	mop(OP_LDUWR,  1, &BR[14][0][0],  (Ull)b131, (Ull)ofs, MSK_W0, (Ull)b13, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#14 */
	mop(OP_LDUWR,  1, &BR[14][1][1],  (Ull)b132, (Ull)ofs, MSK_W0, (Ull)b13, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#14 */
	mop(OP_LDUWR,  1, &BR[14][1][0],  (Ull)b133, (Ull)ofs, MSK_W0, (Ull)b13, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#14 */
	...
	mop(OP_LDUWR,  1, &BR[15][0][1],  (Ull)b140, (Ull)ofs, MSK_W0, (Ull)b14, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#15 */
	mop(OP_LDUWR,  1, &BR[15][0][0],  (Ull)b141, (Ull)ofs, MSK_W0, (Ull)b14, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#15 */
	mop(OP_LDUWR,  1, &BR[15][1][1],  (Ull)b142, (Ull)ofs, MSK_W0, (Ull)b14, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#15 */
	mop(OP_LDUWR,  1, &BR[15][1][0],  (Ull)b143, (Ull)ofs, MSK_W0, (Ull)b14, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#15 */
	...
	mop(OP_LDUWR,  1, &BR[16][0][1],  (Ull)b150, (Ull)ofs, MSK_W0, (Ull)b15, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#16 */
	mop(OP_LDUWR,  1, &BR[16][0][0],  (Ull)b151, (Ull)ofs, MSK_W0, (Ull)b15, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#16 */
	mop(OP_LDUWR,  1, &BR[16][1][1],  (Ull)b152, (Ull)ofs, MSK_W0, (Ull)b15, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#16 */
	mop(OP_LDUWR,  1, &BR[16][1][0],  (Ull)b153, (Ull)ofs, MSK_W0, (Ull)b15, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#16 */
	...
	mop(OP_LDUWR,  1, &BR[17][0][1],  (Ull)b160, (Ull)ofs, MSK_W0, (Ull)b16, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#17 */
	mop(OP_LDUWR,  1, &BR[17][0][0],  (Ull)b161, (Ull)ofs, MSK_W0, (Ull)b16, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#17 */
	mop(OP_LDUWR,  1, &BR[17][1][1],  (Ull)b162, (Ull)ofs, MSK_W0, (Ull)b16, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#17 */
	mop(OP_LDUWR,  1, &BR[17][1][0],  (Ull)b163, (Ull)ofs, MSK_W0, (Ull)b16, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#17 */
	...
	mop(OP_LDUWR,  1, &BR[18][0][1],  (Ull)b170, (Ull)ofs, MSK_W0, (Ull)b17, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#18 */
	mop(OP_LDUWR,  1, &BR[18][0][0],  (Ull)b171, (Ull)ofs, MSK_W0, (Ull)b17, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#18 */
	mop(OP_LDUWR,  1, &BR[18][1][1],  (Ull)b172, (Ull)ofs, MSK_W0, (Ull)b17, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#18 */
	mop(OP_LDUWR,  1, &BR[18][1][0],  (Ull)b173, (Ull)ofs, MSK_W0, (Ull)b17, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#18 */
	...
	mop(OP_LDUWR,  1, &BR[19][0][1],  (Ull)b180, (Ull)ofs, MSK_W0, (Ull)b18, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#19 */
	mop(OP_LDUWR,  1, &BR[19][0][0],  (Ull)b181, (Ull)ofs, MSK_W0, (Ull)b18, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#19 */
	mop(OP_LDUWR,  1, &BR[19][1][1],  (Ull)b182, (Ull)ofs, MSK_W0, (Ull)b18, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#19 */
	mop(OP_LDUWR,  1, &BR[19][1][0],  (Ull)b183, (Ull)ofs, MSK_W0, (Ull)b18, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#19 */
	...
	mop(OP_LDUWR,  1, &BR[20][0][1],  (Ull)b190, (Ull)ofs, MSK_W0, (Ull)b19, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#20 */
	mop(OP_LDUWR,  1, &BR[20][0][0],  (Ull)b191, (Ull)ofs, MSK_W0, (Ull)b19, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#20 */
	mop(OP_LDUWR,  1, &BR[20][1][1],  (Ull)b192, (Ull)ofs, MSK_W0, (Ull)b19, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#20 */
	mop(OP_LDUWR,  1, &BR[20][1][0],  (Ull)b193, (Ull)ofs, MSK_W0, (Ull)b19, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#20 */
	...
	mop(OP_LDUWR,  1, &BR[21][0][1],  (Ull)b200, (Ull)ofs, MSK_W0, (Ull)b20, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#21 */
	mop(OP_LDUWR,  1, &BR[21][0][0],  (Ull)b201, (Ull)ofs, MSK_W0, (Ull)b20, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#21 */
	mop(OP_LDUWR,  1, &BR[21][1][1],  (Ull)b202, (Ull)ofs, MSK_W0, (Ull)b20, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#21 */
	mop(OP_LDUWR,  1, &BR[21][1][0],  (Ull)b203, (Ull)ofs, MSK_W0, (Ull)b20, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#21 */
	...
	mop(OP_LDUWR,  1, &BR[22][0][1],  (Ull)b210, (Ull)ofs, MSK_W0, (Ull)b21, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#22 */
	mop(OP_LDUWR,  1, &BR[22][0][0],  (Ull)b211, (Ull)ofs, MSK_W0, (Ull)b21, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#22 */
	mop(OP_LDUWR,  1, &BR[22][1][1],  (Ull)b212, (Ull)ofs, MSK_W0, (Ull)b21, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#22 */
	mop(OP_LDUWR,  1, &BR[22][1][0],  (Ull)b213, (Ull)ofs, MSK_W0, (Ull)b21, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#22 */
	...
	mop(OP_LDUWR,  1, &BR[23][0][1],  (Ull)b220, (Ull)ofs, MSK_W0, (Ull)b22, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#23 */
	mop(OP_LDUWR,  1, &BR[23][0][0],  (Ull)b221, (Ull)ofs, MSK_W0, (Ull)b22, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#23 */
	mop(OP_LDUWR,  1, &BR[23][1][1],  (Ull)b222, (Ull)ofs, MSK_W0, (Ull)b22, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#23 */
	mop(OP_LDUWR,  1, &BR[23][1][0],  (Ull)b223, (Ull)ofs, MSK_W0, (Ull)b22, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#23 */
	...
	mop(OP_LDUWR,  1, &BR[24][0][1],  (Ull)b230, (Ull)ofs, MSK_W0, (Ull)b23, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#24 */
	mop(OP_LDUWR,  1, &BR[24][0][0],  (Ull)b231, (Ull)ofs, MSK_W0, (Ull)b23, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#24 */
	mop(OP_LDUWR,  1, &BR[24][1][1],  (Ull)b232, (Ull)ofs, MSK_W0, (Ull)b23, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#24 */
	mop(OP_LDUWR,  1, &BR[24][1][0],  (Ull)b233, (Ull)ofs, MSK_W0, (Ull)b23, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#24 */
	...
	mop(OP_LDUWR,  1, &BR[25][0][1],  (Ull)b240, (Ull)ofs, MSK_W0, (Ull)b24, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#25 */
	mop(OP_LDUWR,  1, &BR[25][0][0],  (Ull)b241, (Ull)ofs, MSK_W0, (Ull)b24, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#25 */
	mop(OP_LDUWR,  1, &BR[25][1][1],  (Ull)b242, (Ull)ofs, MSK_W0, (Ull)b24, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#25 */
	mop(OP_LDUWR,  1, &BR[25][1][0],  (Ull)b243, (Ull)ofs, MSK_W0, (Ull)b24, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#25 */
	...
	mop(OP_LDUWR,  1, &BR[26][0][1],  (Ull)b250, (Ull)ofs, MSK_W0, (Ull)b25, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#26 */
	mop(OP_LDUWR,  1, &BR[26][0][0],  (Ull)b251, (Ull)ofs, MSK_W0, (Ull)b25, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#26 */
	mop(OP_LDUWR,  1, &BR[26][1][1],  (Ull)b252, (Ull)ofs, MSK_W0, (Ull)b25, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#26 */
	mop(OP_LDUWR,  1, &BR[26][1][0],  (Ull)b253, (Ull)ofs, MSK_W0, (Ull)b25, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#26 */
	...
	mop(OP_LDUWR,  1, &BR[27][0][1],  (Ull)b260, (Ull)ofs, MSK_W0, (Ull)b26, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#27 */
	mop(OP_LDUWR,  1, &BR[27][0][0],  (Ull)b261, (Ull)ofs, MSK_W0, (Ull)b26, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#27 */
	mop(OP_LDUWR,  1, &BR[27][1][1],  (Ull)b262, (Ull)ofs, MSK_W0, (Ull)b26, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#27 */
	mop(OP_LDUWR,  1, &BR[27][1][0],  (Ull)b263, (Ull)ofs, MSK_W0, (Ull)b26, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#27 */
	...
	mop(OP_LDUWR,  1, &BR[28][0][1],  (Ull)b270, (Ull)ofs, MSK_W0, (Ull)b27, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#28 */
	mop(OP_LDUWR,  1, &BR[28][0][0],  (Ull)b271, (Ull)ofs, MSK_W0, (Ull)b27, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#28 */
	mop(OP_LDUWR,  1, &BR[28][1][1],  (Ull)b272, (Ull)ofs, MSK_W0, (Ull)b27, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#28 */
	mop(OP_LDUWR,  1, &BR[28][1][0],  (Ull)b273, (Ull)ofs, MSK_W0, (Ull)b27, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#28 */
	...
	mop(OP_LDUWR,  1, &BR[29][0][1],  (Ull)b280, (Ull)ofs, MSK_W0, (Ull)b28, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#29 */
	mop(OP_LDUWR,  1, &BR[29][0][0],  (Ull)b281, (Ull)ofs, MSK_W0, (Ull)b28, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#29 */
	mop(OP_LDUWR,  1, &BR[29][1][1],  (Ull)b282, (Ull)ofs, MSK_W0, (Ull)b28, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#29 */
	mop(OP_LDUWR,  1, &BR[29][1][0],  (Ull)b283, (Ull)ofs, MSK_W0, (Ull)b28, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#29 */
	...
	mop(OP_LDUWR,  1, &BR[30][0][1],  (Ull)b290, (Ull)ofs, MSK_W0, (Ull)b29, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#30 */
	mop(OP_LDUWR,  1, &BR[30][0][0],  (Ull)b291, (Ull)ofs, MSK_W0, (Ull)b29, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#30 */
	mop(OP_LDUWR,  1, &BR[30][1][1],  (Ull)b292, (Ull)ofs, MSK_W0, (Ull)b29, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#30 */
	mop(OP_LDUWR,  1, &BR[30][1][0],  (Ull)b293, (Ull)ofs, MSK_W0, (Ull)b29, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#30 */
	...
	mop(OP_LDUWR,  1, &BR[31][0][1],  (Ull)b300, (Ull)ofs, MSK_W0, (Ull)b30, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#31 */
	mop(OP_LDUWR,  1, &BR[31][0][0],  (Ull)b301, (Ull)ofs, MSK_W0, (Ull)b30, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#31 */
	mop(OP_LDUWR,  1, &BR[31][1][1],  (Ull)b302, (Ull)ofs, MSK_W0, (Ull)b30, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#31 */
	mop(OP_LDUWR,  1, &BR[31][1][0],  (Ull)b303, (Ull)ofs, MSK_W0, (Ull)b30, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#31 */
	...
	mop(OP_LDUWR,  1, &BR[32][0][1],  (Ull)b310, (Ull)ofs, MSK_W0, (Ull)b31, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#32 */
	mop(OP_LDUWR,  1, &BR[32][0][0],  (Ull)b311, (Ull)ofs, MSK_W0, (Ull)b31, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#32 */
	mop(OP_LDUWR,  1, &BR[32][1][1],  (Ull)b312, (Ull)ofs, MSK_W0, (Ull)b31, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#32 */
	mop(OP_LDUWR,  1, &BR[32][1][0],  (Ull)b313, (Ull)ofs, MSK_W0, (Ull)b31, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#32 */
	...
	mop(OP_LDUWR,  1, &BR[33][0][1],  (Ull)b320, (Ull)ofs, MSK_W0, (Ull)b32, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#33 */
	mop(OP_LDUWR,  1, &BR[33][0][0],  (Ull)b321, (Ull)ofs, MSK_W0, (Ull)b32, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#33 */
	mop(OP_LDUWR,  1, &BR[33][1][1],  (Ull)b322, (Ull)ofs, MSK_W0, (Ull)b32, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#33 */
	mop(OP_LDUWR,  1, &BR[33][1][0],  (Ull)b323, (Ull)ofs, MSK_W0, (Ull)b32, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#33 */
	...
	mop(OP_LDUWR,  1, &BR[34][0][1],  (Ull)b330, (Ull)ofs, MSK_W0, (Ull)b33, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#34 */
	mop(OP_LDUWR,  1, &BR[34][0][0],  (Ull)b331, (Ull)ofs, MSK_W0, (Ull)b33, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#34 */
	mop(OP_LDUWR,  1, &BR[34][1][1],  (Ull)b332, (Ull)ofs, MSK_W0, (Ull)b33, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#34 */
	mop(OP_LDUWR,  1, &BR[34][1][0],  (Ull)b333, (Ull)ofs, MSK_W0, (Ull)b33, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#34 */
	...
	mop(OP_LDUWR,  1, &BR[35][0][1],  (Ull)b340, (Ull)ofs, MSK_W0, (Ull)b34, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#35 */
	mop(OP_LDUWR,  1, &BR[35][0][0],  (Ull)b341, (Ull)ofs, MSK_W0, (Ull)b34, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#35 */
	mop(OP_LDUWR,  1, &BR[35][1][1],  (Ull)b342, (Ull)ofs, MSK_W0, (Ull)b34, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#35 */
	mop(OP_LDUWR,  1, &BR[35][1][0],  (Ull)b343, (Ull)ofs, MSK_W0, (Ull)b34, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#35 */
	...
	mop(OP_LDUWR,  1, &BR[36][0][1],  (Ull)b350, (Ull)ofs, MSK_W0, (Ull)b35, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#36 */
	mop(OP_LDUWR,  1, &BR[36][0][0],  (Ull)b351, (Ull)ofs, MSK_W0, (Ull)b35, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#36 */
	mop(OP_LDUWR,  1, &BR[36][1][1],  (Ull)b352, (Ull)ofs, MSK_W0, (Ull)b35, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#36 */
	mop(OP_LDUWR,  1, &BR[36][1][0],  (Ull)b353, (Ull)ofs, MSK_W0, (Ull)b35, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#36 */
	...
	mop(OP_LDUWR,  1, &BR[37][0][1],  (Ull)b360, (Ull)ofs, MSK_W0, (Ull)b36, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#37 */
	mop(OP_LDUWR,  1, &BR[37][0][0],  (Ull)b361, (Ull)ofs, MSK_W0, (Ull)b36, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#37 */
	mop(OP_LDUWR,  1, &BR[37][1][1],  (Ull)b362, (Ull)ofs, MSK_W0, (Ull)b36, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#37 */
	mop(OP_LDUWR,  1, &BR[37][1][0],  (Ull)b363, (Ull)ofs, MSK_W0, (Ull)b36, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#37 */
	...
	mop(OP_LDUWR,  1, &BR[38][0][1],  (Ull)b370, (Ull)ofs, MSK_W0, (Ull)b37, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#38 */
	mop(OP_LDUWR,  1, &BR[38][0][0],  (Ull)b371, (Ull)ofs, MSK_W0, (Ull)b37, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#38 */
	mop(OP_LDUWR,  1, &BR[38][1][1],  (Ull)b372, (Ull)ofs, MSK_W0, (Ull)b37, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#38 */
	mop(OP_LDUWR,  1, &BR[38][1][0],  (Ull)b373, (Ull)ofs, MSK_W0, (Ull)b37, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#38 */
	...
	mop(OP_LDUWR,  1, &BR[39][0][1],  (Ull)b380, (Ull)ofs, MSK_W0, (Ull)b38, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#39 */
	mop(OP_LDUWR,  1, &BR[39][0][0],  (Ull)b381, (Ull)ofs, MSK_W0, (Ull)b38, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#39 */
	mop(OP_LDUWR,  1, &BR[39][1][1],  (Ull)b382, (Ull)ofs, MSK_W0, (Ull)b38, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#39 */
	mop(OP_LDUWR,  1, &BR[39][1][0],  (Ull)b383, (Ull)ofs, MSK_W0, (Ull)b38, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#39 */
	...
	mop(OP_LDUWR,  1, &BR[40][0][1],  (Ull)b390, (Ull)ofs, MSK_W0, (Ull)b39, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#40 */
	mop(OP_LDUWR,  1, &BR[40][0][0],  (Ull)b391, (Ull)ofs, MSK_W0, (Ull)b39, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#40 */
	mop(OP_LDUWR,  1, &BR[40][1][1],  (Ull)b392, (Ull)ofs, MSK_W0, (Ull)b39, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#40 */
	mop(OP_LDUWR,  1, &BR[40][1][0],  (Ull)b393, (Ull)ofs, MSK_W0, (Ull)b39, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#40 */
	...
	mop(OP_LDUWR,  1, &BR[41][0][1],  (Ull)b400, (Ull)ofs, MSK_W0, (Ull)b40, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#41 */
	mop(OP_LDUWR,  1, &BR[41][0][0],  (Ull)b401, (Ull)ofs, MSK_W0, (Ull)b40, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#41 */
	mop(OP_LDUWR,  1, &BR[41][1][1],  (Ull)b402, (Ull)ofs, MSK_W0, (Ull)b40, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#41 */
	mop(OP_LDUWR,  1, &BR[41][1][0],  (Ull)b403, (Ull)ofs, MSK_W0, (Ull)b40, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#41 */
	...
	mop(OP_LDUWR,  1, &BR[42][0][1],  (Ull)b410, (Ull)ofs, MSK_W0, (Ull)b41, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#42 */
	mop(OP_LDUWR,  1, &BR[42][0][0],  (Ull)b411, (Ull)ofs, MSK_W0, (Ull)b41, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#42 */
	mop(OP_LDUWR,  1, &BR[42][1][1],  (Ull)b412, (Ull)ofs, MSK_W0, (Ull)b41, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#42 */
	mop(OP_LDUWR,  1, &BR[42][1][0],  (Ull)b413, (Ull)ofs, MSK_W0, (Ull)b41, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#42 */
	...
	mop(OP_LDUWR,  1, &BR[43][0][1],  (Ull)b420, (Ull)ofs, MSK_W0, (Ull)b42, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#43 */
	mop(OP_LDUWR,  1, &BR[43][0][0],  (Ull)b421, (Ull)ofs, MSK_W0, (Ull)b42, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#43 */
	mop(OP_LDUWR,  1, &BR[43][1][1],  (Ull)b422, (Ull)ofs, MSK_W0, (Ull)b42, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#43 */
	mop(OP_LDUWR,  1, &BR[43][1][0],  (Ull)b423, (Ull)ofs, MSK_W0, (Ull)b42, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#43 */
	...
	mop(OP_LDUWR,  1, &BR[44][0][1],  (Ull)b430, (Ull)ofs, MSK_W0, (Ull)b43, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#44 */
	mop(OP_LDUWR,  1, &BR[44][0][0],  (Ull)b431, (Ull)ofs, MSK_W0, (Ull)b43, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#44 */
	mop(OP_LDUWR,  1, &BR[44][1][1],  (Ull)b432, (Ull)ofs, MSK_W0, (Ull)b43, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#44 */
	mop(OP_LDUWR,  1, &BR[44][1][0],  (Ull)b433, (Ull)ofs, MSK_W0, (Ull)b43, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#44 */
	...
	mop(OP_LDUWR,  1, &BR[45][0][1],  (Ull)b440, (Ull)ofs, MSK_W0, (Ull)b44, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#45 */
	mop(OP_LDUWR,  1, &BR[45][0][0],  (Ull)b441, (Ull)ofs, MSK_W0, (Ull)b44, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#45 */
	mop(OP_LDUWR,  1, &BR[45][1][1],  (Ull)b442, (Ull)ofs, MSK_W0, (Ull)b44, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#45 */
	mop(OP_LDUWR,  1, &BR[45][1][0],  (Ull)b443, (Ull)ofs, MSK_W0, (Ull)b44, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#45 */
	...
	mop(OP_LDUWR,  1, &BR[46][0][1],  (Ull)b450, (Ull)ofs, MSK_W0, (Ull)b45, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#46 */
	mop(OP_LDUWR,  1, &BR[46][0][0],  (Ull)b451, (Ull)ofs, MSK_W0, (Ull)b45, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#46 */
	mop(OP_LDUWR,  1, &BR[46][1][1],  (Ull)b452, (Ull)ofs, MSK_W0, (Ull)b45, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#46 */
	mop(OP_LDUWR,  1, &BR[46][1][0],  (Ull)b453, (Ull)ofs, MSK_W0, (Ull)b45, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#46 */
	...
	mop(OP_LDUWR,  1, &BR[47][0][1],  (Ull)b460, (Ull)ofs, MSK_W0, (Ull)b46, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#47 */
	mop(OP_LDUWR,  1, &BR[47][0][0],  (Ull)b461, (Ull)ofs, MSK_W0, (Ull)b46, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#47 */
	mop(OP_LDUWR,  1, &BR[47][1][1],  (Ull)b462, (Ull)ofs, MSK_W0, (Ull)b46, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#47 */
	mop(OP_LDUWR,  1, &BR[47][1][0],  (Ull)b463, (Ull)ofs, MSK_W0, (Ull)b46, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#47 */
	...
	mop(OP_LDUWR,  1, &BR[48][0][1],  (Ull)b470, (Ull)ofs, MSK_W0, (Ull)b47, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#48 */
	mop(OP_LDUWR,  1, &BR[48][0][0],  (Ull)b471, (Ull)ofs, MSK_W0, (Ull)b47, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#48 */
	mop(OP_LDUWR,  1, &BR[48][1][1],  (Ull)b472, (Ull)ofs, MSK_W0, (Ull)b47, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#48 */
	mop(OP_LDUWR,  1, &BR[48][1][0],  (Ull)b473, (Ull)ofs, MSK_W0, (Ull)b47, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#48 */
	...
	mop(OP_LDUWR,  1, &BR[49][0][1],  (Ull)b480, (Ull)ofs, MSK_W0, (Ull)b48, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#49 */
	mop(OP_LDUWR,  1, &BR[49][0][0],  (Ull)b481, (Ull)ofs, MSK_W0, (Ull)b48, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#49 */
	mop(OP_LDUWR,  1, &BR[49][1][1],  (Ull)b482, (Ull)ofs, MSK_W0, (Ull)b48, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#49 */
	mop(OP_LDUWR,  1, &BR[49][1][0],  (Ull)b483, (Ull)ofs, MSK_W0, (Ull)b48, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#49 */
	...
	mop(OP_LDUWR,  1, &BR[50][0][1],  (Ull)b490, (Ull)ofs, MSK_W0, (Ull)b49, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#50 */
	mop(OP_LDUWR,  1, &BR[50][0][0],  (Ull)b491, (Ull)ofs, MSK_W0, (Ull)b49, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#50 */
	mop(OP_LDUWR,  1, &BR[50][1][1],  (Ull)b492, (Ull)ofs, MSK_W0, (Ull)b49, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#50 */
	mop(OP_LDUWR,  1, &BR[50][1][0],  (Ull)b493, (Ull)ofs, MSK_W0, (Ull)b49, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#50 */
	...
	mop(OP_LDUWR,  1, &BR[51][0][1],  (Ull)b500, (Ull)ofs, MSK_W0, (Ull)b50, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#51 */
	mop(OP_LDUWR,  1, &BR[51][0][0],  (Ull)b501, (Ull)ofs, MSK_W0, (Ull)b50, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#51 */
	mop(OP_LDUWR,  1, &BR[51][1][1],  (Ull)b502, (Ull)ofs, MSK_W0, (Ull)b50, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#51 */
	mop(OP_LDUWR,  1, &BR[51][1][0],  (Ull)b503, (Ull)ofs, MSK_W0, (Ull)b50, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#51 */
	...
	mop(OP_LDUWR,  1, &BR[52][0][1],  (Ull)b510, (Ull)ofs, MSK_W0, (Ull)b51, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#52 */
	mop(OP_LDUWR,  1, &BR[52][0][0],  (Ull)b511, (Ull)ofs, MSK_W0, (Ull)b51, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#52 */
	mop(OP_LDUWR,  1, &BR[52][1][1],  (Ull)b512, (Ull)ofs, MSK_W0, (Ull)b51, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#52 */
	mop(OP_LDUWR,  1, &BR[52][1][0],  (Ull)b513, (Ull)ofs, MSK_W0, (Ull)b51, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#52 */
	...
	mop(OP_LDUWR,  1, &BR[53][0][1],  (Ull)b520, (Ull)ofs, MSK_W0, (Ull)b52, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#53 */
	mop(OP_LDUWR,  1, &BR[53][0][0],  (Ull)b521, (Ull)ofs, MSK_W0, (Ull)b52, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#53 */
	mop(OP_LDUWR,  1, &BR[53][1][1],  (Ull)b522, (Ull)ofs, MSK_W0, (Ull)b52, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#53 */
	mop(OP_LDUWR,  1, &BR[53][1][0],  (Ull)b523, (Ull)ofs, MSK_W0, (Ull)b52, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#53 */
	...
	mop(OP_LDUWR,  1, &BR[54][0][1],  (Ull)b530, (Ull)ofs, MSK_W0, (Ull)b53, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#54 */
	mop(OP_LDUWR,  1, &BR[54][0][0],  (Ull)b531, (Ull)ofs, MSK_W0, (Ull)b53, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#54 */
	mop(OP_LDUWR,  1, &BR[54][1][1],  (Ull)b532, (Ull)ofs, MSK_W0, (Ull)b53, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#54 */
	mop(OP_LDUWR,  1, &BR[54][1][0],  (Ull)b533, (Ull)ofs, MSK_W0, (Ull)b53, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#54 */
	...
	mop(OP_LDUWR,  1, &BR[55][0][1],  (Ull)b540, (Ull)ofs, MSK_W0, (Ull)b54, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#55 */
	mop(OP_LDUWR,  1, &BR[55][0][0],  (Ull)b541, (Ull)ofs, MSK_W0, (Ull)b54, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#55 */
	mop(OP_LDUWR,  1, &BR[55][1][1],  (Ull)b542, (Ull)ofs, MSK_W0, (Ull)b54, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#55 */
	mop(OP_LDUWR,  1, &BR[55][1][0],  (Ull)b543, (Ull)ofs, MSK_W0, (Ull)b54, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#55 */
	...
	mop(OP_LDUWR,  1, &BR[56][0][1],  (Ull)b550, (Ull)ofs, MSK_W0, (Ull)b55, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#56 */
	mop(OP_LDUWR,  1, &BR[56][0][0],  (Ull)b551, (Ull)ofs, MSK_W0, (Ull)b55, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#56 */
	mop(OP_LDUWR,  1, &BR[56][1][1],  (Ull)b552, (Ull)ofs, MSK_W0, (Ull)b55, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#56 */
	mop(OP_LDUWR,  1, &BR[56][1][0],  (Ull)b553, (Ull)ofs, MSK_W0, (Ull)b55, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#56 */
	...
	mop(OP_LDUWR,  1, &BR[57][0][1],  (Ull)b560, (Ull)ofs, MSK_W0, (Ull)b56, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#57 */
	mop(OP_LDUWR,  1, &BR[57][0][0],  (Ull)b561, (Ull)ofs, MSK_W0, (Ull)b56, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#57 */
	mop(OP_LDUWR,  1, &BR[57][1][1],  (Ull)b562, (Ull)ofs, MSK_W0, (Ull)b56, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#57 */
	mop(OP_LDUWR,  1, &BR[57][1][0],  (Ull)b563, (Ull)ofs, MSK_W0, (Ull)b56, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#57 */
	...
	mop(OP_LDUWR,  1, &BR[58][0][1],  (Ull)b570, (Ull)ofs, MSK_W0, (Ull)b57, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#58 */
	mop(OP_LDUWR,  1, &BR[58][0][0],  (Ull)b571, (Ull)ofs, MSK_W0, (Ull)b57, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#58 */
	mop(OP_LDUWR,  1, &BR[58][1][1],  (Ull)b572, (Ull)ofs, MSK_W0, (Ull)b57, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#58 */
	mop(OP_LDUWR,  1, &BR[58][1][0],  (Ull)b573, (Ull)ofs, MSK_W0, (Ull)b57, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#58 */
	...
	mop(OP_LDUWR,  1, &BR[59][0][1],  (Ull)b580, (Ull)ofs, MSK_W0, (Ull)b58, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#59 */
	mop(OP_LDUWR,  1, &BR[59][0][0],  (Ull)b581, (Ull)ofs, MSK_W0, (Ull)b58, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#59 */
	mop(OP_LDUWR,  1, &BR[59][1][1],  (Ull)b582, (Ull)ofs, MSK_W0, (Ull)b58, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#59 */
	mop(OP_LDUWR,  1, &BR[59][1][0],  (Ull)b583, (Ull)ofs, MSK_W0, (Ull)b58, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#59 */
	...
	mop(OP_LDUWR,  1, &BR[60][0][1],  (Ull)b590, (Ull)ofs, MSK_W0, (Ull)b59, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#60 */
	mop(OP_LDUWR,  1, &BR[60][0][0],  (Ull)b591, (Ull)ofs, MSK_W0, (Ull)b59, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#60 */
	mop(OP_LDUWR,  1, &BR[60][1][1],  (Ull)b592, (Ull)ofs, MSK_W0, (Ull)b59, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#60 */
	mop(OP_LDUWR,  1, &BR[60][1][0],  (Ull)b593, (Ull)ofs, MSK_W0, (Ull)b59, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#60 */
	...
	mop(OP_LDUWR,  1, &BR[61][0][1],  (Ull)b600, (Ull)ofs, MSK_W0, (Ull)b60, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#61 */
	mop(OP_LDUWR,  1, &BR[61][0][0],  (Ull)b601, (Ull)ofs, MSK_W0, (Ull)b60, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#61 */
	mop(OP_LDUWR,  1, &BR[61][1][1],  (Ull)b602, (Ull)ofs, MSK_W0, (Ull)b60, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#61 */
	mop(OP_LDUWR,  1, &BR[61][1][0],  (Ull)b603, (Ull)ofs, MSK_W0, (Ull)b60, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#61 */
	...
	mop(OP_LDUWR,  1, &BR[62][0][1],  (Ull)b610, (Ull)ofs, MSK_W0, (Ull)b61, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#62 */
	mop(OP_LDUWR,  1, &BR[62][0][0],  (Ull)b611, (Ull)ofs, MSK_W0, (Ull)b61, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#62 */
	mop(OP_LDUWR,  1, &BR[62][1][1],  (Ull)b612, (Ull)ofs, MSK_W0, (Ull)b61, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#62 */
	mop(OP_LDUWR,  1, &BR[62][1][0],  (Ull)b613, (Ull)ofs, MSK_W0, (Ull)b61, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#62 */
