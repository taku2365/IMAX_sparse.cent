...
#define cnn_core1(r, i, ofs, k, rp1) \
            mop(OP_LDUWR,  1, &BR[r][0][1],  (Ull)kp0[i][CHIP], ofs, MSK_D0, (Ull)ker, IC*OC*K*K, 0, 0, (Ull)NULL, IC*OC*K*K);\
            mop(OP_LDUWR,  1, &BR[r][0][0],  (Ull)kp1[i][CHIP], ofs, MSK_D0, (Ull)ker, IC*OC*K*K, 0, 0, (Ull)NULL, IC*OC*K*K);\
            mop(OP_LDUWR,  1, &BR[r][1][1],  (Ull)kp2[i][CHIP], ofs, MSK_D0, (Ull)ker, IC*OC*K*K, 0, 0, (Ull)NULL, IC*OC*K*K);\
            mop(OP_LDUWR,  1, &BR[r][1][0],  (Ull)kp3[i][CHIP], ofs, MSK_D0, (Ull)ker, IC*OC*K*K, 0, 0, (Ull)NULL, IC*OC*K*K);\
            ...
            exe(OP_FMA, &AR[rp1][0], AR[r][0], EXP_H3210, BR[r][2][0], EXP_H3210, BR[r][0][1], EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);\
            exe(OP_FMA, &AR[rp1][1], AR[r][1], EXP_H3210, BR[r][2][0], EXP_H3210, BR[r][0][0], EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);\
            exe(OP_FMA, &AR[rp1][2], AR[r][2], EXP_H3210, BR[r][2][0], EXP_H3210, BR[r][1][1], EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);\
            exe(OP_FMA, &AR[rp1][3], AR[r][3], EXP_H3210, BR[r][2][0], EXP_H3210, BR[r][1][0], EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL)
...
/-EMAX5AS-/       /*1*/ for (INIT0=1,LOOP0=""(M-2)/2"",cofs=""0-8""; LOOP0--; INIT0=0) {          /* stage#0 *//* mapped to FOR() on BR[63][0][0] */
/-EMAX5AS-/               exe(OP_ADD,    &cofs, INIT0?cofs:cofs, EXP_H3210, 8, EXP_H3210, 0LL, EXP_H3210, OP_AND, 0x00000000ffffffffLL, OP_NOP, 0LL);/* stage#0 */
...
/-EMAX5AS-/ 
/-EMAX5AS-/               mop(OP_LDUWR,  1, &BR[2][0][1],  (Ull)kp0[0][CHIP], 0LL, MSK_D0, (Ull)ker, IC*OC*K*K, 0, 0, (Ull)NULL, IC*OC*K*K); /* stage#2 */
/-EMAX5AS-/               mop(OP_LDUWR,  1, &BR[2][0][0],  (Ull)kp1[0][CHIP], 0LL, MSK_D0, (Ull)ker, IC*OC*K*K, 0, 0, (Ull)NULL, IC*OC*K*K); /* stage#2 */
/-EMAX5AS-/               mop(OP_LDUWR,  1, &BR[2][1][1],  (Ull)kp2[0][CHIP], 0LL, MSK_D0, (Ull)ker, IC*OC*K*K, 0, 0, (Ull)NULL, IC*OC*K*K); /* stage#2 */
/-EMAX5AS-/               mop(OP_LDUWR,  1, &BR[2][1][0],  (Ull)kp3[0][CHIP], 0LL, MSK_D0, (Ull)ker, IC*OC*K*K, 0, 0, (Ull)NULL, IC*OC*K*K); /* stage#2 10KB */
/-EMAX5AS-/               mop(OP_LDR,    1, &BR[2][2][1],  (Ull)ip1[0][0], oofs, MSK_W0, (Ull)it[0], M*(RMGRP+2), 0, 0, (Ull)NULL, M*(RMGRP+2)); /* stage#2 8KB *//* unaligned load */
/-EMAX5AS-/               mop(OP_LDR,    1, &BR[2][2][0],  (Ull)ip0[0][0], oofs, MSK_W0, (Ull)it[0], M*(RMGRP+2), 0, 0, (Ull)NULL, M*(RMGRP+2)); /* stage#2 8KB *//* unaligned load */
/-EMAX5AS-/               exe(OP_FML, &AR[3][0], BR[2][2][0], EXP_H3210, BR[2][0][1], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#3 */
/-EMAX5AS-/               exe(OP_FML, &AR[3][1], BR[2][2][0], EXP_H3210, BR[2][0][0], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#3 */
/-EMAX5AS-/               exe(OP_FML, &AR[3][2], BR[2][2][0], EXP_H3210, BR[2][1][1], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#3 */
/-EMAX5AS-/               exe(OP_FML, &AR[3][3], BR[2][2][0], EXP_H3210, BR[2][1][0], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#3 */
/-EMAX5AS-/ 
/-EMAX5AS-/ 	      cnn_core1( 3, 0,  4LL, 1,  4);
/-EMAX5AS-/ 	      cnn_core1( 4, 0,  8LL, 2,  5);
/-EMAX5AS-/ 	      cnn_core1( 5, 0, 12LL, 3,  6);
/-EMAX5AS-/ 	      cnn_core1( 6, 0, 16LL, 4,  7);
/-EMAX5AS-/ 	      cnn_core1( 7, 0, 20LL, 5,  8);
/-EMAX5AS-/ 	      cnn_core1( 8, 0, 24LL, 6,  9);
/-EMAX5AS-/ 	      cnn_core1( 9, 0, 28LL, 7, 10);
/-EMAX5AS-/ 	      cnn_core1(10, 0, 32LL, 8, 11);
/-EMAX5AS-/ 
/-EMAX5AS-/ 	      cnn_core1(11, 1,  0LL, 0, 12);
/-EMAX5AS-/ 	      cnn_core1(12, 1,  4LL, 1, 13);
/-EMAX5AS-/ 	      cnn_core1(13, 1,  8LL, 2, 14);
/-EMAX5AS-/ 	      cnn_core1(14, 1, 12LL, 3, 15);
/-EMAX5AS-/ 	      cnn_core1(15, 1, 16LL, 4, 16);
/-EMAX5AS-/ 	      cnn_core1(16, 1, 20LL, 5, 17);
/-EMAX5AS-/ 	      cnn_core1(17, 1, 24LL, 6, 18);
/-EMAX5AS-/ 	      cnn_core1(18, 1, 28LL, 7, 19);
/-EMAX5AS-/ 	      cnn_core1(19, 1, 32LL, 8, 20);
/-EMAX5AS-/ 
/-EMAX5AS-/ 	      cnn_core1(20, 2,  0LL, 0, 21);
/-EMAX5AS-/ 	      cnn_core1(21, 2,  4LL, 1, 22);
/-EMAX5AS-/ 	      cnn_core1(22, 2,  8LL, 2, 23);
/-EMAX5AS-/ 	      cnn_core1(23, 2, 12LL, 3, 24);
/-EMAX5AS-/ 	      cnn_core1(24, 2, 16LL, 4, 25);
/-EMAX5AS-/ 	      cnn_core1(25, 2, 20LL, 5, 26);
/-EMAX5AS-/ 	      cnn_core1(26, 2, 24LL, 6, 27);
/-EMAX5AS-/ 	      cnn_core1(27, 2, 28LL, 7, 28);
/-EMAX5AS-/ 	      cnn_core1(28, 2, 32LL, 8, 29);
/-EMAX5AS-/ 
/-EMAX5AS-/ 	      cnn_core1(29, 3,  0LL, 0, 30);
/-EMAX5AS-/ 	      cnn_core1(30, 3,  4LL, 1, 31);
/-EMAX5AS-/ 	      cnn_core1(31, 3,  8LL, 2, 32);
/-EMAX5AS-/ 	      cnn_core1(32, 3, 12LL, 3, 33);
/-EMAX5AS-/ 	      cnn_core1(33, 3, 16LL, 4, 34);
/-EMAX5AS-/ 	      cnn_core1(34, 3, 20LL, 5, 35);
/-EMAX5AS-/ 	      cnn_core1(35, 3, 24LL, 6, 36);
/-EMAX5AS-/ 	      cnn_core1(36, 3, 28LL, 7, 37);
/-EMAX5AS-/ 	      cnn_core1(37, 3, 32LL, 8, 38);
/-EMAX5AS-/ 
/-EMAX5AS-/ 	      cnn_core1(38, 4,  0LL, 0, 39);
/-EMAX5AS-/ 	      cnn_core1(39, 4,  4LL, 1, 40);
/-EMAX5AS-/ 	      cnn_core1(40, 4,  8LL, 2, 41);
/-EMAX5AS-/ 	      cnn_core1(41, 4, 12LL, 3, 42);
/-EMAX5AS-/ 	      cnn_core1(42, 4, 16LL, 4, 43);
/-EMAX5AS-/ 	      cnn_core1(43, 4, 20LL, 5, 44);
/-EMAX5AS-/ 	      cnn_core1(44, 4, 24LL, 6, 45);
/-EMAX5AS-/ 	      cnn_core1(45, 4, 28LL, 7, 46);
/-EMAX5AS-/ 	      cnn_core1(46, 4, 32LL, 8, 47);
/-EMAX5AS-/ 
/-EMAX5AS-/ 	      cnn_core1(47, 5,  0LL, 0, 48);
/-EMAX5AS-/ 	      cnn_core1(48, 5,  4LL, 1, 49);
/-EMAX5AS-/ 	      cnn_core1(49, 5,  8LL, 2, 50);
/-EMAX5AS-/ 	      cnn_core1(50, 5, 12LL, 3, 51);
/-EMAX5AS-/ 	      cnn_core1(51, 5, 16LL, 4, 52);
/-EMAX5AS-/ 	      cnn_core1(52, 5, 20LL, 5, 53);
/-EMAX5AS-/ 	      cnn_core1(53, 5, 24LL, 6, 54);
/-EMAX5AS-/ 	      cnn_core1(54, 5, 28LL, 7, 55);
/-EMAX5AS-/ 	      cnn_core1(55, 5, 32LL, 8, 56);
/-EMAX5AS-/ 
/-EMAX5AS-/ 	      /****final*****/
