...
/-EMAX5AS-/ exe(0x24, &r3, r1, 0, (Ull)14, 0, 0LL, 0, 0x02, 0LL, 0x02, 4LL);
...
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[4][0][1], r0, (Ull)ym_xm, 14, (Ull)acci_ym0[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[4][1][1], r0, (Ull)ym_xz, 14, (Ull)acci_ym0[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[4][2][1], r0, (Ull)ym_xp, 14, (Ull)acci_ym0[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x24, &r10, BR[4][0][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[4][1][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[4][2][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[4][0][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[4][1][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[4][2][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r20, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[6][0][1], r0, (Ull)yz_xm, 14, (Ull)acci_yz0[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[6][1][1], r0, (Ull)yz_xz, 14, (Ull)acci_yz0[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[6][2][1], r0, (Ull)yz_xp, 14, (Ull)acci_yz0[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x20, &r21, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r10, BR[6][0][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[6][1][1], 3, 64LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[6][2][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[6][0][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[6][1][1], 4, 64LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[6][2][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r22, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[8][0][1], r0, (Ull)yp_xm, 14, (Ull)acci_yp0[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[8][1][1], r0, (Ull)yp_xz, 14, (Ull)acci_yp0[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[8][2][1], r0, (Ull)yp_xp, 14, (Ull)acci_yp0[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x20, &r23, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r10, BR[8][0][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[8][1][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[8][2][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[8][0][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[8][1][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[8][2][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r24, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r25, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r30, r20, 0, r22, 0, r24, 0, 0x01, -1LL, 0x07, 8LL);
/-EMAX5AS-/ exe(0x20, &r31, r21, 0, r23, 0, r25, 0, 0x01, -1LL, 0x07, 8LL);
/-EMAX5AS-/ exe(0x2a, &r29, r31, 0, r30, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 3, &r29, (Ull)(acco0[CHIP]++), 0LL, 14, (Ull)acco_base0[CHIP], ((1600 -32*2)), 0, 0, (Ull)((void *)0), ((1600 -32*2)));
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x16, &r0, r1, 0, (Ull)yin1[CHIP], 0, 0LL, 0, 0x02, 0LL, 0x01, 2LL);
/-EMAX5AS-/
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[14][0][1], r0, (Ull)ym_xm, 14, (Ull)acci_ym1[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[14][1][1], r0, (Ull)ym_xz, 14, (Ull)acci_ym1[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[14][2][1], r0, (Ull)ym_xp, 14, (Ull)acci_ym1[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x24, &r10, BR[14][0][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[14][1][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[14][2][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[14][0][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[14][1][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[14][2][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r20, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[16][0][1], r0, (Ull)yz_xm, 14, (Ull)acci_yz1[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[16][1][1], r0, (Ull)yz_xz, 14, (Ull)acci_yz1[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[16][2][1], r0, (Ull)yz_xp, 14, (Ull)acci_yz1[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x20, &r21, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r10, BR[16][0][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[16][1][1], 3, 64LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[16][2][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[16][0][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[16][1][1], 4, 64LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[16][2][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r22, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[18][0][1], r0, (Ull)yp_xm, 14, (Ull)acci_yp1[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[18][1][1], r0, (Ull)yp_xz, 14, (Ull)acci_yp1[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[18][2][1], r0, (Ull)yp_xp, 14, (Ull)acci_yp1[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x20, &r23, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r10, BR[18][0][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[18][1][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[18][2][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[18][0][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[18][1][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[18][2][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r24, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r25, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r30, r20, 0, r22, 0, r24, 0, 0x01, -1LL, 0x07, 8LL);
/-EMAX5AS-/ exe(0x20, &r31, r21, 0, r23, 0, r25, 0, 0x01, -1LL, 0x07, 8LL);
/-EMAX5AS-/ exe(0x2a, &r29, r31, 0, r30, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 3, &r29, (Ull)(acco1[CHIP]++), 0LL, 14, (Ull)acco_base1[CHIP], ((1600 -32*2)), 0, 0, (Ull)((void *)0), ((1600 -32*2)));
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x16, &r0, r1, 0, (Ull)yin2[CHIP], 0, 0LL, 0, 0x02, 0LL, 0x01, 2LL);
/-EMAX5AS-/
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[24][0][1], r0, (Ull)ym_xm, 14, (Ull)acci_ym2[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[24][1][1], r0, (Ull)ym_xz, 14, (Ull)acci_ym2[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[24][2][1], r0, (Ull)ym_xp, 14, (Ull)acci_ym2[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x24, &r10, BR[24][0][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[24][1][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[24][2][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[24][0][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[24][1][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[24][2][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r20, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[26][0][1], r0, (Ull)yz_xm, 14, (Ull)acci_yz2[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[26][1][1], r0, (Ull)yz_xz, 14, (Ull)acci_yz2[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[26][2][1], r0, (Ull)yz_xp, 14, (Ull)acci_yz2[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x20, &r21, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r10, BR[26][0][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[26][1][1], 3, 64LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[26][2][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[26][0][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[26][1][1], 4, 64LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[26][2][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r22, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[28][0][1], r0, (Ull)yp_xm, 14, (Ull)acci_yp2[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[28][1][1], r0, (Ull)yp_xz, 14, (Ull)acci_yp2[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[28][2][1], r0, (Ull)yp_xp, 14, (Ull)acci_yp2[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x20, &r23, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r10, BR[28][0][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[28][1][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[28][2][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[28][0][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[28][1][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[28][2][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r24, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r25, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r30, r20, 0, r22, 0, r24, 0, 0x01, -1LL, 0x07, 8LL);
/-EMAX5AS-/ exe(0x20, &r31, r21, 0, r23, 0, r25, 0, 0x01, -1LL, 0x07, 8LL);
/-EMAX5AS-/ exe(0x2a, &r29, r31, 0, r30, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 3, &r29, (Ull)(acco2[CHIP]++), 0LL, 14, (Ull)acco_base2[CHIP], ((1600 -32*2)), 0, 0, (Ull)((void *)0), ((1600 -32*2)));
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x16, &r0, r1, 0, (Ull)yin3[CHIP], 0, 0LL, 0, 0x02, 0LL, 0x01, 2LL);
/-EMAX5AS-/
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[34][0][1], r0, (Ull)ym_xm, 14, (Ull)acci_ym3[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[34][1][1], r0, (Ull)ym_xz, 14, (Ull)acci_ym3[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[34][2][1], r0, (Ull)ym_xp, 14, (Ull)acci_ym3[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x24, &r10, BR[34][0][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[34][1][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[34][2][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[34][0][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[34][1][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[34][2][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r20, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[36][0][1], r0, (Ull)yz_xm, 14, (Ull)acci_yz3[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[36][1][1], r0, (Ull)yz_xz, 14, (Ull)acci_yz3[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[36][2][1], r0, (Ull)yz_xp, 14, (Ull)acci_yz3[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x20, &r21, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r10, BR[36][0][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[36][1][1], 3, 64LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[36][2][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[36][0][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[36][1][1], 4, 64LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[36][2][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r22, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[38][0][1], r0, (Ull)yp_xm, 14, (Ull)acci_yp3[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[38][1][1], r0, (Ull)yp_xz, 14, (Ull)acci_yp3[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[38][2][1], r0, (Ull)yp_xp, 14, (Ull)acci_yp3[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x20, &r23, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r10, BR[38][0][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[38][1][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[38][2][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[38][0][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[38][1][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[38][2][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r24, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r25, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r30, r20, 0, r22, 0, r24, 0, 0x01, -1LL, 0x07, 8LL);
/-EMAX5AS-/ exe(0x20, &r31, r21, 0, r23, 0, r25, 0, 0x01, -1LL, 0x07, 8LL);
/-EMAX5AS-/ exe(0x2a, &r29, r31, 0, r30, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 3, &r29, (Ull)(acco3[CHIP]++), 0LL, 14, (Ull)acco_base3[CHIP], ((1600 -32*2)), 0, 0, (Ull)((void *)0), ((1600 -32*2)));
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x16, &r0, r1, 0, (Ull)yin4[CHIP], 0, 0LL, 0, 0x02, 0LL, 0x01, 2LL);
/-EMAX5AS-/
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[44][0][1], r0, (Ull)ym_xm, 14, (Ull)acci_ym4[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[44][1][1], r0, (Ull)ym_xz, 14, (Ull)acci_ym4[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[44][2][1], r0, (Ull)ym_xp, 14, (Ull)acci_ym4[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x24, &r10, BR[44][0][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[44][1][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[44][2][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[44][0][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[44][1][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[44][2][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r20, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[46][0][1], r0, (Ull)yz_xm, 14, (Ull)acci_yz4[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[46][1][1], r0, (Ull)yz_xz, 14, (Ull)acci_yz4[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[46][2][1], r0, (Ull)yz_xp, 14, (Ull)acci_yz4[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x20, &r21, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r10, BR[46][0][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[46][1][1], 3, 64LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[46][2][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[46][0][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[46][1][1], 4, 64LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[46][2][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r22, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[48][0][1], r0, (Ull)yp_xm, 14, (Ull)acci_yp4[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[48][1][1], r0, (Ull)yp_xz, 14, (Ull)acci_yp4[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[48][2][1], r0, (Ull)yp_xp, 14, (Ull)acci_yp4[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x20, &r23, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r10, BR[48][0][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[48][1][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[48][2][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[48][0][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[48][1][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[48][2][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r24, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r25, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r30, r20, 0, r22, 0, r24, 0, 0x01, -1LL, 0x07, 8LL);
/-EMAX5AS-/ exe(0x20, &r31, r21, 0, r23, 0, r25, 0, 0x01, -1LL, 0x07, 8LL);
/-EMAX5AS-/ exe(0x2a, &r29, r31, 0, r30, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 3, &r29, (Ull)(acco4[CHIP]++), 0LL, 14, (Ull)acco_base4[CHIP], ((1600 -32*2)), 0, 0, (Ull)((void *)0), ((1600 -32*2)));
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x16, &r0, r1, 0, (Ull)yin5[CHIP], 0, 0LL, 0, 0x02, 0LL, 0x01, 2LL);
/-EMAX5AS-/
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[54][0][1], r0, (Ull)ym_xm, 14, (Ull)acci_ym5[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[54][1][1], r0, (Ull)ym_xz, 14, (Ull)acci_ym5[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[54][2][1], r0, (Ull)ym_xp, 14, (Ull)acci_ym5[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x24, &r10, BR[54][0][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[54][1][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[54][2][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[54][0][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[54][1][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[54][2][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r20, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[56][0][1], r0, (Ull)yz_xm, 14, (Ull)acci_yz5[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[56][1][1], r0, (Ull)yz_xz, 14, (Ull)acci_yz5[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[56][2][1], r0, (Ull)yz_xp, 14, (Ull)acci_yz5[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x20, &r21, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r10, BR[56][0][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[56][1][1], 3, 64LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[56][2][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[56][0][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[56][1][1], 4, 64LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[56][2][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r22, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[58][0][1], r0, (Ull)yp_xm, 14, (Ull)acci_yp5[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[58][1][1], r0, (Ull)yp_xz, 14, (Ull)acci_yp5[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ mop(OP_LDUWR, 1, &BR[58][2][1], r0, (Ull)yp_xp, 14, (Ull)acci_yp5[CHIP], 7500, 0, 0, (Ull)((void *)0), 7500);
/-EMAX5AS-/ exe(0x20, &r23, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r10, BR[58][0][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r11, BR[58][1][1], 3, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r12, BR[58][2][1], 3, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r13, BR[58][0][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r14, BR[58][1][1], 4, 32LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x24, &r15, BR[58][2][1], 4, 16LL, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r24, r10, 0, r11, 0, r12, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r25, r13, 0, r14, 0, r15, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ exe(0x20, &r30, r20, 0, r22, 0, r24, 0, 0x01, -1LL, 0x07, 8LL);
/-EMAX5AS-/ exe(0x20, &r31, r21, 0, r23, 0, r25, 0, 0x01, -1LL, 0x07, 8LL);
/-EMAX5AS-/ exe(0x2a, &r29, r31, 0, r30, 0, 0LL, 0, 0x00, 0LL, 0x00, 0LL);
/-EMAX5AS-/ mop(0x12, 3, &r29, (Ull)(acco5[CHIP]++), 0LL, 14, (Ull)acco_base5[CHIP], ((1600 -32*2)), 0, 0, (Ull)((void *)0), ((1600 -32*2)));
/-EMAX5AS-/ }
/-EMAX5AS-/ }
/-EMAX5AE-/
  }
