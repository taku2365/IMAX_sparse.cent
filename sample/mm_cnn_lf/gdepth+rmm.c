...
//EMAX5A begin gdepth mapdist=3
	...
	mop(OP_LDUWR,  1, &BR[4][0][1], r0, (Ull)yzm_xm_m4, MSK_D0, (Ull)acci_yzm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#4 */
	mop(OP_LDUWR,  1, &BR[4][0][0], r0, (Ull)yzm_xm_p4, MSK_D0, (Ull)acci_yzm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#4 */
	mop(OP_LDUWR,  1, &BR[4][1][1], r0, (Ull)yzm_xz_m4, MSK_D0, (Ull)acci_yzm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#4 */
	mop(OP_LDUWR,  1, &BR[4][1][0], r0, (Ull)yzm_xz_p4, MSK_D0, (Ull)acci_yzm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#4 */
	mop(OP_LDUWR,  1, &BR[4][2][1], r0, (Ull)yzm_xp_m4, MSK_D0, (Ull)acci_yzm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#4 */
	mop(OP_LDUWR,  1, &BR[4][2][0], r0, (Ull)yzm_xp_p4, MSK_D0, (Ull)acci_yzm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#4 */
	...
	mop(OP_LDUWR,  1, &BR[5][0][1], r0, (Ull)ymm_xm_m4, MSK_D0, (Ull)acci_ymm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#5 */
	mop(OP_LDUWR,  1, &BR[5][0][0], r0, (Ull)ymm_xm_p4, MSK_D0, (Ull)acci_ymm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#5 */
	mop(OP_LDUWR,  1, &BR[5][2][1], r0, (Ull)ymm_xp_m4, MSK_D0, (Ull)acci_ymm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#5 */
	mop(OP_LDUWR,  1, &BR[5][2][0], r0, (Ull)ymm_xp_p4, MSK_D0, (Ull)acci_ymm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#5 */
	...
	mop(OP_LDUWR,  1, &BR[6][0][1], r0, (Ull)ypm_xm_m4, MSK_D0, (Ull)acci_ypm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#6 */
	mop(OP_LDUWR,  1, &BR[6][0][0], r0, (Ull)ypm_xm_p4, MSK_D0, (Ull)acci_ypm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#6 */
	mop(OP_LDUWR,  1, &BR[6][2][1], r0, (Ull)ypm_xp_m4, MSK_D0, (Ull)acci_ypm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#6 */
	mop(OP_LDUWR,  1, &BR[6][2][0], r0, (Ull)ypm_xp_p4, MSK_D0, (Ull)acci_ypm0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#6 */
	...
	mop(OP_LDUWR,  1, &BR[7][0][1], r0, (Ull)yzz_xm_m4, MSK_D0, (Ull)acci_yzz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#7 */
	mop(OP_LDUWR,  1, &BR[7][0][0], r0, (Ull)yzz_xm_p4, MSK_D0, (Ull)acci_yzz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#7 */
	mop(OP_LDUWR,  1, &BR[7][1][1], r0, (Ull)yzz_xz_m4, MSK_D0, (Ull)acci_yzz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#7 */
	mop(OP_LDUWR,  1, &BR[7][1][0], r0, (Ull)yzz_xz_p4, MSK_D0, (Ull)acci_yzz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#7 */
	mop(OP_LDUWR,  1, &BR[7][2][1], r0, (Ull)yzz_xp_m4, MSK_D0, (Ull)acci_yzz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#7 */
	mop(OP_LDUWR,  1, &BR[7][2][0], r0, (Ull)yzz_xp_p4, MSK_D0, (Ull)acci_yzz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#7 */
	...
	mop(OP_LDUWR,  1, &BR[8][0][1], r0, (Ull)ymz_xm_m4, MSK_D0, (Ull)acci_ymz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#8 */
	mop(OP_LDUWR,  1, &BR[8][0][0], r0, (Ull)ymz_xm_p4, MSK_D0, (Ull)acci_ymz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#8 */
	mop(OP_LDUWR,  1, &BR[8][2][1], r0, (Ull)ymz_xp_m4, MSK_D0, (Ull)acci_ymz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#8 */
	mop(OP_LDUWR,  1, &BR[8][2][0], r0, (Ull)ymz_xp_p4, MSK_D0, (Ull)acci_ymz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#8 */
	...
	mop(OP_LDUWR,  1, &BR[9][0][1], r0, (Ull)ypz_xm_m4, MSK_D0, (Ull)acci_ypz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#9 */
	mop(OP_LDUWR,  1, &BR[9][0][0], r0, (Ull)ypz_xm_p4, MSK_D0, (Ull)acci_ypz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#9 */
	mop(OP_LDUWR,  1, &BR[9][2][1], r0, (Ull)ypz_xp_m4, MSK_D0, (Ull)acci_ypz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#9 */
	mop(OP_LDUWR,  1, &BR[9][2][0], r0, (Ull)ypz_xp_p4, MSK_D0, (Ull)acci_ypz0[CHIP], IM, 0, 0, (Ull)NULL, IM);       /* stage#9 */
	...
	mop(OP_LDUWR,  1, &BR[10][0][1], r0, (Ull)yzp_xm_m4, MSK_D0, (Ull)acci_yzp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#10 */
	mop(OP_LDUWR,  1, &BR[10][0][0], r0, (Ull)yzp_xm_p4, MSK_D0, (Ull)acci_yzp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#10 */
	mop(OP_LDUWR,  1, &BR[10][1][1], r0, (Ull)yzp_xz_m4, MSK_D0, (Ull)acci_yzp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#10 */
	mop(OP_LDUWR,  1, &BR[10][1][0], r0, (Ull)yzp_xz_p4, MSK_D0, (Ull)acci_yzp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#10 */
	mop(OP_LDUWR,  1, &BR[10][2][1], r0, (Ull)yzp_xp_m4, MSK_D0, (Ull)acci_yzp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#10 */
	mop(OP_LDUWR,  1, &BR[10][2][0], r0, (Ull)yzp_xp_p4, MSK_D0, (Ull)acci_yzp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#10 */
	...
	mop(OP_LDUWR,  1, &BR[11][0][1], r0, (Ull)ymp_xm_m4, MSK_D0, (Ull)acci_ymp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#11 */
	mop(OP_LDUWR,  1, &BR[11][0][0], r0, (Ull)ymp_xm_p4, MSK_D0, (Ull)acci_ymp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#11 */
	mop(OP_LDUWR,  1, &BR[11][2][1], r0, (Ull)ymp_xp_m4, MSK_D0, (Ull)acci_ymp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#11 */
	mop(OP_LDUWR,  1, &BR[11][2][0], r0, (Ull)ymp_xp_p4, MSK_D0, (Ull)acci_ymp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#11 */
	...
	mop(OP_LDUWR,  1, &BR[12][0][1], r0, (Ull)ypp_xm_m4, MSK_D0, (Ull)acci_ypp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#12 */
	mop(OP_LDUWR,  1, &BR[12][0][0], r0, (Ull)ypp_xm_p4, MSK_D0, (Ull)acci_ypp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#12 */
	mop(OP_LDUWR,  1, &BR[12][2][1], r0, (Ull)ypp_xp_m4, MSK_D0, (Ull)acci_ypp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#12 */
	mop(OP_LDUWR,  1, &BR[12][2][0], r0, (Ull)ypp_xp_p4, MSK_D0, (Ull)acci_ypp0[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#12 */
	...
	mop(OP_LDUWR,  1, &BR[15][1][1], (Ull)(sadi0[CHIP]++), 0LL, MSK_D0, (Ull)sadx_base0[CHIP], CRANGE, 0, 1, (Ull)NULL, CRANGE);    /* stage#15 */
	...
	/********************/
	mop(OP_LDUWR,  1, &BR[18][0][1], r0, (Ull)yzm_xm_m4, MSK_D0, (Ull)acci_yzm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#18 */
	mop(OP_LDUWR,  1, &BR[18][0][0], r0, (Ull)yzm_xm_p4, MSK_D0, (Ull)acci_yzm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#18 */
	mop(OP_LDUWR,  1, &BR[18][1][1], r0, (Ull)yzm_xz_m4, MSK_D0, (Ull)acci_yzm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#18 */
	mop(OP_LDUWR,  1, &BR[18][1][0], r0, (Ull)yzm_xz_p4, MSK_D0, (Ull)acci_yzm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#18 */
	mop(OP_LDUWR,  1, &BR[18][2][1], r0, (Ull)yzm_xp_m4, MSK_D0, (Ull)acci_yzm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#18 */
	mop(OP_LDUWR,  1, &BR[18][2][0], r0, (Ull)yzm_xp_p4, MSK_D0, (Ull)acci_yzm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#18 */
	...
	mop(OP_LDUWR,  1, &BR[19][0][1], r0, (Ull)ymm_xm_m4, MSK_D0, (Ull)acci_ymm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#19 */
	mop(OP_LDUWR,  1, &BR[19][0][0], r0, (Ull)ymm_xm_p4, MSK_D0, (Ull)acci_ymm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#19 */
	mop(OP_LDUWR,  1, &BR[19][2][1], r0, (Ull)ymm_xp_m4, MSK_D0, (Ull)acci_ymm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#19 */
	mop(OP_LDUWR,  1, &BR[19][2][0], r0, (Ull)ymm_xp_p4, MSK_D0, (Ull)acci_ymm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#19 */
	...
	mop(OP_LDUWR,  1, &BR[20][0][1], r0, (Ull)ypm_xm_m4, MSK_D0, (Ull)acci_ypm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#20 */
	mop(OP_LDUWR,  1, &BR[20][0][0], r0, (Ull)ypm_xm_p4, MSK_D0, (Ull)acci_ypm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#20 */
	mop(OP_LDUWR,  1, &BR[20][2][1], r0, (Ull)ypm_xp_m4, MSK_D0, (Ull)acci_ypm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#20 */
	mop(OP_LDUWR,  1, &BR[20][2][0], r0, (Ull)ypm_xp_p4, MSK_D0, (Ull)acci_ypm1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#20 */
	...
	mop(OP_LDUWR,  1, &BR[21][0][1], r0, (Ull)yzz_xm_m4, MSK_D0, (Ull)acci_yzz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#21 */
	mop(OP_LDUWR,  1, &BR[21][0][0], r0, (Ull)yzz_xm_p4, MSK_D0, (Ull)acci_yzz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#21 */
	mop(OP_LDUWR,  1, &BR[21][1][1], r0, (Ull)yzz_xz_m4, MSK_D0, (Ull)acci_yzz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#21 */
	mop(OP_LDUWR,  1, &BR[21][1][0], r0, (Ull)yzz_xz_p4, MSK_D0, (Ull)acci_yzz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#21 */
	mop(OP_LDUWR,  1, &BR[21][2][1], r0, (Ull)yzz_xp_m4, MSK_D0, (Ull)acci_yzz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#21 */
	mop(OP_LDUWR,  1, &BR[21][2][0], r0, (Ull)yzz_xp_p4, MSK_D0, (Ull)acci_yzz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#21 */
	...
	mop(OP_LDUWR,  1, &BR[22][0][1], r0, (Ull)ymz_xm_m4, MSK_D0, (Ull)acci_ymz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#22 */
	mop(OP_LDUWR,  1, &BR[22][0][0], r0, (Ull)ymz_xm_p4, MSK_D0, (Ull)acci_ymz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#22 */
	mop(OP_LDUWR,  1, &BR[22][2][1], r0, (Ull)ymz_xp_m4, MSK_D0, (Ull)acci_ymz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#22 */
	mop(OP_LDUWR,  1, &BR[22][2][0], r0, (Ull)ymz_xp_p4, MSK_D0, (Ull)acci_ymz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#22 */
	...
	mop(OP_LDUWR,  1, &BR[23][0][1], r0, (Ull)ypz_xm_m4, MSK_D0, (Ull)acci_ypz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#23 */
	mop(OP_LDUWR,  1, &BR[23][0][0], r0, (Ull)ypz_xm_p4, MSK_D0, (Ull)acci_ypz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#23 */
	mop(OP_LDUWR,  1, &BR[23][2][1], r0, (Ull)ypz_xp_m4, MSK_D0, (Ull)acci_ypz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#23 */
	mop(OP_LDUWR,  1, &BR[23][2][0], r0, (Ull)ypz_xp_p4, MSK_D0, (Ull)acci_ypz1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#23 */
	...
	mop(OP_LDUWR,  1, &BR[24][0][1], r0, (Ull)yzp_xm_m4, MSK_D0, (Ull)acci_yzp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#24 */
	mop(OP_LDUWR,  1, &BR[24][0][0], r0, (Ull)yzp_xm_p4, MSK_D0, (Ull)acci_yzp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#24 */
        mop(OP_LDUWR,  1, &BR[24][1][1], r0, (Ull)yzp_xz_m4, MSK_D0, (Ull)acci_yzp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#24 */
        mop(OP_LDUWR,  1, &BR[24][1][0], r0, (Ull)yzp_xz_p4, MSK_D0, (Ull)acci_yzp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#24 */
        mop(OP_LDUWR,  1, &BR[24][2][1], r0, (Ull)yzp_xp_m4, MSK_D0, (Ull)acci_yzp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#24 */
        mop(OP_LDUWR,  1, &BR[24][2][0], r0, (Ull)yzp_xp_p4, MSK_D0, (Ull)acci_yzp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#24 */
        ...
        mop(OP_LDUWR,  1, &BR[25][0][1], r0, (Ull)ymp_xm_m4, MSK_D0, (Ull)acci_ymp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#25 */
        mop(OP_LDUWR,  1, &BR[25][0][0], r0, (Ull)ymp_xm_p4, MSK_D0, (Ull)acci_ymp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#25 */
        mop(OP_LDUWR,  1, &BR[25][2][1], r0, (Ull)ymp_xp_m4, MSK_D0, (Ull)acci_ymp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#25 */
        mop(OP_LDUWR,  1, &BR[25][2][0], r0, (Ull)ymp_xp_p4, MSK_D0, (Ull)acci_ymp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#25 */
        ...
        mop(OP_LDUWR,  1, &BR[26][0][1], r0, (Ull)ypp_xm_m4, MSK_D0, (Ull)acci_ypp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#26 */
        mop(OP_LDUWR,  1, &BR[26][0][0], r0, (Ull)ypp_xm_p4, MSK_D0, (Ull)acci_ypp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#26 */
        mop(OP_LDUWR,  1, &BR[26][2][1], r0, (Ull)ypp_xp_m4, MSK_D0, (Ull)acci_ypp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#26 */
        mop(OP_LDUWR,  1, &BR[26][2][0], r0, (Ull)ypp_xp_p4, MSK_D0, (Ull)acci_ypp1[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#26 */
        ...
        mop(OP_LDUWR,  1, &BR[29][1][1], (Ull)(sadi1[CHIP]++), 0LL, MSK_D0, (Ull)sadx_base1[CHIP], CRANGE, 0, 1, (Ull)NULL, CRANGE);    /* stage#29 */
        ...
        /********************/
        mop(OP_LDUWR,  1, &BR[32][0][1], r0, (Ull)yzm_xm_m4, MSK_D0, (Ull)acci_yzm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#32 */
        mop(OP_LDUWR,  1, &BR[32][0][0], r0, (Ull)yzm_xm_p4, MSK_D0, (Ull)acci_yzm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#32 */
        mop(OP_LDUWR,  1, &BR[32][1][1], r0, (Ull)yzm_xz_m4, MSK_D0, (Ull)acci_yzm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#32 */
        mop(OP_LDUWR,  1, &BR[32][1][0], r0, (Ull)yzm_xz_p4, MSK_D0, (Ull)acci_yzm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#32 */
        mop(OP_LDUWR,  1, &BR[32][2][1], r0, (Ull)yzm_xp_m4, MSK_D0, (Ull)acci_yzm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#32 */
        mop(OP_LDUWR,  1, &BR[32][2][0], r0, (Ull)yzm_xp_p4, MSK_D0, (Ull)acci_yzm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#32 */
        ...
        mop(OP_LDUWR,  1, &BR[33][0][1], r0, (Ull)ymm_xm_m4, MSK_D0, (Ull)acci_ymm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#33 */
        mop(OP_LDUWR,  1, &BR[33][0][0], r0, (Ull)ymm_xm_p4, MSK_D0, (Ull)acci_ymm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#33 */
        mop(OP_LDUWR,  1, &BR[33][2][1], r0, (Ull)ymm_xp_m4, MSK_D0, (Ull)acci_ymm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#33 */
        mop(OP_LDUWR,  1, &BR[33][2][0], r0, (Ull)ymm_xp_p4, MSK_D0, (Ull)acci_ymm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#33 */
        ...
        mop(OP_LDUWR,  1, &BR[34][0][1], r0, (Ull)ypm_xm_m4, MSK_D0, (Ull)acci_ypm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#34 */
        mop(OP_LDUWR,  1, &BR[34][0][0], r0, (Ull)ypm_xm_p4, MSK_D0, (Ull)acci_ypm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#34 */
        mop(OP_LDUWR,  1, &BR[34][2][1], r0, (Ull)ypm_xp_m4, MSK_D0, (Ull)acci_ypm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#34 */
        mop(OP_LDUWR,  1, &BR[34][2][0], r0, (Ull)ypm_xp_p4, MSK_D0, (Ull)acci_ypm2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#34 */
        ...
        mop(OP_LDUWR,  1, &BR[35][0][1], r0, (Ull)yzz_xm_m4, MSK_D0, (Ull)acci_yzz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#35 */
        mop(OP_LDUWR,  1, &BR[35][0][0], r0, (Ull)yzz_xm_p4, MSK_D0, (Ull)acci_yzz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#35 */
        mop(OP_LDUWR,  1, &BR[35][1][1], r0, (Ull)yzz_xz_m4, MSK_D0, (Ull)acci_yzz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#35 */
        mop(OP_LDUWR,  1, &BR[35][1][0], r0, (Ull)yzz_xz_p4, MSK_D0, (Ull)acci_yzz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#35 */
        mop(OP_LDUWR,  1, &BR[35][2][1], r0, (Ull)yzz_xp_m4, MSK_D0, (Ull)acci_yzz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#35 */
        mop(OP_LDUWR,  1, &BR[35][2][0], r0, (Ull)yzz_xp_p4, MSK_D0, (Ull)acci_yzz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#35 */
        ...
        mop(OP_LDUWR,  1, &BR[36][0][1], r0, (Ull)ymz_xm_m4, MSK_D0, (Ull)acci_ymz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#36 */
        mop(OP_LDUWR,  1, &BR[36][0][0], r0, (Ull)ymz_xm_p4, MSK_D0, (Ull)acci_ymz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#36 */
        mop(OP_LDUWR,  1, &BR[36][2][1], r0, (Ull)ymz_xp_m4, MSK_D0, (Ull)acci_ymz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#36 */
        mop(OP_LDUWR,  1, &BR[36][2][0], r0, (Ull)ymz_xp_p4, MSK_D0, (Ull)acci_ymz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#36 */
        ...
        mop(OP_LDUWR,  1, &BR[37][0][1], r0, (Ull)ypz_xm_m4, MSK_D0, (Ull)acci_ypz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#37 */
        mop(OP_LDUWR,  1, &BR[37][0][0], r0, (Ull)ypz_xm_p4, MSK_D0, (Ull)acci_ypz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#37 */
        mop(OP_LDUWR,  1, &BR[37][2][1], r0, (Ull)ypz_xp_m4, MSK_D0, (Ull)acci_ypz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#37 */
        mop(OP_LDUWR,  1, &BR[37][2][0], r0, (Ull)ypz_xp_p4, MSK_D0, (Ull)acci_ypz2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#37 */
        ...
        mop(OP_LDUWR,  1, &BR[38][0][1], r0, (Ull)yzp_xm_m4, MSK_D0, (Ull)acci_yzp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#38 */
        mop(OP_LDUWR,  1, &BR[38][0][0], r0, (Ull)yzp_xm_p4, MSK_D0, (Ull)acci_yzp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#38 */
        mop(OP_LDUWR,  1, &BR[38][1][1], r0, (Ull)yzp_xz_m4, MSK_D0, (Ull)acci_yzp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#38 */
        mop(OP_LDUWR,  1, &BR[38][1][0], r0, (Ull)yzp_xz_p4, MSK_D0, (Ull)acci_yzp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#38 */
        mop(OP_LDUWR,  1, &BR[38][2][1], r0, (Ull)yzp_xp_m4, MSK_D0, (Ull)acci_yzp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#38 */
        mop(OP_LDUWR,  1, &BR[38][2][0], r0, (Ull)yzp_xp_p4, MSK_D0, (Ull)acci_yzp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#38 */
        ...
        mop(OP_LDUWR,  1, &BR[39][0][1], r0, (Ull)ymp_xm_m4, MSK_D0, (Ull)acci_ymp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#39 */
        mop(OP_LDUWR,  1, &BR[39][0][0], r0, (Ull)ymp_xm_p4, MSK_D0, (Ull)acci_ymp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#39 */
        mop(OP_LDUWR,  1, &BR[39][2][1], r0, (Ull)ymp_xp_m4, MSK_D0, (Ull)acci_ymp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#39 */
        mop(OP_LDUWR,  1, &BR[39][2][0], r0, (Ull)ymp_xp_p4, MSK_D0, (Ull)acci_ymp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#39 */
        ...
        mop(OP_LDUWR,  1, &BR[40][0][1], r0, (Ull)ypp_xm_m4, MSK_D0, (Ull)acci_ypp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#40 */
        mop(OP_LDUWR,  1, &BR[40][0][0], r0, (Ull)ypp_xm_p4, MSK_D0, (Ull)acci_ypp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#40 */
        mop(OP_LDUWR,  1, &BR[40][2][1], r0, (Ull)ypp_xp_m4, MSK_D0, (Ull)acci_ypp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#40 */
        mop(OP_LDUWR,  1, &BR[40][2][0], r0, (Ull)ypp_xp_p4, MSK_D0, (Ull)acci_ypp2[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#40 */
        ...
        mop(OP_LDUWR,  1, &BR[43][1][1], (Ull)(sadi2[CHIP]++), 0LL, MSK_D0, (Ull)sadx_base2[CHIP], CRANGE, 0, 1, (Ull)NULL, CRANGE);    /* stage#43 */
        ...
        /********************/
        mop(OP_LDUWR,  1, &BR[46][0][1], r0, (Ull)yzm_xm_m4, MSK_D0, (Ull)acci_yzm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#46 */
        mop(OP_LDUWR,  1, &BR[46][0][0], r0, (Ull)yzm_xm_p4, MSK_D0, (Ull)acci_yzm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#46 */
        mop(OP_LDUWR,  1, &BR[46][1][1], r0, (Ull)yzm_xz_m4, MSK_D0, (Ull)acci_yzm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#46 */
        mop(OP_LDUWR,  1, &BR[46][1][0], r0, (Ull)yzm_xz_p4, MSK_D0, (Ull)acci_yzm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#46 */
        mop(OP_LDUWR,  1, &BR[46][2][1], r0, (Ull)yzm_xp_m4, MSK_D0, (Ull)acci_yzm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#46 */
        mop(OP_LDUWR,  1, &BR[46][2][0], r0, (Ull)yzm_xp_p4, MSK_D0, (Ull)acci_yzm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#46 */
        ...
        mop(OP_LDUWR,  1, &BR[47][0][1], r0, (Ull)ymm_xm_m4, MSK_D0, (Ull)acci_ymm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#47 */
        mop(OP_LDUWR,  1, &BR[47][0][0], r0, (Ull)ymm_xm_p4, MSK_D0, (Ull)acci_ymm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#47 */
        mop(OP_LDUWR,  1, &BR[47][2][1], r0, (Ull)ymm_xp_m4, MSK_D0, (Ull)acci_ymm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#47 */
        mop(OP_LDUWR,  1, &BR[47][2][0], r0, (Ull)ymm_xp_p4, MSK_D0, (Ull)acci_ymm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#47 */
        ...
        mop(OP_LDUWR,  1, &BR[48][0][1], r0, (Ull)ypm_xm_m4, MSK_D0, (Ull)acci_ypm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#48 */
        mop(OP_LDUWR,  1, &BR[48][0][0], r0, (Ull)ypm_xm_p4, MSK_D0, (Ull)acci_ypm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#48 */
        mop(OP_LDUWR,  1, &BR[48][2][1], r0, (Ull)ypm_xp_m4, MSK_D0, (Ull)acci_ypm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#48 */
        mop(OP_LDUWR,  1, &BR[48][2][0], r0, (Ull)ypm_xp_p4, MSK_D0, (Ull)acci_ypm3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#48 */
        ...
        mop(OP_LDUWR,  1, &BR[49][0][1], r0, (Ull)yzz_xm_m4, MSK_D0, (Ull)acci_yzz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#49 */
        mop(OP_LDUWR,  1, &BR[49][0][0], r0, (Ull)yzz_xm_p4, MSK_D0, (Ull)acci_yzz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#49 */
        mop(OP_LDUWR,  1, &BR[49][1][1], r0, (Ull)yzz_xz_m4, MSK_D0, (Ull)acci_yzz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#49 */
        mop(OP_LDUWR,  1, &BR[49][1][0], r0, (Ull)yzz_xz_p4, MSK_D0, (Ull)acci_yzz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#49 */
        mop(OP_LDUWR,  1, &BR[49][2][1], r0, (Ull)yzz_xp_m4, MSK_D0, (Ull)acci_yzz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#49 */
        mop(OP_LDUWR,  1, &BR[49][2][0], r0, (Ull)yzz_xp_p4, MSK_D0, (Ull)acci_yzz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#49 */
        ...
        mop(OP_LDUWR,  1, &BR[50][0][1], r0, (Ull)ymz_xm_m4, MSK_D0, (Ull)acci_ymz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#50 */
        mop(OP_LDUWR,  1, &BR[50][0][0], r0, (Ull)ymz_xm_p4, MSK_D0, (Ull)acci_ymz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#50 */
        mop(OP_LDUWR,  1, &BR[50][2][1], r0, (Ull)ymz_xp_m4, MSK_D0, (Ull)acci_ymz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#50 */
        mop(OP_LDUWR,  1, &BR[50][2][0], r0, (Ull)ymz_xp_p4, MSK_D0, (Ull)acci_ymz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#50 */
        ...
        mop(OP_LDUWR,  1, &BR[51][0][1], r0, (Ull)ypz_xm_m4, MSK_D0, (Ull)acci_ypz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#51 */
        mop(OP_LDUWR,  1, &BR[51][0][0], r0, (Ull)ypz_xm_p4, MSK_D0, (Ull)acci_ypz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#51 */
        mop(OP_LDUWR,  1, &BR[51][2][1], r0, (Ull)ypz_xp_m4, MSK_D0, (Ull)acci_ypz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#51 */
        mop(OP_LDUWR,  1, &BR[51][2][0], r0, (Ull)ypz_xp_p4, MSK_D0, (Ull)acci_ypz3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#51 */
        ...
        mop(OP_LDUWR,  1, &BR[52][0][1], r0, (Ull)yzp_xm_m4, MSK_D0, (Ull)acci_yzp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#52 */
        mop(OP_LDUWR,  1, &BR[52][0][0], r0, (Ull)yzp_xm_p4, MSK_D0, (Ull)acci_yzp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#52 */
        mop(OP_LDUWR,  1, &BR[52][1][1], r0, (Ull)yzp_xz_m4, MSK_D0, (Ull)acci_yzp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#52 */
        mop(OP_LDUWR,  1, &BR[52][1][0], r0, (Ull)yzp_xz_p4, MSK_D0, (Ull)acci_yzp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#52 */
        mop(OP_LDUWR,  1, &BR[52][2][1], r0, (Ull)yzp_xp_m4, MSK_D0, (Ull)acci_yzp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#52 */
        mop(OP_LDUWR,  1, &BR[52][2][0], r0, (Ull)yzp_xp_p4, MSK_D0, (Ull)acci_yzp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#52 */
        ...
        mop(OP_LDUWR,  1, &BR[53][0][1], r0, (Ull)ymp_xm_m4, MSK_D0, (Ull)acci_ymp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#53 */
        mop(OP_LDUWR,  1, &BR[53][0][0], r0, (Ull)ymp_xm_p4, MSK_D0, (Ull)acci_ymp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#53 */
        mop(OP_LDUWR,  1, &BR[53][2][1], r0, (Ull)ymp_xp_m4, MSK_D0, (Ull)acci_ymp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#53 */
        mop(OP_LDUWR,  1, &BR[53][2][0], r0, (Ull)ymp_xp_p4, MSK_D0, (Ull)acci_ymp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#53 */
        ...
        mop(OP_LDUWR,  1, &BR[54][0][1], r0, (Ull)ypp_xm_m4, MSK_D0, (Ull)acci_ypp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#54 */
        mop(OP_LDUWR,  1, &BR[54][0][0], r0, (Ull)ypp_xm_p4, MSK_D0, (Ull)acci_ypp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#54 */
        mop(OP_LDUWR,  1, &BR[54][2][1], r0, (Ull)ypp_xp_m4, MSK_D0, (Ull)acci_ypp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#54 */
        mop(OP_LDUWR,  1, &BR[54][2][0], r0, (Ull)ypp_xp_p4, MSK_D0, (Ull)acci_ypp3[CHIP], IM, 0, 0, (Ull)NULL, IM);      /* stage#54 */
        ...
        mop(OP_LDUWR,  1, &BR[57][1][1], (Ull)(sadi3[CHIP]++), 0LL, MSK_D0, (Ull)sadx_base3[CHIP], CRANGE, 0, 1, (Ull)NULL, CRANGE);    /* stage#57 */
