...
//EMAX5A begin cnn mapdist=0
	  ...
	  mop(OP_LDUWR,  1, &BR[0][0][1],  (Ull)(op000++), 0LL, MSK_D0, (Ull)ot000, M/2, 0, 1, (Ull)NULL, M/2);            /* stage#0 */
	  mop(OP_LDUWR,  1, &BR[0][1][1],  (Ull)(op001++), 0LL, MSK_D0, (Ull)ot001, M/2, 0, 1, (Ull)NULL, M/2);            /* stage#0 */
	  mop(OP_LDUWR,  1, &BR[0][2][1],  (Ull)(op002++), 0LL, MSK_D0, (Ull)ot002, M/2, 0, 1, (Ull)NULL, M/2);            /* stage#0 */
	  mop(OP_LDUWR,  1, &BR[0][3][1],  (Ull)(op003++), 0LL, MSK_D0, (Ull)ot003, M/2, 0, 1, (Ull)NULL, M/2);            /* stage#0 */

	  mop(OP_LDUWR,  1, &BR[1][0][1],  (Ull)kp00, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#1 */
	  mop(OP_LDUWR,  1, &BR[1][0][0],  (Ull)kp01, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#1 */
	  mop(OP_LDUWR,  1, &BR[1][1][1],  (Ull)kp02, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#1 */
	  mop(OP_LDUWR,  1, &BR[1][1][0],  (Ull)kp03, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#1 */
	  mop(OP_LDUWR,  1, &BR[1][2][1],  (Ull)(ip00++), 0LL, MSK_D0, (Ull)it00, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#1 */
	  ...
	  mop(OP_LDUWR,  1, &BR[2][0][1],  (Ull)kp00, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#2 */
	  mop(OP_LDUWR,  1, &BR[2][0][0],  (Ull)kp01, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#2 */
	  mop(OP_LDUWR,  1, &BR[2][1][1],  (Ull)kp02, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#2 */
	  mop(OP_LDUWR,  1, &BR[2][1][0],  (Ull)kp03, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#2 */
	  mop(OP_LDUWR,  1, &BR[2][2][1],  (Ull)(ip01++), 0LL, MSK_D0, (Ull)it00, M/2, 0, 0, (Ull)NULL, M/2);              /* stage#2 */
	  ...
	  mop(OP_LDUWR,  1, &BR[3][0][1],  (Ull)kp00, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#3 */
	  mop(OP_LDUWR,  1, &BR[3][0][0],  (Ull)kp01, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#3 */
	  mop(OP_LDUWR,  1, &BR[3][1][1],  (Ull)kp02, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#3 */
	  mop(OP_LDUWR,  1, &BR[3][1][0],  (Ull)kp03, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#3 */
	  mop(OP_LDUWR,  1, &BR[3][2][1],  (Ull)(ip02++), 0LL, MSK_D0, (Ull)it00, M/2, 0, 0, (Ull)NULL, M/2);              /* stage#3 */
	  ...
	  mop(OP_LDUWR,  1, &BR[4][0][1],  (Ull)kp00, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#4 */
	  mop(OP_LDUWR,  1, &BR[4][0][0],  (Ull)kp01, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#4 */
	  mop(OP_LDUWR,  1, &BR[4][1][1],  (Ull)kp02, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#4 */
	  mop(OP_LDUWR,  1, &BR[4][1][0],  (Ull)kp03, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#4 */
	  mop(OP_LDUWR,  1, &BR[4][2][1],  (Ull)(ip03++), 0LL, MSK_D0, (Ull)it03, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#4 */
	  ...
	  mop(OP_LDUWR,  1, &BR[5][0][1],  (Ull)kp00, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#5 */
	  mop(OP_LDUWR,  1, &BR[5][0][0],  (Ull)kp01, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#5 */
	  mop(OP_LDUWR,  1, &BR[5][1][1],  (Ull)kp02, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#5 */
	  mop(OP_LDUWR,  1, &BR[5][1][0],  (Ull)kp03, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#5 */
	  mop(OP_LDUWR,  1, &BR[5][2][1],  (Ull)(ip04++), 0LL, MSK_D0, (Ull)it03, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#5 */
	  ...
	  mop(OP_LDUWR,  1, &BR[6][0][1],  (Ull)kp00, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#6 */
	  mop(OP_LDUWR,  1, &BR[6][0][0],  (Ull)kp01, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#6 */
	  mop(OP_LDUWR,  1, &BR[6][1][1],  (Ull)kp02, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#6 */
	  mop(OP_LDUWR,  1, &BR[6][1][0],  (Ull)kp03, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#6 */
	  mop(OP_LDUWR,  1, &BR[6][2][1],  (Ull)(ip05++), 0LL, MSK_D0, (Ull)it03, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#6 */
	  ...
	  mop(OP_LDUWR,  1, &BR[7][0][1],  (Ull)kp00, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#7 */
	  mop(OP_LDUWR,  1, &BR[7][0][0],  (Ull)kp01, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#7 */
	  mop(OP_LDUWR,  1, &BR[7][1][1],  (Ull)kp02, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#7 */
	  mop(OP_LDUWR,  1, &BR[7][1][0],  (Ull)kp03, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#7 */
	  mop(OP_LDUWR,  1, &BR[7][2][1],  (Ull)(ip06++), 0LL, MSK_D0, (Ull)it06, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#7 */
	  ...
	  mop(OP_LDUWR,  1, &BR[8][0][1],  (Ull)kp00, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#8 */
	  mop(OP_LDUWR,  1, &BR[8][0][0],  (Ull)kp01, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#8 */
	  mop(OP_LDUWR,  1, &BR[8][1][1],  (Ull)kp02, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#8 */
	  mop(OP_LDUWR,  1, &BR[8][1][0],  (Ull)kp03, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#8 */
	  mop(OP_LDUWR,  1, &BR[8][2][1],  (Ull)(ip07++), 0LL, MSK_D0, (Ull)it06, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#8 */
	  ...
	  mop(OP_LDUWR,  1, &BR[9][0][1],  (Ull)kp00, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#9 */
	  mop(OP_LDUWR,  1, &BR[9][0][0],  (Ull)kp01, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#9 */
	  mop(OP_LDUWR,  1, &BR[9][1][1],  (Ull)kp02, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#9 */
	  mop(OP_LDUWR,  1, &BR[9][1][0],  (Ull)kp03, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#9 */
	  mop(OP_LDUWR,  1, &BR[9][2][1],  (Ull)(ip08++), 0LL, MSK_D0, (Ull)it06, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#9 */
	  ...
	  mop(OP_LDUWR,  1, &BR[10][0][1],  (Ull)kp10, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#10 */
	  mop(OP_LDUWR,  1, &BR[10][0][0],  (Ull)kp11, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#10 */
	  mop(OP_LDUWR,  1, &BR[10][1][1],  (Ull)kp12, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#10 */
	  mop(OP_LDUWR,  1, &BR[10][1][0],  (Ull)kp13, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#10 */
	  mop(OP_LDUWR,  1, &BR[10][2][1],  (Ull)(ip10++), 0LL, MSK_D0, (Ull)it10, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#10 */
	  ...
	  mop(OP_LDUWR,  1, &BR[11][0][1],  (Ull)kp10, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#11 */
	  mop(OP_LDUWR,  1, &BR[11][0][0],  (Ull)kp11, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#11 */
	  mop(OP_LDUWR,  1, &BR[11][1][1],  (Ull)kp12, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#11 */
	  mop(OP_LDUWR,  1, &BR[11][1][0],  (Ull)kp13, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#11 */
	  mop(OP_LDUWR,  1, &BR[11][2][1],  (Ull)(ip11++), 0LL, MSK_D0, (Ull)it10, M/2, 0, 0, (Ull)NULL, M/2);              /* stage#11 */
	  ...
	  mop(OP_LDUWR,  1, &BR[12][0][1],  (Ull)kp10, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#12 */
	  mop(OP_LDUWR,  1, &BR[12][0][0],  (Ull)kp11, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#12 */
	  mop(OP_LDUWR,  1, &BR[12][1][1],  (Ull)kp12, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#12 */
	  mop(OP_LDUWR,  1, &BR[12][1][0],  (Ull)kp13, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#12 */
	  mop(OP_LDUWR,  1, &BR[12][2][1],  (Ull)(ip12++), 0LL, MSK_D0, (Ull)it10, M/2, 0, 0, (Ull)NULL, M/2);              /* stage#12 */
	  ...
	  mop(OP_LDUWR,  1, &BR[13][0][1],  (Ull)kp10, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#13 */
	  mop(OP_LDUWR,  1, &BR[13][0][0],  (Ull)kp11, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#13 */
	  mop(OP_LDUWR,  1, &BR[13][1][1],  (Ull)kp12, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#13 */
	  mop(OP_LDUWR,  1, &BR[13][1][0],  (Ull)kp13, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#13 */
	  mop(OP_LDUWR,  1, &BR[13][2][1],  (Ull)(ip13++), 0LL, MSK_D0, (Ull)it13, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#13 */
	  ...
	  mop(OP_LDUWR,  1, &BR[14][0][1],  (Ull)kp10, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#14 */
	  mop(OP_LDUWR,  1, &BR[14][0][0],  (Ull)kp11, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#14 */
	  mop(OP_LDUWR,  1, &BR[14][1][1],  (Ull)kp12, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#14 */
	  mop(OP_LDUWR,  1, &BR[14][1][0],  (Ull)kp13, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#14 */
	  mop(OP_LDUWR,  1, &BR[14][2][1],  (Ull)(ip14++), 0LL, MSK_D0, (Ull)it13, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#14 */
	  ...
	  mop(OP_LDUWR,  1, &BR[15][0][1],  (Ull)kp10, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#15 */
	  mop(OP_LDUWR,  1, &BR[15][0][0],  (Ull)kp11, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#15 */
	  mop(OP_LDUWR,  1, &BR[15][1][1],  (Ull)kp12, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#15 */
	  mop(OP_LDUWR,  1, &BR[15][1][0],  (Ull)kp13, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#15 */
	  mop(OP_LDUWR,  1, &BR[15][2][1],  (Ull)(ip15++), 0LL, MSK_D0, (Ull)it13, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#15 */
	  ...
	  mop(OP_LDUWR,  1, &BR[16][0][1],  (Ull)kp10, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#16 */
	  mop(OP_LDUWR,  1, &BR[16][0][0],  (Ull)kp11, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#16 */
	  mop(OP_LDUWR,  1, &BR[16][1][1],  (Ull)kp12, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#16 */
	  mop(OP_LDUWR,  1, &BR[16][1][0],  (Ull)kp13, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#16 */
	  mop(OP_LDUWR,  1, &BR[16][2][1],  (Ull)(ip16++), 0LL, MSK_D0, (Ull)it16, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#16 */
	  ...
	  mop(OP_LDUWR,  1, &BR[17][0][1],  (Ull)kp10, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#17 */
	  mop(OP_LDUWR,  1, &BR[17][0][0],  (Ull)kp11, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#17 */
	  mop(OP_LDUWR,  1, &BR[17][1][1],  (Ull)kp12, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#17 */
	  mop(OP_LDUWR,  1, &BR[17][1][0],  (Ull)kp13, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#17 */
	  mop(OP_LDUWR,  1, &BR[17][2][1],  (Ull)(ip17++), 0LL, MSK_D0, (Ull)it16, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#17 */
	  ...
	  mop(OP_LDUWR,  1, &BR[18][0][1],  (Ull)kp10, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#18 */
	  mop(OP_LDUWR,  1, &BR[18][0][0],  (Ull)kp11, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#18 */
	  mop(OP_LDUWR,  1, &BR[18][1][1],  (Ull)kp12, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#18 */
	  mop(OP_LDUWR,  1, &BR[18][1][0],  (Ull)kp13, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#18 */
	  mop(OP_LDUWR,  1, &BR[18][2][1],  (Ull)(ip18++), 0LL, MSK_D0, (Ull)it16, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#18 */
	  ...
	  mop(OP_LDUWR,  1, &BR[19][0][1],  (Ull)kp20, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#19 */
	  mop(OP_LDUWR,  1, &BR[19][0][0],  (Ull)kp21, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#19 */
	  mop(OP_LDUWR,  1, &BR[19][1][1],  (Ull)kp22, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#19 */
	  mop(OP_LDUWR,  1, &BR[19][1][0],  (Ull)kp23, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#19 */
	  mop(OP_LDUWR,  1, &BR[19][2][1],  (Ull)(ip20++), 0LL, MSK_D0, (Ull)it20, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#19 */
	  ...
	  mop(OP_LDUWR,  1, &BR[20][0][1],  (Ull)kp20, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#20 */
	  mop(OP_LDUWR,  1, &BR[20][0][0],  (Ull)kp21, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#20 */
	  mop(OP_LDUWR,  1, &BR[20][1][1],  (Ull)kp22, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#20 */
	  mop(OP_LDUWR,  1, &BR[20][1][0],  (Ull)kp23, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#20 */
	  mop(OP_LDUWR,  1, &BR[20][2][1],  (Ull)(ip21++), 0LL, MSK_D0, (Ull)it20, M/2, 0, 0, (Ull)NULL, M/2);              /* stage#20 */
	  ...
	  mop(OP_LDUWR,  1, &BR[21][0][1],  (Ull)kp20, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#21 */
	  mop(OP_LDUWR,  1, &BR[21][0][0],  (Ull)kp21, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#21 */
	  mop(OP_LDUWR,  1, &BR[21][1][1],  (Ull)kp22, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#21 */
	  mop(OP_LDUWR,  1, &BR[21][1][0],  (Ull)kp23, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#21 */
	  mop(OP_LDUWR,  1, &BR[21][2][1],  (Ull)(ip22++), 0LL, MSK_D0, (Ull)it20, M/2, 0, 0, (Ull)NULL, M/2);              /* stage#21 */
	  ...
	  mop(OP_LDUWR,  1, &BR[22][0][1],  (Ull)kp20, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#22 */
	  mop(OP_LDUWR,  1, &BR[22][0][0],  (Ull)kp21, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#22 */
	  mop(OP_LDUWR,  1, &BR[22][1][1],  (Ull)kp22, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#22 */
	  mop(OP_LDUWR,  1, &BR[22][1][0],  (Ull)kp23, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#22 */
	  mop(OP_LDUWR,  1, &BR[22][2][1],  (Ull)(ip23++), 0LL, MSK_D0, (Ull)it23, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#22 */
	  ...
	  mop(OP_LDUWR,  1, &BR[23][0][1],  (Ull)kp20, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#23 */
	  mop(OP_LDUWR,  1, &BR[23][0][0],  (Ull)kp21, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#23 */
	  mop(OP_LDUWR,  1, &BR[23][1][1],  (Ull)kp22, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#23 */
	  mop(OP_LDUWR,  1, &BR[23][1][0],  (Ull)kp23, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#23 */
	  mop(OP_LDUWR,  1, &BR[23][2][1],  (Ull)(ip24++), 0LL, MSK_D0, (Ull)it23, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#23 */
	  ...
	  mop(OP_LDUWR,  1, &BR[24][0][1],  (Ull)kp20, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#24 */
	  mop(OP_LDUWR,  1, &BR[24][0][0],  (Ull)kp21, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#24 */
	  mop(OP_LDUWR,  1, &BR[24][1][1],  (Ull)kp22, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#24 */
	  mop(OP_LDUWR,  1, &BR[24][1][0],  (Ull)kp23, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#24 */
	  mop(OP_LDUWR,  1, &BR[24][2][1],  (Ull)(ip25++), 0LL, MSK_D0, (Ull)it23, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#24 */
	  ...
	  mop(OP_LDUWR,  1, &BR[25][0][1],  (Ull)kp20, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#25 */
	  mop(OP_LDUWR,  1, &BR[25][0][0],  (Ull)kp21, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#25 */
	  mop(OP_LDUWR,  1, &BR[25][1][1],  (Ull)kp22, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#25 */
	  mop(OP_LDUWR,  1, &BR[25][1][0],  (Ull)kp23, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#25 */
	  mop(OP_LDUWR,  1, &BR[25][2][1],  (Ull)(ip26++), 0LL, MSK_D0, (Ull)it26, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#25 */
	  ...
	  mop(OP_LDUWR,  1, &BR[26][0][1],  (Ull)kp20, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#26 */
	  mop(OP_LDUWR,  1, &BR[26][0][0],  (Ull)kp21, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#26 */
	  mop(OP_LDUWR,  1, &BR[26][1][1],  (Ull)kp22, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#26 */
	  mop(OP_LDUWR,  1, &BR[26][1][0],  (Ull)kp23, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#26 */
	  mop(OP_LDUWR,  1, &BR[26][2][1],  (Ull)(ip27++), 0LL, MSK_D0, (Ull)it26, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#26 */
	  ...
	  mop(OP_LDUWR,  1, &BR[27][0][1],  (Ull)kp20, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#27 */
	  mop(OP_LDUWR,  1, &BR[27][0][0],  (Ull)kp21, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#27 */
	  mop(OP_LDUWR,  1, &BR[27][1][1],  (Ull)kp22, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#27 */
	  mop(OP_LDUWR,  1, &BR[27][1][0],  (Ull)kp23, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#27 */
	  mop(OP_LDUWR,  1, &BR[27][2][1],  (Ull)(ip28++), 0LL, MSK_D0, (Ull)it26, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#27 */
	  ...
	  mop(OP_LDUWR,  1, &BR[28][0][1],  (Ull)kp30, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#28 */
	  mop(OP_LDUWR,  1, &BR[28][0][0],  (Ull)kp31, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#28 */
	  mop(OP_LDUWR,  1, &BR[28][1][1],  (Ull)kp32, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#28 */
	  mop(OP_LDUWR,  1, &BR[28][1][0],  (Ull)kp33, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#28 */
	  mop(OP_LDUWR,  1, &BR[28][2][1],  (Ull)(ip30++), 0LL, MSK_D0, (Ull)it30, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#28 */
	  ...
	  mop(OP_LDUWR,  1, &BR[29][0][1],  (Ull)kp30, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#29 */
	  mop(OP_LDUWR,  1, &BR[29][0][0],  (Ull)kp31, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#29 */
	  mop(OP_LDUWR,  1, &BR[29][1][1],  (Ull)kp32, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#29 */
	  mop(OP_LDUWR,  1, &BR[29][1][0],  (Ull)kp33, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#29 */
	  mop(OP_LDUWR,  1, &BR[29][2][1],  (Ull)(ip31++), 0LL, MSK_D0, (Ull)it30, M/2, 0, 0, (Ull)NULL, M/2);              /* stage#29 */
	  ...
	  mop(OP_LDUWR,  1, &BR[30][0][1],  (Ull)kp30, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#30 */
	  mop(OP_LDUWR,  1, &BR[30][0][0],  (Ull)kp31, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#30 */
	  mop(OP_LDUWR,  1, &BR[30][1][1],  (Ull)kp32, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#30 */
	  mop(OP_LDUWR,  1, &BR[30][1][0],  (Ull)kp33, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#30 */
	  mop(OP_LDUWR,  1, &BR[30][2][1],  (Ull)(ip32++), 0LL, MSK_D0, (Ull)it30, M/2, 0, 0, (Ull)NULL, M/2);              /* stage#30 */
	  ...
	  mop(OP_LDUWR,  1, &BR[31][0][1],  (Ull)kp30, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#31 */
	  mop(OP_LDUWR,  1, &BR[31][0][0],  (Ull)kp31, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#31 */
	  mop(OP_LDUWR,  1, &BR[31][1][1],  (Ull)kp32, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#31 */
	  mop(OP_LDUWR,  1, &BR[31][1][0],  (Ull)kp33, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#31 */
	  mop(OP_LDUWR,  1, &BR[31][2][1],  (Ull)(ip33++), 0LL, MSK_D0, (Ull)it33, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#31 */
	  ...
	  mop(OP_LDUWR,  1, &BR[32][0][1],  (Ull)kp30, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#32 */
	  mop(OP_LDUWR,  1, &BR[32][0][0],  (Ull)kp31, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#32 */
	  mop(OP_LDUWR,  1, &BR[32][1][1],  (Ull)kp32, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#32 */
	  mop(OP_LDUWR,  1, &BR[32][1][0],  (Ull)kp33, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#32 */
	  mop(OP_LDUWR,  1, &BR[32][2][1],  (Ull)(ip34++), 0LL, MSK_D0, (Ull)it33, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#32 */
	  ...
	  mop(OP_LDUWR,  1, &BR[33][0][1],  (Ull)kp30, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#33 */
	  mop(OP_LDUWR,  1, &BR[33][0][0],  (Ull)kp31, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#33 */
	  mop(OP_LDUWR,  1, &BR[33][1][1],  (Ull)kp32, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#33 */
	  mop(OP_LDUWR,  1, &BR[33][1][0],  (Ull)kp33, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#33 */
	  mop(OP_LDUWR,  1, &BR[33][2][1],  (Ull)(ip35++), 0LL, MSK_D0, (Ull)it33, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#33 */
	  ...
	  mop(OP_LDUWR,  1, &BR[34][0][1],  (Ull)kp30, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#34 */
	  mop(OP_LDUWR,  1, &BR[34][0][0],  (Ull)kp31, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#34 */
	  mop(OP_LDUWR,  1, &BR[34][1][1],  (Ull)kp32, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#34 */
	  mop(OP_LDUWR,  1, &BR[34][1][0],  (Ull)kp33, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#34 */
	  mop(OP_LDUWR,  1, &BR[34][2][1],  (Ull)(ip36++), 0LL, MSK_D0, (Ull)it36, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#34 */
	  ...
	  mop(OP_LDUWR,  1, &BR[35][0][1],  (Ull)kp30, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#35 */
	  mop(OP_LDUWR,  1, &BR[35][0][0],  (Ull)kp31, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#35 */
	  mop(OP_LDUWR,  1, &BR[35][1][1],  (Ull)kp32, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#35 */
	  mop(OP_LDUWR,  1, &BR[35][1][0],  (Ull)kp33, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#35 */
	  mop(OP_LDUWR,  1, &BR[35][2][1],  (Ull)(ip37++), 0LL, MSK_D0, (Ull)it36, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#35 */
	  ...
	  mop(OP_LDUWR,  1, &BR[36][0][1],  (Ull)kp30, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#36 */
	  mop(OP_LDUWR,  1, &BR[36][0][0],  (Ull)kp31, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#36 */
	  mop(OP_LDUWR,  1, &BR[36][1][1],  (Ull)kp32, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#36 */
	  mop(OP_LDUWR,  1, &BR[36][1][0],  (Ull)kp33, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#36 */
	  mop(OP_LDUWR,  1, &BR[36][2][1],  (Ull)(ip38++), 0LL, MSK_D0, (Ull)it36, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#36 */
	  ...
	  mop(OP_LDUWR,  1, &BR[37][0][1],  (Ull)kp40, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#37 */
	  mop(OP_LDUWR,  1, &BR[37][0][0],  (Ull)kp41, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#37 */
	  mop(OP_LDUWR,  1, &BR[37][1][1],  (Ull)kp42, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#37 */
	  mop(OP_LDUWR,  1, &BR[37][1][0],  (Ull)kp43, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#37 */
	  mop(OP_LDUWR,  1, &BR[37][2][1],  (Ull)(ip40++), 0LL, MSK_D0, (Ull)it40, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#37 */
	  ...
	  mop(OP_LDUWR,  1, &BR[38][0][1],  (Ull)kp40, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#38 */
	  mop(OP_LDUWR,  1, &BR[38][0][0],  (Ull)kp41, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#38 */
	  mop(OP_LDUWR,  1, &BR[38][1][1],  (Ull)kp42, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#38 */
	  mop(OP_LDUWR,  1, &BR[38][1][0],  (Ull)kp43, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#38 */
	  mop(OP_LDUWR,  1, &BR[38][2][1],  (Ull)(ip41++), 0LL, MSK_D0, (Ull)it40, M/2, 0, 0, (Ull)NULL, M/2);              /* stage#38 */
	  ...
	  mop(OP_LDUWR,  1, &BR[39][0][1],  (Ull)kp40, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#39 */
	  mop(OP_LDUWR,  1, &BR[39][0][0],  (Ull)kp41, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#39 */
	  mop(OP_LDUWR,  1, &BR[39][1][1],  (Ull)kp42, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#39 */
	  mop(OP_LDUWR,  1, &BR[39][1][0],  (Ull)kp43, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#39 */
	  mop(OP_LDUWR,  1, &BR[39][2][1],  (Ull)(ip42++), 0LL, MSK_D0, (Ull)it40, M/2, 0, 0, (Ull)NULL, M/2);              /* stage#39 */
	  ...
	  mop(OP_LDUWR,  1, &BR[40][0][1],  (Ull)kp40, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#40 */
	  mop(OP_LDUWR,  1, &BR[40][0][0],  (Ull)kp41, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#40 */
	  mop(OP_LDUWR,  1, &BR[40][1][1],  (Ull)kp42, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#40 */
	  mop(OP_LDUWR,  1, &BR[40][1][0],  (Ull)kp43, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#40 */
	  mop(OP_LDUWR,  1, &BR[40][2][1],  (Ull)(ip43++), 0LL, MSK_D0, (Ull)it43, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#40 */
	  ...
	  mop(OP_LDUWR,  1, &BR[41][0][1],  (Ull)kp40, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#41 */
	  mop(OP_LDUWR,  1, &BR[41][0][0],  (Ull)kp41, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#41 */
	  mop(OP_LDUWR,  1, &BR[41][1][1],  (Ull)kp42, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#41 */
	  mop(OP_LDUWR,  1, &BR[41][1][0],  (Ull)kp43, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#41 */
	  mop(OP_LDUWR,  1, &BR[41][2][1],  (Ull)(ip44++), 0LL, MSK_D0, (Ull)it43, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#41 */
	  ...
	  mop(OP_LDUWR,  1, &BR[42][0][1],  (Ull)kp40, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#42 */
	  mop(OP_LDUWR,  1, &BR[42][0][0],  (Ull)kp41, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#42 */
	  mop(OP_LDUWR,  1, &BR[42][1][1],  (Ull)kp42, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#42 */
	  mop(OP_LDUWR,  1, &BR[42][1][0],  (Ull)kp43, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#42 */
	  mop(OP_LDUWR,  1, &BR[42][2][1],  (Ull)(ip45++), 0LL, MSK_D0, (Ull)it43, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#42 */
	  ...
	  mop(OP_LDUWR,  1, &BR[43][0][1],  (Ull)kp40, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#43 */
	  mop(OP_LDUWR,  1, &BR[43][0][0],  (Ull)kp41, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#43 */
	  mop(OP_LDUWR,  1, &BR[43][1][1],  (Ull)kp42, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#43 */
	  mop(OP_LDUWR,  1, &BR[43][1][0],  (Ull)kp43, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#43 */
	  mop(OP_LDUWR,  1, &BR[43][2][1],  (Ull)(ip46++), 0LL, MSK_D0, (Ull)it46, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#43 */
	  ...
	  mop(OP_LDUWR,  1, &BR[44][0][1],  (Ull)kp40, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#44 */
	  mop(OP_LDUWR,  1, &BR[44][0][0],  (Ull)kp41, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#44 */
	  mop(OP_LDUWR,  1, &BR[44][1][1],  (Ull)kp42, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#44 */
	  mop(OP_LDUWR,  1, &BR[44][1][0],  (Ull)kp43, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#44 */
	  mop(OP_LDUWR,  1, &BR[44][2][1],  (Ull)(ip47++), 0LL, MSK_D0, (Ull)it46, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#44 */
	  ...
	  mop(OP_LDUWR,  1, &BR[45][0][1],  (Ull)kp40, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#45 */
	  mop(OP_LDUWR,  1, &BR[45][0][0],  (Ull)kp41, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#45 */
	  mop(OP_LDUWR,  1, &BR[45][1][1],  (Ull)kp42, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#45 */
	  mop(OP_LDUWR,  1, &BR[45][1][0],  (Ull)kp43, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#45 */
	  mop(OP_LDUWR,  1, &BR[45][2][1],  (Ull)(ip48++), 0LL, MSK_D0, (Ull)it46, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#45 */
	  ...
	  mop(OP_LDUWR,  1, &BR[46][0][1],  (Ull)kp50, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#46 */
	  mop(OP_LDUWR,  1, &BR[46][0][0],  (Ull)kp51, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#46 */
	  mop(OP_LDUWR,  1, &BR[46][1][1],  (Ull)kp52, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#46 */
	  mop(OP_LDUWR,  1, &BR[46][1][0],  (Ull)kp53, 0LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2); /* stage#46 */
	  mop(OP_LDUWR,  1, &BR[46][2][1],  (Ull)(ip50++), 0LL, MSK_D0, (Ull)it50, M/2, 0, 0, (Ull)NULL, M/2);            /* stage#46 */
	  ...
	  mop(OP_LDUWR,  1, &BR[47][0][1],  (Ull)kp50, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#47 */
	  mop(OP_LDUWR,  1, &BR[47][0][0],  (Ull)kp51, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#47 */
	  mop(OP_LDUWR,  1, &BR[47][1][1],  (Ull)kp52, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#47 */
	  mop(OP_LDUWR,  1, &BR[47][1][0],  (Ull)kp53, 4LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#47 */
	  mop(OP_LDUWR,  1, &BR[47][2][1],  (Ull)(ip51++), 0LL, MSK_D0, (Ull)it50, M/2, 0, 0, (Ull)NULL, M/2);              /* stage#47 */
	  ...
	  mop(OP_LDUWR,  1, &BR[48][0][1],  (Ull)kp50, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#48 */
	  mop(OP_LDUWR,  1, &BR[48][0][0],  (Ull)kp51, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#48 */
	  mop(OP_LDUWR,  1, &BR[48][1][1],  (Ull)kp52, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#48 */
	  mop(OP_LDUWR,  1, &BR[48][1][0],  (Ull)kp53, 8LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#48 */
	  mop(OP_LDUWR,  1, &BR[48][2][1],  (Ull)(ip52++), 0LL, MSK_D0, (Ull)it50, M/2, 0, 0, (Ull)NULL, M/2);              /* stage#48 */
	  ...
	  mop(OP_LDUWR,  1, &BR[49][0][1],  (Ull)kp50, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#49 */
	  mop(OP_LDUWR,  1, &BR[49][0][0],  (Ull)kp51, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#49 */
	  mop(OP_LDUWR,  1, &BR[49][1][1],  (Ull)kp52, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#49 */
	  mop(OP_LDUWR,  1, &BR[49][1][0],  (Ull)kp53, 12LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#49 */
	  mop(OP_LDUWR,  1, &BR[49][2][1],  (Ull)(ip53++), 0LL, MSK_D0, (Ull)it53, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#49 */
	  ...
	  mop(OP_LDUWR,  1, &BR[50][0][1],  (Ull)kp50, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#50 */
	  mop(OP_LDUWR,  1, &BR[50][0][0],  (Ull)kp51, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#50 */
	  mop(OP_LDUWR,  1, &BR[50][1][1],  (Ull)kp52, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#50 */
	  mop(OP_LDUWR,  1, &BR[50][1][0],  (Ull)kp53, 16LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#50 */
	  mop(OP_LDUWR,  1, &BR[50][2][1],  (Ull)(ip54++), 0LL, MSK_D0, (Ull)it53, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#50 */
	  ...
	  mop(OP_LDUWR,  1, &BR[51][0][1],  (Ull)kp50, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#51 */
	  mop(OP_LDUWR,  1, &BR[51][0][0],  (Ull)kp51, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#51 */
	  mop(OP_LDUWR,  1, &BR[51][1][1],  (Ull)kp52, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#51 */
	  mop(OP_LDUWR,  1, &BR[51][1][0],  (Ull)kp53, 20LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#51 */
	  mop(OP_LDUWR,  1, &BR[51][2][1],  (Ull)(ip55++), 0LL, MSK_D0, (Ull)it53, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#51 */
	  ...
	  mop(OP_LDUWR,  1, &BR[52][0][1],  (Ull)kp50, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#52 */
	  mop(OP_LDUWR,  1, &BR[52][0][0],  (Ull)kp51, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#52 */
	  mop(OP_LDUWR,  1, &BR[52][1][1],  (Ull)kp52, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#52 */
	  mop(OP_LDUWR,  1, &BR[52][1][0],  (Ull)kp53, 24LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#52 */
	  mop(OP_LDUWR,  1, &BR[52][2][1],  (Ull)(ip56++), 0LL, MSK_D0, (Ull)it56, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#52 */
	  ...
	  mop(OP_LDUWR,  1, &BR[53][0][1],  (Ull)kp50, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#53 */
	  mop(OP_LDUWR,  1, &BR[53][0][0],  (Ull)kp51, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#53 */
	  mop(OP_LDUWR,  1, &BR[53][1][1],  (Ull)kp52, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#53 */
	  mop(OP_LDUWR,  1, &BR[53][1][0],  (Ull)kp53, 28LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#53 */
	  mop(OP_LDUWR,  1, &BR[53][2][1],  (Ull)(ip57++), 0LL, MSK_D0, (Ull)it56, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#53 */
	  ...
	  mop(OP_LDUWR,  1, &BR[54][0][1],  (Ull)kp50, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#54 */
	  mop(OP_LDUWR,  1, &BR[54][0][0],  (Ull)kp51, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#54 */
	  mop(OP_LDUWR,  1, &BR[54][1][1],  (Ull)kp52, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#54 */
	  mop(OP_LDUWR,  1, &BR[54][1][0],  (Ull)kp53, 32LL, MSK_D0, (Ull)ker, IC*OC*K*K/2, 0, 0, (Ull)NULL, IC*OC*K*K/2);   /* stage#54 */
	  mop(OP_LDUWR,  1, &BR[54][2][1],  (Ull)(ip58++), 0LL, MSK_D0, (Ull)it56, M/2, 0, 0, (Ull)NULL, M/2);               /* stage#54 */
