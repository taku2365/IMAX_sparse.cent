...
main()
{
  ...
  sort_index = (Uint*)((Uchar*)C1 + 736LL*736LL*sizeof(Uint));
  ...
  for (row=0; row<736LL; row++) {
   ...
   reset_nanosec();
    ...
    int* count = (int*) calloc(736LL,sizeof(int));
    int* count_tmp = (int*) calloc((736LL +1),sizeof(int));
    int* count_sort_index_inverse = (int*) calloc(736LL,sizeof(int));
    Uint* count_sort_index= sort_index;
    int* row_count = (int*) calloc((736LL +1),sizeof(int));
    int* col_count = (int*) calloc((736LL +1),sizeof(int));
    int* paddings = (int*) calloc((736LL),sizeof(int));
    int count_tmp1;
    Ull* margin = (Ull*) calloc((736LL/46),sizeof(Ull));
    int iter_num = 0,margin_tmp;
    int k,row,row1,col,col1,iter,count_sort_index_inverse_tmp;
    for(k=0; k<nnz_A; k++) count[row_index_A[k]]++;
    for(row=0; row<736LL; row++){
        count_tmp[count[row]]++;
    }
    for(row=0; row<736LL; row++) count_tmp[row+1] += count_tmp[row];
    for(row=0; row<736LL; row++){
        count_tmp1 = --count_tmp[count[row]];
        count_sort_index[(736LL -1)-count_tmp1] = row*2*4;
        count_sort_index_inverse[row] = (736LL -1) - count_tmp1;
         paddings[(736LL -1) - count_tmp1] = count[row]/46 + (int)(count[row]%46 != 0);
    }
    for(iter=0;iter<paddings[736LL -1]; iter++){
        margin[iter_num++] = 736LL;
    }
    for(row=736LL -2,tmp=paddings[736LL -1]; row>=0; row--){
        if(tmp != paddings[row]){
    ...
    Uint* val_index_set_tmp = (Uint*) calloc(736LL*736LL,sizeof(Uint));
    int* col_index_sparse = (int*) calloc(736LL*736LL,sizeof(int));
    int* row_index_sort_sparse = (int*) calloc((736LL*736LL),sizeof(int));
    for(k=0,count_sort_index_inverse_tmp=0; k<nnz_A; k++){
        count_sort_index_inverse_tmp = count_sort_index_inverse[row_index_A[k]];
        A[count_sort_index_inverse_tmp+row_count[1+row_index_A[k]]*736LL] = A_tmp[row_index_A[k]+col_index_A[k]*736LL];
        val_index_set_tmp[count_sort_index_inverse_tmp+row_count[1+row_index_A[k]]*736LL] = col_index_A[k]*2*4;
        col_index_sparse[count_sort_index_inverse_tmp+row_count[1+row_index_A[k]]*736LL] = col_index_A[k];
    ...
    for (col=0,col1=0; col<736LL/2; col+=1,col1+=2){
      ...
      *(Uint*)&A[col*2*736LL +row+736LL*736LL] = *(Uint*)&val_index_set_tmp[col1*736LL +row1];
      *(Uint*)&A[col*2*736LL +row+1+736LL*736LL] = *(Uint*)&val_index_set_tmp[(col1+1)*736LL +row1];
    }
  }
    ...
    A_sparse->nnz = nnz_A;
    A_sparse->row_normal_size = 736LL;
    A_sparse->col_normal_size = 736LL;
  ...
  for (row=0; row<736LL; row++) {
    for (col=0; col<736LL; col++){
      ...
      *(float*)&B_debug[col*736LL +row] = (float)1;
        ...
        *(float*)&B_debug[col*736LL +row] = (float)0;
      }
    }
  }
    for (col=0,col1=0; col<736LL/2; col+=1,col1+=2){
...
/-EMAX5AS-/
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[5][0], AR[4][0], 3, BR[4][2][1], 3, BR[4][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[5][1], AR[4][1], 3, BR[4][2][1], 3, BR[4][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[5][2], AR[4][2], 3, BR[4][2][1], 3, BR[4][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[5][3], AR[4][3], 3, BR[4][2][1], 3, BR[4][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[5][0][1], (Ull)b0[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[5][0][0], (Ull)b1[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[5][1][1], (Ull)b2[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[5][1][0], (Ull)b3[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[5][2][1], (Ull)a[2], (Ull)rofs, 12, (Ull)a[2], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[6][0], AR[5][0], 3, BR[5][2][1], 3, BR[5][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[6][1], AR[5][1], 3, BR[5][2][1], 3, BR[5][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[6][2], AR[5][2], 3, BR[5][2][1], 3, BR[5][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[6][3], AR[5][3], 3, BR[5][2][1], 3, BR[5][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[6][0][1], (Ull)b0[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[6][0][0], (Ull)b1[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[6][1][1], (Ull)b2[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[6][1][0], (Ull)b3[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[6][2][1], (Ull)a[3], (Ull)rofs, 12, (Ull)a[3], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[7][0], AR[6][0], 3, BR[6][2][1], 3, BR[6][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[7][1], AR[6][1], 3, BR[6][2][1], 3, BR[6][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[7][2], AR[6][2], 3, BR[6][2][1], 3, BR[6][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[7][3], AR[6][3], 3, BR[6][2][1], 3, BR[6][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[7][0][1], (Ull)b0[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[7][0][0], (Ull)b1[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[7][1][1], (Ull)b2[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[7][1][0], (Ull)b3[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[7][2][1], (Ull)a[4], (Ull)rofs, 12, (Ull)a[4], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[8][0], AR[7][0], 3, BR[7][2][1], 3, BR[7][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[8][1], AR[7][1], 3, BR[7][2][1], 3, BR[7][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[8][2], AR[7][2], 3, BR[7][2][1], 3, BR[7][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[8][3], AR[7][3], 3, BR[7][2][1], 3, BR[7][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[8][0][1], (Ull)b0[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[8][0][0], (Ull)b1[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[8][1][1], (Ull)b2[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[8][1][0], (Ull)b3[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[8][2][1], (Ull)a[5], (Ull)rofs, 12, (Ull)a[5], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[9][0], AR[8][0], 3, BR[8][2][1], 3, BR[8][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[9][1], AR[8][1], 3, BR[8][2][1], 3, BR[8][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[9][2], AR[8][2], 3, BR[8][2][1], 3, BR[8][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[9][3], AR[8][3], 3, BR[8][2][1], 3, BR[8][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[9][0][1], (Ull)b0[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[9][0][0], (Ull)b1[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[9][1][1], (Ull)b2[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[9][1][0], (Ull)b3[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[9][2][1], (Ull)a[6], (Ull)rofs, 12, (Ull)a[6], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[10][0], AR[9][0], 3, BR[9][2][1], 3, BR[9][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[10][1], AR[9][1], 3, BR[9][2][1], 3, BR[9][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[10][2], AR[9][2], 3, BR[9][2][1], 3, BR[9][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[10][3], AR[9][3], 3, BR[9][2][1], 3, BR[9][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[10][0][1], (Ull)b0[CHIP],(Ull)t, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[10][0][0], (Ull)b1[CHIP],(Ull)t, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[10][1][1], (Ull)b2[CHIP],(Ull)t, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[10][1][0], (Ull)b3[CHIP],(Ull)t, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[10][2][1], (Ull)a[7], (Ull)rofs, 12, (Ull)a[7], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[11][0], AR[10][0], 3, BR[10][2][1], 3, BR[10][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[11][1], AR[10][1], 3, BR[10][2][1], 3, BR[10][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[11][2], AR[10][2], 3, BR[10][2][1], 3, BR[10][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[11][3], AR[10][3], 3, BR[10][2][1], 3, BR[10][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01,3, &BR[11][1][1], (Ull)a_index[4], (Ull)rofs, 13, (Ull)a_index[0], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[11][1][0], (Ull)a_index[5], (Ull)rofs, 13, (Ull)a_index[0], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[11][2][1], (Ull)a_index[6], (Ull)rofs, 13, (Ull)a_index[0], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[11][2][0], (Ull)a_index[7], (Ull)rofs, 13, (Ull)a_index[0], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2);
/-EMAX5AS-/ exe(0x16, &x, BR[11][1][1], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &y, BR[11][1][0], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &z, BR[11][2][1], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &t, BR[11][2][0], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[13][0][1], (Ull)b0[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[13][0][0], (Ull)b1[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[13][1][1], (Ull)b2[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[13][1][0], (Ull)b3[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[13][2][1], (Ull)a[8], (Ull)rofs, 12, (Ull)a[8], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[14][0], AR[11][0], 3, BR[13][2][1], 3, BR[13][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[14][1], AR[11][1], 3, BR[13][2][1], 3, BR[13][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[14][2], AR[11][2], 3, BR[13][2][1], 3, BR[13][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[14][3], AR[11][3], 3, BR[13][2][1], 3, BR[13][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[14][0][1], (Ull)b0[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[14][0][0], (Ull)b1[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[14][1][1], (Ull)b2[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[14][1][0], (Ull)b3[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[14][2][1], (Ull)a[9], (Ull)rofs, 12, (Ull)a[9], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[15][0], AR[14][0], 3, BR[14][2][1], 3, BR[14][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[15][1], AR[14][1], 3, BR[14][2][1], 3, BR[14][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[15][2], AR[14][2], 3, BR[14][2][1], 3, BR[14][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[15][3], AR[14][3], 3, BR[14][2][1], 3, BR[14][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[15][0][1], (Ull)b0[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[15][0][0], (Ull)b1[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[15][1][1], (Ull)b2[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[15][1][0], (Ull)b3[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[15][2][1], (Ull)a[10], (Ull)rofs, 12, (Ull)a[10], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[16][0], AR[15][0], 3, BR[15][2][1], 3, BR[15][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[16][1], AR[15][1], 3, BR[15][2][1], 3, BR[15][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[16][2], AR[15][2], 3, BR[15][2][1], 3, BR[15][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[16][3], AR[15][3], 3, BR[15][2][1], 3, BR[15][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[16][0][1], (Ull)b0[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[16][0][0], (Ull)b1[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[16][1][1], (Ull)b2[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[16][1][0], (Ull)b3[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[16][2][1], (Ull)a[11], (Ull)rofs, 12, (Ull)a[11], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[17][0], AR[16][0], 3, BR[16][2][1], 3, BR[16][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[17][1], AR[16][1], 3, BR[16][2][1], 3, BR[16][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[17][2], AR[16][2], 3, BR[16][2][1], 3, BR[16][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[17][3], AR[16][3], 3, BR[16][2][1], 3, BR[16][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[17][0][1], (Ull)b0[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[17][0][0], (Ull)b1[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[17][1][1], (Ull)b2[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[17][1][0], (Ull)b3[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[17][2][1], (Ull)a[12], (Ull)rofs, 12, (Ull)a[12], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[18][0], AR[17][0], 3, BR[17][2][1], 3, BR[17][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[18][1], AR[17][1], 3, BR[17][2][1], 3, BR[17][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[18][2], AR[17][2], 3, BR[17][2][1], 3, BR[17][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[18][3], AR[17][3], 3, BR[17][2][1], 3, BR[17][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[18][0][1], (Ull)b0[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[18][0][0], (Ull)b1[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[18][1][1], (Ull)b2[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[18][1][0], (Ull)b3[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[18][2][1], (Ull)a[13], (Ull)rofs, 12, (Ull)a[13], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[19][0], AR[18][0], 3, BR[18][2][1], 3, BR[18][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[19][1], AR[18][1], 3, BR[18][2][1], 3, BR[18][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[19][2], AR[18][2], 3, BR[18][2][1], 3, BR[18][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[19][3], AR[18][3], 3, BR[18][2][1], 3, BR[18][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[19][0][1], (Ull)b0[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[19][0][0], (Ull)b1[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[19][1][1], (Ull)b2[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[19][1][0], (Ull)b3[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[19][2][1], (Ull)a[14], (Ull)rofs, 12, (Ull)a[14], 736LL, 0, 0, (Ull)((void *)0), 736LL);
...
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[21][0], AR[20][0], 3, BR[20][2][1], 3, BR[20][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[21][1], AR[20][1], 3, BR[20][2][1], 3, BR[20][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[21][2], AR[20][2], 3, BR[20][2][1], 3, BR[20][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[21][3], AR[20][3], 3, BR[20][2][1], 3, BR[20][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01,3, &BR[21][1][1], (Ull)a_index[8], (Ull)rofs, 13, (Ull)a_index[8], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[21][1][0], (Ull)a_index[9], (Ull)rofs, 13, (Ull)a_index[8], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[21][2][1], (Ull)a_index[10], (Ull)rofs, 13, (Ull)a_index[8], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[21][2][0], (Ull)a_index[11], (Ull)rofs, 13, (Ull)a_index[8], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2);
/-EMAX5AS-/ exe(0x16, &x, BR[21][1][1], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &y, BR[21][1][0], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &z, BR[21][2][1], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &t, BR[21][2][0], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[23][0][1], (Ull)b0[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[23][0][0], (Ull)b1[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[23][1][1], (Ull)b2[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[23][1][0], (Ull)b3[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[23][2][1], (Ull)a[16], (Ull)rofs, 12, (Ull)a[16], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[24][0], AR[21][0], 3, BR[23][2][1], 3, BR[23][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[24][1], AR[21][1], 3, BR[23][2][1], 3, BR[23][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[24][2], AR[21][2], 3, BR[23][2][1], 3, BR[23][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[24][3], AR[21][3], 3, BR[23][2][1], 3, BR[23][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[24][0][1], (Ull)b0[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[24][0][0], (Ull)b1[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[24][1][1], (Ull)b2[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[24][1][0], (Ull)b3[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[24][2][1], (Ull)a[17], (Ull)rofs, 12, (Ull)a[17], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[25][0], AR[24][0], 3, BR[24][2][1], 3, BR[24][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[25][1], AR[24][1], 3, BR[24][2][1], 3, BR[24][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[25][2], AR[24][2], 3, BR[24][2][1], 3, BR[24][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[25][3], AR[24][3], 3, BR[24][2][1], 3, BR[24][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[25][0][1], (Ull)b0[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[25][0][0], (Ull)b1[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[25][1][1], (Ull)b2[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[25][1][0], (Ull)b3[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[25][2][1], (Ull)a[18], (Ull)rofs, 12, (Ull)a[18], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[26][0], AR[25][0], 3, BR[25][2][1], 3, BR[25][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[26][1], AR[25][1], 3, BR[25][2][1], 3, BR[25][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[26][2], AR[25][2], 3, BR[25][2][1], 3, BR[25][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[26][3], AR[25][3], 3, BR[25][2][1], 3, BR[25][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[26][0][1], (Ull)b0[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[26][0][0], (Ull)b1[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[26][1][1], (Ull)b2[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[26][1][0], (Ull)b3[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[26][2][1], (Ull)a[19], (Ull)rofs, 12, (Ull)a[19], 736LL, 0, 0, (Ull)((void *)0), 736LL);
...
/-EMAX5AS-/ exe(0x10, &AR[28][0], AR[27][0], 3, BR[27][2][1], 3, BR[27][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[28][1], AR[27][1], 3, BR[27][2][1], 3, BR[27][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[28][2], AR[27][2], 3, BR[27][2][1], 3, BR[27][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[28][3], AR[27][3], 3, BR[27][2][1], 3, BR[27][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[28][0][1], (Ull)b0[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[28][0][0], (Ull)b1[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[28][1][1], (Ull)b2[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[28][1][0], (Ull)b3[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[28][2][1], (Ull)a[21], (Ull)rofs, 12, (Ull)a[21], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[29][0], AR[28][0], 3, BR[28][2][1], 3, BR[28][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[29][1], AR[28][1], 3, BR[28][2][1], 3, BR[28][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[29][2], AR[28][2], 3, BR[28][2][1], 3, BR[28][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[29][3], AR[28][3], 3, BR[28][2][1], 3, BR[28][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[29][0][1], (Ull)b0[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[29][0][0], (Ull)b1[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[29][1][1], (Ull)b2[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[29][1][0], (Ull)b3[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[29][2][1], (Ull)a[22], (Ull)rofs, 12, (Ull)a[22], 736LL, 0, 0, (Ull)((void *)0), 736LL);
...
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[31][0], AR[30][0], 3, BR[30][2][1], 3, BR[30][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[31][1], AR[30][1], 3, BR[30][2][1], 3, BR[30][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[31][2], AR[30][2], 3, BR[30][2][1], 3, BR[30][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[31][3], AR[30][3], 3, BR[30][2][1], 3, BR[30][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01,3, &BR[31][1][1], (Ull)a_index[12], (Ull)rofs, 13, (Ull)a_index[8], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[31][1][0], (Ull)a_index[13], (Ull)rofs, 13, (Ull)a_index[8], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[31][2][1], (Ull)a_index[14], (Ull)rofs, 13, (Ull)a_index[8], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[31][2][0], (Ull)a_index[15], (Ull)rofs, 13, (Ull)a_index[8], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2);
/-EMAX5AS-/ exe(0x16, &x, BR[31][1][1], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &y, BR[31][1][0], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &z, BR[31][2][1], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &t, BR[31][2][0], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[33][0][1], (Ull)b0[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[33][0][0], (Ull)b1[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[33][1][1], (Ull)b2[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[33][1][0], (Ull)b3[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[33][2][1], (Ull)a[24], (Ull)rofs, 12, (Ull)a[24], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[34][0], AR[31][0], 3, BR[33][2][1], 3, BR[33][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[34][1], AR[31][1], 3, BR[33][2][1], 3, BR[33][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[34][2], AR[31][2], 3, BR[33][2][1], 3, BR[33][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[34][3], AR[31][3], 3, BR[33][2][1], 3, BR[33][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[34][0][1], (Ull)b0[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[34][0][0], (Ull)b1[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[34][1][1], (Ull)b2[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[34][1][0], (Ull)b3[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[34][2][1], (Ull)a[25], (Ull)rofs, 12, (Ull)a[25], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[35][0], AR[34][0], 3, BR[34][2][1], 3, BR[34][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[35][1], AR[34][1], 3, BR[34][2][1], 3, BR[34][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[35][2], AR[34][2], 3, BR[34][2][1], 3, BR[34][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[35][3], AR[34][3], 3, BR[34][2][1], 3, BR[34][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[35][0][1], (Ull)b0[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[35][0][0], (Ull)b1[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[35][1][1], (Ull)b2[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[35][1][0], (Ull)b3[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[35][2][1], (Ull)a[26], (Ull)rofs, 12, (Ull)a[26], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[36][0], AR[35][0], 3, BR[35][2][1], 3, BR[35][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[36][1], AR[35][1], 3, BR[35][2][1], 3, BR[35][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[36][2], AR[35][2], 3, BR[35][2][1], 3, BR[35][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[36][3], AR[35][3], 3, BR[35][2][1], 3, BR[35][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[36][0][1], (Ull)b0[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[36][0][0], (Ull)b1[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[36][1][1], (Ull)b2[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[36][1][0], (Ull)b3[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[36][2][1], (Ull)a[27], (Ull)rofs, 12, (Ull)a[27], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[37][0], AR[36][0], 3, BR[36][2][1], 3, BR[36][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[37][1], AR[36][1], 3, BR[36][2][1], 3, BR[36][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[37][2], AR[36][2], 3, BR[36][2][1], 3, BR[36][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[37][3], AR[36][3], 3, BR[36][2][1], 3, BR[36][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[37][0][1], (Ull)b0[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[37][0][0], (Ull)b1[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[37][1][1], (Ull)b2[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[37][1][0], (Ull)b3[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[37][2][1], (Ull)a[28], (Ull)rofs, 12, (Ull)a[28], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[38][0], AR[37][0], 3, BR[37][2][1], 3, BR[37][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[38][1], AR[37][1], 3, BR[37][2][1], 3, BR[37][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[38][2], AR[37][2], 3, BR[37][2][1], 3, BR[37][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[38][3], AR[37][3], 3, BR[37][2][1], 3, BR[37][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[38][0][1], (Ull)b0[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[38][0][0], (Ull)b1[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[38][1][1], (Ull)b2[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[38][1][0], (Ull)b3[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[38][2][1], (Ull)a[29], (Ull)rofs, 12, (Ull)a[29], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[39][0], AR[38][0], 3, BR[38][2][1], 3, BR[38][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[39][1], AR[38][1], 3, BR[38][2][1], 3, BR[38][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[39][2], AR[38][2], 3, BR[38][2][1], 3, BR[38][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[39][3], AR[38][3], 3, BR[38][2][1], 3, BR[38][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[39][0][1], (Ull)b0[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[39][0][0], (Ull)b1[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[39][1][1], (Ull)b2[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[39][1][0], (Ull)b3[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[39][2][1], (Ull)a[30], (Ull)rofs, 12, (Ull)a[30], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[40][0], AR[39][0], 3, BR[39][2][1], 3, BR[39][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[40][1], AR[39][1], 3, BR[39][2][1], 3, BR[39][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[40][2], AR[39][2], 3, BR[39][2][1], 3, BR[39][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[40][3], AR[39][3], 3, BR[39][2][1], 3, BR[39][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[40][0][1], (Ull)b0[CHIP],(Ull)t, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[40][0][0], (Ull)b1[CHIP],(Ull)t, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[40][1][1], (Ull)b2[CHIP],(Ull)t, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[40][1][0], (Ull)b3[CHIP],(Ull)t, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[40][2][1], (Ull)a[31], (Ull)rofs, 12, (Ull)a[31], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[41][0], AR[40][0], 3, BR[40][2][1], 3, BR[40][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[41][1], AR[40][1], 3, BR[40][2][1], 3, BR[40][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[41][2], AR[40][2], 3, BR[40][2][1], 3, BR[40][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[41][3], AR[40][3], 3, BR[40][2][1], 3, BR[40][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01,3, &BR[41][1][1], (Ull)a_index[16], (Ull)rofs, 13, (Ull)a_index[16], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[41][1][0], (Ull)a_index[17], (Ull)rofs, 13, (Ull)a_index[16], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[41][2][1], (Ull)a_index[18], (Ull)rofs, 13, (Ull)a_index[16], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[41][2][0], (Ull)a_index[19], (Ull)rofs, 13, (Ull)a_index[16], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2);
/-EMAX5AS-/ exe(0x16, &x, BR[41][1][1], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &y, BR[41][1][0], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &z, BR[41][2][1], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &t, BR[41][2][0], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[43][0][1], (Ull)b0[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[43][0][0], (Ull)b1[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[43][1][1], (Ull)b2[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[43][1][0], (Ull)b3[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[43][2][1], (Ull)a[32], (Ull)rofs, 12, (Ull)a[32], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[44][0], AR[41][0], 3, BR[43][2][1], 3, BR[43][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[44][1], AR[41][1], 3, BR[43][2][1], 3, BR[43][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[44][2], AR[41][2], 3, BR[43][2][1], 3, BR[43][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[44][3], AR[41][3], 3, BR[43][2][1], 3, BR[43][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[44][0][1], (Ull)b0[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[44][0][0], (Ull)b1[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[44][1][1], (Ull)b2[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[44][1][0], (Ull)b3[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[44][2][1], (Ull)a[33], (Ull)rofs, 12, (Ull)a[33], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
...
/-EMAX5AS-/ exe(0x10, &AR[46][0], AR[45][0], 3, BR[45][2][1], 3, BR[45][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[46][1], AR[45][1], 3, BR[45][2][1], 3, BR[45][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[46][2], AR[45][2], 3, BR[45][2][1], 3, BR[45][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[46][3], AR[45][3], 3, BR[45][2][1], 3, BR[45][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[46][0][1], (Ull)b0[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[46][0][0], (Ull)b1[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[46][1][1], (Ull)b2[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[46][1][0], (Ull)b3[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[46][2][1], (Ull)a[35], (Ull)rofs, 12, (Ull)a[35], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[47][0], AR[46][0], 3, BR[46][2][1], 3, BR[46][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[47][1], AR[46][1], 3, BR[46][2][1], 3, BR[46][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[47][2], AR[46][2], 3, BR[46][2][1], 3, BR[46][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[47][3], AR[46][3], 3, BR[46][2][1], 3, BR[46][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[47][0][1], (Ull)b0[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[47][0][0], (Ull)b1[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[47][1][1], (Ull)b2[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[47][1][0], (Ull)b3[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[47][2][1], (Ull)a[36], (Ull)rofs, 12, (Ull)a[36], 736LL, 0, 0, (Ull)((void *)0), 736LL);
...
/-EMAX5AS-/ exe(0x10, &AR[49][0], AR[48][0], 3, BR[48][2][1], 3, BR[48][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[49][1], AR[48][1], 3, BR[48][2][1], 3, BR[48][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[49][2], AR[48][2], 3, BR[48][2][1], 3, BR[48][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[49][3], AR[48][3], 3, BR[48][2][1], 3, BR[48][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[49][0][1], (Ull)b0[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[49][0][0], (Ull)b1[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[49][1][1], (Ull)b2[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[49][1][0], (Ull)b3[CHIP],(Ull)t, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[49][2][1], (Ull)a[38], (Ull)rofs, 12, (Ull)a[38], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[50][0], AR[49][0], 3, BR[49][2][1], 3, BR[49][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[50][1], AR[49][1], 3, BR[49][2][1], 3, BR[49][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[50][2], AR[49][2], 3, BR[49][2][1], 3, BR[49][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[50][3], AR[49][3], 3, BR[49][2][1], 3, BR[49][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[50][0][1], (Ull)b0[CHIP],(Ull)t, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[50][0][0], (Ull)b1[CHIP],(Ull)t, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[50][1][1], (Ull)b2[CHIP],(Ull)t, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[50][1][0], (Ull)b3[CHIP],(Ull)t, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[50][2][1], (Ull)a[39], (Ull)rofs, 12, (Ull)a[39], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[51][0], AR[50][0], 3, BR[50][2][1], 3, BR[50][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[51][1], AR[50][1], 3, BR[50][2][1], 3, BR[50][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[51][2], AR[50][2], 3, BR[50][2][1], 3, BR[50][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[51][3], AR[50][3], 3, BR[50][2][1], 3, BR[50][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01,3, &BR[51][1][1], (Ull)a_index[20], (Ull)rofs, 13, (Ull)a_index[16], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[51][1][0], (Ull)a_index[21], (Ull)rofs, 13, (Ull)a_index[16], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[51][2][1], (Ull)a_index[22], (Ull)rofs, 13, (Ull)a_index[16], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2); mop(0x01,3, &BR[51][2][0], (Ull)a_index[22], (Ull)rofs, 13, (Ull)a_index[16], 736LL*2*4*2, 0, 0, (Ull)((void *)0), 736LL*2*4*2);
/-EMAX5AS-/ exe(0x16, &x, BR[51][1][1], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &y, BR[51][1][0], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &z, BR[51][2][1], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); exe(0x16, &t, BR[51][2][0], 3, cofs, 3, 0LL, 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[53][0][1], (Ull)b0[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[53][0][0], (Ull)b1[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[53][1][1], (Ull)b2[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[53][1][0], (Ull)b3[CHIP], x, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[53][2][1], (Ull)a[40], (Ull)rofs, 12, (Ull)a[40], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[54][0], AR[51][0], 3, BR[53][2][1], 3, BR[53][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[54][1], AR[51][1], 3, BR[53][2][1], 3, BR[53][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[54][2], AR[51][2], 3, BR[53][2][1], 3, BR[53][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[54][3], AR[51][3], 3, BR[53][2][1], 3, BR[53][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[54][0][1], (Ull)b0[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[54][0][0], (Ull)b1[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[54][1][1], (Ull)b2[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[54][1][0], (Ull)b3[CHIP],(Ull)x, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[54][2][1], (Ull)a[41], (Ull)rofs, 12, (Ull)a[41], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/
/-EMAX5AS-/ exe(0x10, &AR[55][0], AR[54][0], 3, BR[54][2][1], 3, BR[54][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[55][1], AR[54][1], 3, BR[54][2][1], 3, BR[54][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[55][2], AR[54][2], 3, BR[54][2][1], 3, BR[54][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[55][3], AR[54][3], 3, BR[54][2][1], 3, BR[54][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[55][0][1], (Ull)b0[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[55][0][0], (Ull)b1[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[55][1][1], (Ull)b2[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[55][1][0], (Ull)b3[CHIP],(Ull)y, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[55][2][1], (Ull)a[42], (Ull)rofs, 12, (Ull)a[42], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[56][0], AR[55][0], 3, BR[55][2][1], 3, BR[55][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[56][1], AR[55][1], 3, BR[55][2][1], 3, BR[55][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[56][2], AR[55][2], 3, BR[55][2][1], 3, BR[55][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[56][3], AR[55][3], 3, BR[55][2][1], 3, BR[55][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[56][0][1], (Ull)b0[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[56][0][0], (Ull)b1[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[56][1][1], (Ull)b2[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[56][1][0], (Ull)b3[CHIP],(Ull)y, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[56][2][1], (Ull)a[43], (Ull)rofs, 12, (Ull)a[43], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[57][0], AR[56][0], 3, BR[56][2][1], 3, BR[56][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[57][1], AR[56][1], 3, BR[56][2][1], 3, BR[56][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[57][2], AR[56][2], 3, BR[56][2][1], 3, BR[56][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[57][3], AR[56][3], 3, BR[56][2][1], 3, BR[56][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[57][0][1], (Ull)b0[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[57][0][0], (Ull)b1[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[57][1][1], (Ull)b2[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[57][1][0], (Ull)b3[CHIP],(Ull)z, 12, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[57][2][1], (Ull)a[44], (Ull)rofs, 12, (Ull)a[44], 736LL, 0, 0, (Ull)((void *)0), 736LL);
/-EMAX5AS-/ exe(0x10, &AR[58][0], AR[57][0], 3, BR[57][2][1], 3, BR[57][0][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[58][1], AR[57][1], 3, BR[57][2][1], 3, BR[57][0][0], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[58][2], AR[57][2], 3, BR[57][2][1], 3, BR[57][1][1], 3, 0x00, 0LL, 0x00, 0LL); exe(0x10, &AR[58][3], AR[57][3], 3, BR[57][2][1], 3, BR[57][1][0], 3, 0x00, 0LL, 0x00, 0LL); mop(0x01, 3, &BR[58][0][1], (Ull)b0[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[58][0][0], (Ull)b1[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[58][1][1], (Ull)b2[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x01, 3, &BR[58][1][0], (Ull)b3[CHIP],(Ull)z, 13, (Ull)b[CHIP], 8*736LL, 0, 0, (Ull)((void *)0), 8*736LL); mop(0x02, 1, &BR[58][2][1], (Ull)a[45], (Ull)rofs, 12, (Ull)a[45], 736LL, 0, 0, (Ull)((void *)0), 736LL);
