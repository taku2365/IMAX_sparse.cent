...
main()
{
  ...
  reset_nanosec();
  A_sparse = sparse_format5(nnz_A,A,A_tmp,col_index_A,row_index_A,736LL,736LL,params,sort_index,"/home/takuya-s/IMAX_sparse.cent/sample/test/sparse_data.wb",0);
  get_nanosec(0);
  show_nanosec();
  for (row=0; row<736LL; row++) {
    for (col=0; col<736LL; col++){
