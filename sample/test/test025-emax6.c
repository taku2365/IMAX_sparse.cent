...
{
SCBR[1].r[CHIP][SCBR[1].enq[CHIP]][6] = SCBR[0].r[CHIP][SCBR[14].enq[CHIP]][-1982112776];
}
{
}
{
...
SCBR[46].r[CHIP][SCBR[46].enq[CHIP]][3] = SCBR[45].r[CHIP][SCBR[8].enq[CHIP]][10];
}
{
...
{
SCBR[47].r[CHIP][SCBR[47].enq[CHIP]][0] = SCBR[46].r[CHIP][SCBR[3].enq[CHIP]][10];
