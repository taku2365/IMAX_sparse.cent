...
#ifdef EMAXSC
/* EMAXSC start */
SCBR[1].r[0][0][3] = BR[1][2][1];
SCBR[1].r[0][1][3] = BR[1][2][1];
SCBR[1].r[1][0][3] = BR[1][2][1];
SCBR[1].r[1][1][3] = BR[1][2][1];
SCBR[1].r[2][0][3] = BR[1][2][1];
SCBR[1].r[2][1][3] = BR[1][2][1];
SCBR[1].r[3][0][3] = BR[1][2][1];
SCBR[1].r[3][1][3] = BR[1][2][1];
SCBR[62].r[0][0][0] = AR[61][0];
SCBR[62].r[0][1][0] = AR[61][0];
SCBR[62].r[1][0][0] = AR[61][0];
SCBR[62].r[1][1][0] = AR[61][0];
SCBR[62].r[2][0][0] = AR[61][0];
SCBR[62].r[2][1][0] = AR[61][0];
SCBR[62].r[3][0][0] = AR[61][0];
SCBR[62].r[3][1][0] = AR[61][0];
SCBR[62].r[0][0][3] = AR[61][1];
SCBR[62].r[0][1][3] = AR[61][1];
SCBR[62].r[1][0][3] = AR[61][1];
SCBR[62].r[1][1][3] = AR[61][1];
SCBR[62].r[2][0][3] = AR[61][1];
SCBR[62].r[2][1][3] = AR[61][1];
SCBR[62].r[3][0][3] = AR[61][1];
SCBR[62].r[3][1][3] = AR[61][1];
SCBR[62].r[0][0][4] = AR[61][2];
SCBR[62].r[0][1][4] = AR[61][2];
SCBR[62].r[1][0][4] = AR[61][2];
SCBR[62].r[1][1][4] = AR[61][2];
SCBR[62].r[2][0][4] = AR[61][2];
SCBR[62].r[2][1][4] = AR[61][2];
SCBR[62].r[3][0][4] = AR[61][2];
SCBR[62].r[3][1][4] = AR[61][2];
SCBR[62].r[0][0][7] = AR[61][3];
SCBR[62].r[0][1][7] = AR[61][3];
SCBR[62].r[1][0][7] = AR[61][3];
SCBR[62].r[1][1][7] = AR[61][3];
SCBR[62].r[2][0][7] = AR[61][3];
SCBR[62].r[2][1][7] = AR[61][3];
SCBR[62].r[3][0][7] = AR[61][3];
SCBR[62].r[3][1][7] = AR[61][3];
...
/* EMAXSC end */
	...
	*(Uint*)&emax6.lmmi[3][62][0][emax6.lmmic] = 0x1c1f10e7|(1<<2);
	...
	((struct reg_ctrl*)emax6.reg_ctrl)->i[0].breg[1][0].br[3] = BR[1][2][1];
	((struct reg_ctrl*)emax6.reg_ctrl)->i[0].breg[62][0].br[0] = AR[61][0];
	((struct reg_ctrl*)emax6.reg_ctrl)->i[0].breg[62][0].br[3] = AR[61][1];
	((struct reg_ctrl*)emax6.reg_ctrl)->i[0].breg[62][1].br[0] = AR[61][2];
	((struct reg_ctrl*)emax6.reg_ctrl)->i[0].breg[62][1].br[3] = AR[61][3];
...
"	.word	0x00000000, 0x00000000\n"
"	.word	0x00000000, 0x00000000\n"
"	.word	0x00602027, 0x00000000\n"
"	.word	0xffff0000, 0x60d81d81\n"
"	.word	0x00806000, 0x0002811e\n"
"	.word	0x00000000, 0x00000000\n"
"	.word	0x00600027, 0x00000000\n"
"	.word	0xffff0000, 0x60d81d81\n"
"	.word	0x00802000, 0x0002811e\n"
"	.word	0x00000000, 0x00000000\n"
"	.word	0x0060a027, 0x00000000\n"
"	.word	0xffff0000, 0x00000000\n"
"	.word	0x00000000, 0x00000000\n"
"	.word	0x00000000, 0x00000000\n"
"	.word	0x00608027, 0x00000000\n"
"	.word	0xffff0000, 0x00000000\n"
"	.word	0x00000000, 0x00000000\n"
"	.word	0x00000000, 0x00000000\n"
"	.word	0x00000001, 0x00000000\n"
"	.word	0xffff0000, 0x30d81d81\n"
"	.word	0x00a07300, 0x0002815e\n"
"	.word	0x00000000, 0x00000000\n"
"	.word	0x00000001, 0x00000000\n"
"	.word	0xffff0000, 0x30d81d81\n"
