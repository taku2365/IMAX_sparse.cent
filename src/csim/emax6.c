...
struct exring { /* ex status of EMAX6 */
  Ull   cmd_busy        : 1; /* ¡ú¡ú¡úreg_ctrl.stat¤ËÄ¾ÀÜÈ¿±Ç¡ú¡ú¡ú */
  Ull   unit_busy       : 1; /* ¡ú¡ú¡úreg_ctrl.stat¤ËÄ¾ÀÜÈ¿±Ç¡ú¡ú¡ú */
  Ull   cycle           : 3;
  ...
  struct unit { /* hardware status of EMAX6 units */
    ...
    Ull   unit1_exec    : 1; /* ¼¡¤ÎÆ°ºî¤ò»Ø¼¨ (cex,exe,eag), 0:wait 1:exec *//* ¡ú¡ú¡úreg_ctrl.stat¤ËÄ¾ÀÜÈ¿±Ç¡ú¡ú¡ú */
    ...
    Ull   unit2_exec    : 1; /* ¼¡¤ÎÆ°ºî¤ò»Ø¼¨ (lmm),         0:wait 1:exec *//* ¡ú¡ú¡úreg_ctrl.stat¤ËÄ¾ÀÜÈ¿±Ç¡ú¡ú¡ú */
    ...
    Ull   lmea0sfma     : 1; /* wire *//* sfma+ea0.stbrÂ¸ºß¡ú¡ú¡ú4¥µ¥¤¥¯¥ë¤ËÊ¬¤±¤Æ¼Â¹Ô */
    Ull   lmea0strq     : 1; /* wire *//* ea0.strqÂ¸ºß     ¡ú¡ú¡ú4¥µ¥¤¥¯¥ë¤ËÊ¬¤±¤Æ¼Â¹Ô */
    Ull   lmea0strqcol  : 2; /* wire *//* ea0.strq_colÈÖ¹æ ¡ú¡ú¡ú4¥µ¥¤¥¯¥ë¤ËÊ¬¤±¤Æ¼Â¹Ô */
     ...
     Uint cid; Uint trace, trace_pipe;
{
  ...
  /* find top_row */
  for (row0=0; row0<EMAX_DEPTH; row0++)           /* ¡ú¡úEXRING¤ÏÏÀÍýrow0¤«¤ésiml¤¹¤ëÉ¬Í×¤¬¤¢¤ê,LMRING¤â¹ç¤ï¤»¤ë */
    if (exring[cid].unit[row0].l_row == 0) break; /* ¡ú¡úLMRING¤Ï¼ÂºÝ¤Ë¤ÏÊªÍýrow0¤¬fsm¤ËÀÜÂ³¤µ¤ì¤Æ¤¤¤ë¤¬,siml»þ¤ÏÏÀÍýrow0¤¬ÀèÆ¬¤È¹Í¤¨¤ÆÌäÂê¤Ê¤¤ */
...
siml_axi_iorq(cid, trace) Uint cid, trace;
{
  ...
  /* row0+DEPTH-1              1        |            V        ¢¬                                     */
  /*   ¡úsimlµ¯ÅÀ(brout¤ÏÄê¿ô)   unit[].lmring_br -------  SIMLµ¯ÅÀ(1¦ÓÁ°¤Î¼¡ÃÊdeq_wait¤ò»È¤¦.Àµ¾ï)  */
  /* row0                     62        |            V   ¡úSIMLºÇ¸å(Á°ÃÊbr¤ÎÃÍ¤¬1¦ÓÌ¤Íè¤Ë¤Ê¤ë)       */
  /*                             unit[].lmring_br -------     ¢¬                                     */
  /* row0+1                   63        |            V                                               */
  ...
  /* iorq.rob                                                                                                                                                                                                 */
  /* rdata[]    SLAVE                                                   -----<=D=====>---                                                                                                                     */
  /* rvalid     SLAVE                                                   _____/~~~~~¡ú\___                                                                                                                     */
  /* rlast      SLAVE                                                   _____/~~~~~~~\___                                                                                                                     */
  /* rready    MASTER*                                                  _____/~~~~~¡ú\___                                                                                                                     */
  /************************************************************************************************************************************************************************************************************/
...
siml_iorq_axi(cid, trace) Uint cid, trace;
{
  ...
  /* awaddr    MASTER*  -----<=A=====>---                                                                                                                                                                     */
  /* awlen     MASTER*  -----<=0=====>---                                                                                                                                                                     */
  /* awvalid   MASTER*  ___¡ú/~~~~~~~\___ valid=1                                                                                                                                                             */
  /* awready    SLAVE   ~~~~~~~~~~~~~\___ ready=1»þ¤Ë¼ø¼õ                                                                                                                                                     */
  /* wstrb     MASTER*  -----<=M=====>---                                                                                                                                                                     */
  /* wdata[]   MASTER*  -----<=D=====>---                                                                                                                                                                     */
  /* wvalid    MASTER*  ___¡ú/~~~~~~~\___                                                                                                                                                                     */
  /* wlast     MASTER*  _____/~~~~~~~\___ PIO¤Î¾ì¹ç,¾ï¤Ë1                                                                                                                                                     */
  /* wready     SLAVE   ~~~~~~~~~~~~~\___                                                                                                                                                                     */
  /* araddr    MASTER*                                  -----<=A=====>---                                                                                                                                     */
  /* arlen     MASTER*                                  -----<=0=====>---                                                                                                                                     */
  /* arvalid   MASTER*                                  ___¡ú/~~~~~~~\___                                                                                                                                     */
  /* arready    SLAVE                                   ~~~~~~~~~~~~~\___                                                                                                                                     */
  /************************************************************************************************************************************************************************************************************/
...
siml_axi_lmring(cid, trace) Uint cid, trace;
{
  ...
  /* awaddr    MASTER   -----<=A=====>---                                                                                                                                                                     */
  /* awlen     MASTER   -----<=0=====>---                                                                                                                                                                     */
  /* awvalid   MASTER   _____/~~~~~¡ú\___ valid=1                                                                                                                                                             */
  /* awready    SLAVE*  ~~~~~~~~~~~¡ú\___ ready=1¤Î»þ¤Ë¼ø¼õ                                                                                                                                                   */
  /* wstrb     MASTER   -----<=M=====>---                                                                                                                                                                     */
  /* wdata[]   MASTER   -----<=D=====>---                                                                                                                                                                     */
  /* wvalid    MASTER   _____/~~~~~¡ú\___                                                                                                                                                                     */
  /* wlast     MASTER   _____/~~~~~~~\___ PIO¤Î¾ì¹ç,¾ï¤Ë1                                                                                                                                                     */
  /* wready     SLAVE*  ~~~~~~~~~~~¡ú\___                                                                                                                                                                     */
  /* araddr    MASTER                A                          -----<=A=====>---                                                                                                                             */
  /* arlen     MASTER                |                          -----<=0=====>---                                                                                                                             */
  /* arvalid   MASTER                |                          _____/~~~~~¡ú\___                                                                                                                             */
  /* arready    SLAVE*               |                          ~~~~~~~~~~~¡ú\___                                                                                                                             */
  /* axiif_busy           *                                             _____/~~~~~~~~~~~                                                                                                                     */
  /* axiif_srw            *     -----<=1=====>---                       -----<=0=====>---                                                                                                                     */
  /* axiif_sadr           *     -----<=A=====>---                       -----<=A=====>---                                                                                                                     */
...
/*¡ú*/  bi = (reg_ctrl.i[cid].conf[i][k].cdw1.ea0bs&2)? i : pi; /* if ea0 takes eabbrs, shuold be i (else ea1(load) from pi) */
...
#endif
/*¡ú*/s = reg_ctrl.i[cid].conf[i][k].cdw1.eabbrs; exring[cid].unit[i].eab   = exring[cid].unit[bi].b[b][s/UNIT_WIDTH].r[s%UNIT_WIDTH]; //¡ú¤³¤³¤¬SFMA+STBR¤Îµ¯¸»
      ...
      /* ¡ú¡ú¡úSTRQ/SFMA+STBR¤ÏSTR¤ò4¥µ¥¤¥¯¥ëÊ¬³ä¼Â¹Ô¡ú¡ú¡ú */
      /* ¡ú¡ú¡úexring[cid].unit[i].lmea0strq ¤È exring[cid].unit[i].lmea0strqcol ¤Ï siml_unit_stage4()¤Ë¤ÆÀè¹Ô¥»¥Ã¥È */
...
siml_unit_stage2(Uint cid, Uint i) /* stage-2 (EX/TX->1DR) */
{
  ...
  case CMD_EXEC:  /* exec */
	...
	ex1_retval = exe(op_ex1, &exring[cid].unit[i].ex2dr, r1, exp1, r2, exp2, r3, exp3, op_ex2, r4, op_ex3, r5);
      ...
      k     = (exring[cid].unit[i].lmea0sfma || exring[cid].unit[i].lmea0strq) ? exring[cid].unit[i].lmea0strqcol : j;
/*¡ú*/eag(&exring[cid].unit[i].ea02dr, base0, offs0, reg_ctrl.i[cid].conf[i][k].cdw1.ea0msk);
...
siml_unit_stage4(Uint cid, Uint i) /* stage-4 (2DR->3DR)  (LMRING_BRIN->LMRING_TR) */
{
  ...
  /* OP_IM_PREF      0x1f lmring-writeÆ°ºî ¡ú¼«¿È¤Ê¤Î¤Ç´³¾Ä¤·¤Ê¤¤ */

  /* op1                      */
  /* OP_LDR          0x01 ... */
  /* OP_IM_BUFRD     0x0e ----¤³¤³¤Þ¤Çeag¤È´³¾Ä */
  /* OP_IM_DRAIN     0x0f lmring-readÆ°ºî ¡ú¼«¿È¤Ê¤Î¤Ç´³¾Ä¤·¤Ê¤¤ */
  /* OP_LDDMQ        0x18 lmring-readÆ°ºî ¡ú¼«¿È¤Ê¤Î¤Ç´³¾Ä¤·¤Ê¤¤ */
  /* OP_TR           0x19 lmring-readÆ°ºî ¡ú¼«¿È¤Ê¤Î¤Ç´³¾Ä¤·¤Ê¤¤ */
...
printf("====== WLMM row=%x br.col=%x ====axir=%x axiw=%x br->rw=%x br->ty=%x a=%08.8x lmranger_ok=%x lmrangew_ok=%x top=%08.8x bot=%08.8x\n", i, br->col, reg_ctrl.i[cid].conf[i][br->col].cdw2.lmm_axir, reg_ctrl.i[cid].conf[i][br->col].cdw2.lmm_axiw, br->rw, br->ty, br->a, exring[cid].unit[i].lmranger_ok, exring[cid].unit[i].lmrangew_ok, reg_ctrl.i[cid].addr[i][br->col].top, reg_ctrl.i[cid].addr[i][br->col].bot);
	...
	exring[cid].unit[i].lmm.mw0[3] = exring[cid].unit[i].mwmux[3]<<(exring[cid].unit[i].ea03dr & (sizeof(int)|sizeof(short)|sizeof(char)))*8; /* alignÉ¬Í× */
      ...
      case OP_IM_PREF:
      case OP_IM_BUFWR:
        exring[cid].unit[i].lmm.mm0    = 0xffffffff;         /* mask *//* ¡ú¡ú¡ú»ÃÄêµ­½Ò¡ú¡ú¡ú */
        exring[cid].unit[i].lmm.mw0[0] = exring[cid].unit[i].mwmux[0]; /* ¡ú¡ú¡ú»ÃÄêµ­½Ò¡ú¡ú¡ú */
        exring[cid].unit[i].lmm.mw0[1] = exring[cid].unit[i].mwmux[1]; /* ¡ú¡ú¡ú»ÃÄêµ­½Ò¡ú¡ú¡ú */
        exring[cid].unit[i].lmm.mw0[2] = exring[cid].unit[i].mwmux[2]; /* ¡ú¡ú¡ú»ÃÄêµ­½Ò¡ú¡ú¡ú */
        exring[cid].unit[i].lmm.mw0[3] = exring[cid].unit[i].mwmux[3]; /* ¡ú¡ú¡ú»ÃÄêµ­½Ò¡ú¡ú¡ú */
        break;
      case OP_STRQ: /* OP_STRQ in target   slot */
        if (exring[cid].unit[i].lmea0strq) {
          /* ¡ú¡ú¡úSTRQ¤ÏSTR¤ò4¥µ¥¤¥¯¥ëÊ¬³ä¼Â¹Ô¡ú¡ú¡ú */
...
printf("====== WREG chip=%d cdx=%d l_row=%x row=%x cmd=%d ==== tr->ty=%x a=%08.8x dm=%08.8x d=%08.8x%08.8x_%08.8x%08.8x_%08.8x%08.8x_%08.8x%08.8x\n", (Uint)(reg_ctrl.i[cid].cmd>>16), cdx, exring[cid].unit[i].l_row, row, exring[cid].unit[i].cmd&3, tr->ty, tr->a, tr->dm, (Uint)(tr->d[3]>>32), (Uint)(tr->d[3]), (Uint)(tr->d[2]>>32), (Uint)(tr->d[2]), (Uint)(tr->d[1]>>32), (Uint)(tr->d[1]), (Uint)(tr->d[0]>>32), (Uint)(tr->d[0]));
    ...
    case 2: /* reg/addr */
      ...
      break;
    case 3: /* lddmq/tr */
      if      (tr->dm & 0x000000ff) { *((Ull *)((Uchar*)&reg_ctrl.i[cid].lddmrw[i]+ofs)+0) = tr->d[0];   }/* ¡ú¡ú¡ú only write is implemented */
      if      (tr->dm & 0x0000ff00) { *((Ull *)((Uchar*)&reg_ctrl.i[cid].lddmrw[i]+ofs)+1) = tr->d[1];   }/* ¡ú¡ú¡ú only write is implemented */
      if      (tr->dm & 0x00ff0000) { *((Ull *)((Uchar*)&reg_ctrl.i[cid].lddmrw[i]+ofs)+2) = tr->d[2];   }/* ¡ú¡ú¡ú only write is implemented */
      if      (tr->dm & 0xff000000) { *((Ull *)((Uchar*)&reg_ctrl.i[cid].lddmrw[i]+ofs)+3) = tr->d[3];   }/* ¡ú¡ú¡ú only write is implemented */
      break;
    }
  }
