...
// double sum=0,sum1=0;
// FILE* fp;
// Uint size_array_index,row_size_array_len;
// Uint memsize_tmp;
// Sll H;
...
// row_size_array_len = 6;
// Uint row_size_array[6] = {1024,512,256,128,64,32};
...
// for(size_array_index=0;size_array_index<row_size_array_len;size_array_index++){
//     for(sparse_rate_index=0;sparse_rate_index<sparse_rate_len;sparse_rate_index++){
//         A_row_size = params->A_row_size_param = 1024LL;
...
// size_array_len = 4;
// Uint size_array[4] = {256,128,64,32};
// size_array_len = 1;
...
for(size_array_index=0;size_array_index<size_array_len;size_array_index++){
    for(sparse_rate_index=0;sparse_rate_index<sparse_rate_len;sparse_rate_index++){
        A_row_size = params.A_row_size_param = 1003LL;
