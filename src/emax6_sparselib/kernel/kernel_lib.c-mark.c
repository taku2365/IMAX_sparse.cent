...
/-EMAX5AS-/         //LOOP1--はLOOP1==1で終了するので、LOOP1はrow+1がよい
/-EMAX5AS-/    /*1*/ for (INIT1=1,LOOP1=""RMGRP/(W*2)"",cofs=""(0-W*4*2*B_row_size)<<32|((0-W*4*2*B_row_size)&0xffffffff)""; LOOP1--; INIT1=0) {      /* stage#0 *//* mapped to FOR() on BR[63][0][0] */
/-EMAX5AS-/   /*2*/    for (INIT0=1,LOOP0=""A_margin_tmp"",rofs=""(0-(Ull)1*8)<<32|((0-(Ull)1*4)&0xffffffff)""; LOOP0--; INIT0=0) {  /* stage#0 *//* mapped to FOR() on BR[63][1][0] */
/-EMAX5AS-/             exe(OP_ADD,    &cofs, cofs, EXP_H3210, INIT0? (W*4*2*B_row_size)<<32|(W*4*2*B_row_size):0, EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#0 */
/-EMAX5AS-/             exe(OP_ADD,    &rofs, INIT0?rofs:rofs, EXP_H3210, ((Ull)1*8)<<32|(((Ull)1*4)&0xffffffff), EXP_H3210, 0LL, EXP_H3210, OP_AND, 0xffffffffffffffffLL, OP_NOP, 0LL);/* stage#0 */
/-EMAX5AS-/             exe(OP_ADD,    &oofs, cofs, EXP_H3210, 0, EXP_H3210, 0, EXP_H3210, OP_NOP, 0LL, OP_SLL, 0);            /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,3, &BR[1][1][1],  (Ull)a_index[0], (Ull)rofs, MSK_W1, (Ull)a_index[0], A_row_size*2*4*2, 0, 0, (Ull)NULL, A_row_size*2*4*2);             /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,3, &BR[1][1][0],  (Ull)a_index[1], (Ull)rofs, MSK_W1, (Ull)a_index[0], A_row_size*2*4*2, 0, 0, (Ull)NULL, A_row_size*2*4*2);             /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,3, &BR[1][2][1],  (Ull)a_index[2], (Ull)rofs, MSK_W1, (Ull)a_index[0], A_row_size*2*4*2, 0, 0, (Ull)NULL, A_row_size*2*4*2);             /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,3, &BR[1][2][0],  (Ull)a_index[3], (Ull)rofs, MSK_W1, (Ull)a_index[0], A_row_size*2*4*2, 0, 0, (Ull)NULL, A_row_size*2*4*2);             /* stage#1 */
/-EMAX5AS-/ 
/-EMAX5AS-/             exe(OP_ADD, &x, BR[1][1][1], EXP_H3210, cofs, EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);                                /* stage#2 */
/-EMAX5AS-/             exe(OP_ADD, &y, BR[1][1][0], EXP_H3210, cofs, EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);                                /* stage#2 */
/-EMAX5AS-/             exe(OP_ADD, &z, BR[1][2][1], EXP_H3210, cofs, EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);                                /* stage#2 */
/-EMAX5AS-/             exe(OP_ADD, &t, BR[1][2][0], EXP_H3210, cofs, EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);                                /* stage#2 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[3][0][1], (Ull)b0[CHIP], x, MSK_W0, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL, RMGRP*B_row_size);             /* stage#2 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[3][0][0], (Ull)b1[CHIP], x, MSK_W0, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL, RMGRP*B_row_size);             /* stage#2 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[3][1][1], (Ull)b2[CHIP], x, MSK_W0, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL, RMGRP*B_row_size);             /* stage#2 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[3][1][0], (Ull)b3[CHIP], x, MSK_W0, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL, RMGRP*B_row_size);             /* stage#2 2KB */
/-EMAX5AS-/             mop(OP_LDWR, 1, &BR[3][2][1], (Ull)a[0], (Ull)rofs, MSK_W0, (Ull)a[0], A_row_size, 0, 0, (Ull)NULL, A_row_size); /* stage#2 16KB */
/-EMAX5AS-/ 
/-EMAX5AS-/             exe(OP_FML, &AR[4][0], BR[3][0][1], EXP_H3210,  BR[3][2][1], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#3 */
/-EMAX5AS-/             exe(OP_FML, &AR[4][1], BR[3][0][0], EXP_H3210,  BR[3][2][1], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#3 */
/-EMAX5AS-/             exe(OP_FML, &AR[4][2], BR[3][1][1], EXP_H3210,  BR[3][2][1], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#3 */
/-EMAX5AS-/             exe(OP_FML, &AR[4][3], BR[3][1][0], EXP_H3210,  BR[3][2][1], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#3 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[4][0][1],  (Ull)b0[CHIP],(Ull)x, MSK_W1, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL,  RMGRP*B_row_size);
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[4][0][0],  (Ull)b1[CHIP],(Ull)x, MSK_W1, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL,  RMGRP*B_row_size);
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[4][1][1],  (Ull)b2[CHIP],(Ull)x, MSK_W1, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL,  RMGRP*B_row_size);
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[4][1][0],  (Ull)b3[CHIP],(Ull)x, MSK_W1, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL,  RMGRP*B_row_size);
/-EMAX5AS-/             mop(OP_LDWR, 1, &BR[4][2][1],  (Ull)a[1],    (Ull)rofs, MSK_W0, (Ull)a[1], A_row_size, 0, 0, (Ull)NULL, A_row_size);
/-EMAX5AS-/             
/-EMAX5AS-/             sparse_core1_1(5,  4,  5,  4,     2,           y,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(6,  5,  6,  5,     3,           y,MSK_W1);
/-EMAX5AS-/             sparse_core1_1(7,  6,  7,  6,     4,           z,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(8,  7,  8,  7,     5,           z,MSK_W1);
/-EMAX5AS-/             sparse_core1_1(9,  8,  9,  8,     6,           t,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(10, 9,  10, 9,     7,           t,MSK_W1);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core2(  11, 10, 11, 10,        4,5,6,7,0);
/-EMAX5AS-/             sparse_core3_1(12, 11, 13, 11,    8,  x,y,z,t, x,MSK_W0);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core1_1(14, 11, 14, 13,    9,           x,MSK_W1);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core1_1(15, 14, 15, 14,    10,          y,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(16, 15, 16, 15,    11,          y,MSK_W1);
/-EMAX5AS-/             sparse_core1_1(17, 16, 17, 16,    12,          z,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(18, 17, 18, 17,    13,          z,MSK_W1);
/-EMAX5AS-/             sparse_core1_1(19, 18, 19, 18,    14,          t,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(20, 19, 20, 19,    15,          t,MSK_W1);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core2(  21, 20, 21, 20,        8,9,10,11,8);
/-EMAX5AS-/             sparse_core3_1(22, 21, 23, 21,    16, x,y,z,t, x,MSK_W0);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core1_1(24, 21, 24, 23,    17,          x,MSK_W1);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core1_1(25, 24, 25, 24,    18,          y,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(26, 25, 26, 25,    19,          y,MSK_W1);
/-EMAX5AS-/             sparse_core1_1(27, 26, 27, 26,    20,          z,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(28, 27, 28, 27,    21,          z,MSK_W1);
/-EMAX5AS-/             sparse_core1_1(29, 28, 29, 28,    22,          t,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(30, 29, 30, 29,    23,          t,MSK_W1);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core2(  31, 30, 31, 30,        12,13,14,15,8);
/-EMAX5AS-/             sparse_core3_1(32, 31, 33, 31,    24, x,y,z,t, x,MSK_W0);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core1_1(34, 31, 34, 33,    25,          x,MSK_W1);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core1_1(35, 34, 35, 34,    26,          y,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(36, 35, 36, 35,    27,          y,MSK_W1);
/-EMAX5AS-/             sparse_core1_1(37, 36, 37, 36,    28,          z,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(38, 37, 38, 37,    29,          z,MSK_W1);
/-EMAX5AS-/             sparse_core1_1(39, 38, 39, 38,    30,          t,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(40, 39, 40, 39,    31,          t,MSK_W1);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core2(  41, 40, 41, 40,        16,17,18,19,16);
/-EMAX5AS-/             sparse_core3_1(42, 41, 43, 41,    32, x,y,z,t, x,MSK_W0);
/-EMAX5AS-/    
/-EMAX5AS-/             sparse_core1_1(44, 41, 44, 43,    33,          x,MSK_W1);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core1_1(45, 44, 45, 44,    34,          y,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(46, 45, 46, 45,    35,          y,MSK_W1);
/-EMAX5AS-/             sparse_core1_1(47, 46, 47, 46,    36,          z,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(48, 47, 48, 47,    37,          z,MSK_W1);
/-EMAX5AS-/             sparse_core1_1(49, 48, 49, 48,    38,          t,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(50, 49, 50, 49,    39,          t,MSK_W1);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core2_1(51, 50, 51, 50,        20,21,22,16);
/-EMAX5AS-/             sparse_core3_1(52, 51, 53, 51,    40, x,y,z,t, x,MSK_W0);
/-EMAX5AS-/    
/-EMAX5AS-/             sparse_core1_1(54, 51, 54, 53,    41,           x,MSK_W1);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core1_1(55, 54, 55, 54,    42,             y,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(56, 55, 56, 55,    43,             y,MSK_W1);
/-EMAX5AS-/             sparse_core1_1(57, 56, 57, 56,    44,             z,MSK_W0);
/-EMAX5AS-/             sparse_core1_1(58, 57, 58, 57,    45,             z,MSK_W1);
/-EMAX5AS-/             sparse_core4(  59, 58, 59, 58);
/-EMAX5AS-/             exe(OP_ADD, &x, BR[59][0][1], EXP_H3210, oofs, EXP_H3210, 0LL, EXP_H3210, OP_AND, 0xffffffff,  OP_NOP, 0LL);
/-EMAX5AS-/             
/-EMAX5AS-/             sparse_final1(62,59,62,59,x);
/-EMAX5AS-/ 
/-EMAX5AS-/ 
/-EMAX5AS-/ 
/-EMAX5AS-/           }
...
/-EMAX5AS-/ /*3*/ for (CHIP=0; CHIP<NCHIP; CHIP++) { /* will be parallelized by multi-chip (M/#chip) */
/-EMAX5AS-/         //LOOP1--はLOOP1==1で終了するので、LOOP1はrow+1がよい
/-EMAX5AS-/   /*2*/ for (INIT1=1,LOOP1=""A_margin_tmp"",rofs=""(0-(Ull)1*8)<<32|((0-(Ull)1*4)&0xffffffff)""; LOOP1--; INIT1=0) {  /* stage#0 *//* mapped to FOR() on BR[63][1][0] */
/-EMAX5AS-/     /*1*/ for (INIT0=1,LOOP0=""RMGRP/(W*2)"",cofs=""(0-W*4*2*B_row_size)<<32|((0-W*4*2*B_row_size)&0xffffffff)""; LOOP0--; INIT0=0) {      /* stage#0 *//* mapped to FOR() on BR[63][0][0] */
/-EMAX5AS-/             exe(OP_ADD,    &cofs, INIT0?cofs:cofs, EXP_H3210, (W*4*2*B_row_size)<<32|(W*4*2*B_row_size), EXP_H3210, 0LL, EXP_H3210, OP_AND, 0xffffffffffffffffLL, OP_NOP, 0LL);/* stage#0 */
/-EMAX5AS-/             exe(OP_ADD,    &rofs, rofs, EXP_H3210, INIT0?((Ull)1*8)<<32|((Ull)1*4):0, EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#0 */
/-EMAX5AS-/             exe(OP_ADD,    &oofs, cofs, EXP_H3210, 0, EXP_H3210, 0, EXP_H3210, OP_NOP, 0LL, OP_SLL, OOFS_SHIFT);            /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,3, &BR[1][1][1],  (Ull)a_index[0], (Ull)rofs, MSK_W1, (Ull)a_index[0], A_row_size*2*4*2, 0, 0, (Ull)NULL, A_row_size*2*4*2);             /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,3, &BR[1][1][0],  (Ull)a_index[1], (Ull)rofs, MSK_W1, (Ull)a_index[0], A_row_size*2*4*2, 0, 0, (Ull)NULL, A_row_size*2*4*2);             /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,3, &BR[1][2][1],  (Ull)a_index[2], (Ull)rofs, MSK_W1, (Ull)a_index[0], A_row_size*2*4*2, 0, 0, (Ull)NULL, A_row_size*2*4*2);             /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,3, &BR[1][2][0],  (Ull)a_index[3], (Ull)rofs, MSK_W1, (Ull)a_index[0], A_row_size*2*4*2, 0, 0, (Ull)NULL, A_row_size*2*4*2);             /* stage#1 */
...
/-EMAX5AS-/             exe(OP_ADD, &x, BR[59][0][1], EXP_H3210, oofs, EXP_H3210, 0LL, EXP_H3210, OP_AND, 0xffffffff,  OP_NOP, 0LL);
/-EMAX5AS-/             
/-EMAX5AS-/             sparse_final2(62,59,62,59,x);
/-EMAX5AS-/ 
/-EMAX5AS-/ 
/-EMAX5AS-/ 
/-EMAX5AS-/           }
...
/-EMAX5AS-/ /*3*/ for (CHIP=0; CHIP<NCHIP; CHIP++) { /* will be parallelized by multi-chip (M/#chip) */
/-EMAX5AS-/         //LOOP1--はLOOP1==1で終了するので、LOOP1はrow+1がよい
/-EMAX5AS-/    /*1*/ for (INIT1=1,LOOP1=""A_col_blk"",cofs=""(0-A_row_size*8)<<32|((0-A_row_size*8)&0xffffffff)""; LOOP1--; INIT1=0) {      /* stage#0 *//* mapped to FOR() on BR[63][0][0] */
/-EMAX5AS-/   /*2*/    for (INIT0=1,LOOP0=""A_margin_tmp"",rofs=""(0-(Ull)1*8)<<32|((0-(Ull)1*4)&0xffffffff)""; LOOP0--; INIT0=0) {  /* stage#0 *//* mapped to FOR() on BR[63][1][0] */
/-EMAX5AS-/             exe(OP_ADD,    &cofs, cofs, EXP_H3210, INIT0? (A_row_size*8)<<32|(A_row_size*8):0, EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#0 */
/-EMAX5AS-/             exe(OP_ADD,    &rofs, INIT0?rofs:rofs, EXP_H3210, ((Ull)1*8)<<32|(((Ull)1*4)&0xffffffff), EXP_H3210, 0LL, EXP_H3210, OP_AND, 0xffffffffffffffffLL, OP_NOP, 0LL);/* stage#0 */
/-EMAX5AS-/             exe(OP_ADD,    &a_rofs, rofs, EXP_H3210, cofs, EXP_H3210, 0, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);            /* stage#1 */
/-EMAX5AS-/             exe(OP_ADD,    &oofs, cofs, EXP_H3210, 0, EXP_H3210, 0, EXP_H3210, OP_AND, 0xffffffff,OP_NOP, 0LL);            /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,  3, &a0, (Ull)a[0], (Ull)a_rofs, MSK_W1, (Ull)a[0], A_row_size*2*A_col_blk, 0, 0, (Ull)NULL, A_row_size*2*A_col_blk);             /* stage#1 */
/-EMAX5AS-/             mop(OP_LDWR, 1, &c_index, (Ull)A_sort_index, (Ull)rofs, MSK_W0, (Ull)A_sort_index, A_row_size, 0, 0, (Ull)NULL, A_row_size);
/-EMAX5AS-/ 
/-EMAX5AS-/             exe(OP_ADD,    &c_index, (Ull)c_index, EXP_H3210, 0, EXP_H3210, 0, EXP_H3210, OP_AND, 0xffffffff, OP_NOP, 0LL);            /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[3][0][1], (Ull)b0[CHIP], a0, MSK_W1, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL, RMGRP*B_row_size);             /* stage#2 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[3][0][0], (Ull)b1[CHIP], a0, MSK_W1, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL, RMGRP*B_row_size);             /* stage#2 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[3][1][1], (Ull)b2[CHIP], a0, MSK_W1, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL, RMGRP*B_row_size);             /* stage#2 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[3][1][0], (Ull)b3[CHIP], a0, MSK_W1, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL, RMGRP*B_row_size);             /* stage#2 2KB */
/-EMAX5AS-/             mop(OP_LDR,  3, &a1, (Ull)a[1], (Ull)a_rofs, MSK_W1, (Ull)a[1], A_row_size*2*A_col_blk, 0, 0, (Ull)NULL, A_row_size*2*A_col_blk); /* stage#2 16KB */
/-EMAX5AS-/ 
/-EMAX5AS-/             exe(OP_FML, &AR[4][0], a0, EXP_H1010, BR[3][0][1], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#3 */
/-EMAX5AS-/             exe(OP_FML, &AR[4][1], a0, EXP_H1010, BR[3][0][0], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#3 */
/-EMAX5AS-/             exe(OP_FML, &AR[4][2], a0, EXP_H1010, BR[3][1][1], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#3 */
/-EMAX5AS-/             exe(OP_FML, &AR[4][3], a0, EXP_H1010, BR[3][1][0], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#3 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[4][0][1],  (Ull)b0[CHIP],(Ull)a1, MSK_W1, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL,  RMGRP*B_row_size);
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[4][0][0],  (Ull)b1[CHIP],(Ull)a1, MSK_W1, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL,  RMGRP*B_row_size);
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[4][1][1],  (Ull)b2[CHIP],(Ull)a1, MSK_W1, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL,  RMGRP*B_row_size);
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[4][1][0],  (Ull)b3[CHIP],(Ull)a1, MSK_W1, (Ull)b[CHIP], RMGRP*B_row_size, 0, 0, (Ull)NULL,  RMGRP*B_row_size);
/-EMAX5AS-/             mop(OP_LDR,  3, &a2,  (Ull)a[2],    (Ull)a_rofs, MSK_W1, (Ull)a[2], A_row_size*2*A_col_blk, 0, 0, (Ull)NULL, A_row_size*2*A_col_blk);
/-EMAX5AS-/             
/-EMAX5AS-/ 
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core1_1(5,  4,  5  ,4 , 3 , a1 , a2 , a3 );
/-EMAX5AS-/             sparse_core1_1(6,  5,  6  ,5 , 4 , a2 , a3 , a4 );
/-EMAX5AS-/             sparse_core1_1(7,  6,  7  ,6 , 5 , a3 , a4 , a5 );
/-EMAX5AS-/             sparse_core1_1(8,  7,  8  ,7 , 6 , a4 , a5 , a6 );
/-EMAX5AS-/             sparse_core1_1(9,  8,  9  ,8 , 7 , a5 , a6 , a7 );
/-EMAX5AS-/             sparse_core1_1(10, 9,  10 ,9 , 8 , a6 , a7 , a8 );
/-EMAX5AS-/             sparse_core1_1(11, 10, 11 ,10, 9 , a7 , a8 , a9 );
/-EMAX5AS-/             sparse_core1_1(12, 11, 12 ,11, 10, a8 , a9 , a10);
/-EMAX5AS-/             sparse_core1_1(13, 12, 13 ,12, 11, a9 , a10, a11);
/-EMAX5AS-/             sparse_core1_1(14, 13, 14 ,13, 12, a10, a11, a12);
/-EMAX5AS-/             sparse_core1_1(15, 14, 15 ,14, 13, a11, a12, a13);
/-EMAX5AS-/             sparse_core1_1(16, 15, 16 ,15, 14, a12, a13, a14);
/-EMAX5AS-/             sparse_core1_1(17, 16, 17 ,16, 15, a13, a14, a15);
/-EMAX5AS-/             sparse_core1_1(18, 17, 18 ,17, 16, a14, a15, a16);
/-EMAX5AS-/             sparse_core1_1(19, 18, 19 ,18, 17, a15, a16, a17);
/-EMAX5AS-/             sparse_core1_1(20, 19, 20 ,19, 18, a16, a17, a18);
/-EMAX5AS-/             sparse_core1_1(21, 20, 21 ,20, 19, a17, a18, a19);
/-EMAX5AS-/             sparse_core1_1(22, 21, 22 ,21, 20, a18, a19, a20);
/-EMAX5AS-/             sparse_core1_1(23, 22, 23 ,22, 21, a19, a20, a21);
/-EMAX5AS-/             sparse_core1_1(24, 23, 24 ,23, 22, a20, a21, a22);
/-EMAX5AS-/             sparse_core1_1(25, 24, 25 ,24, 23, a21, a22, a23);
/-EMAX5AS-/             sparse_core1_1(26, 25, 26 ,25, 24, a22, a23, a24);
/-EMAX5AS-/             sparse_core1_1(27, 26, 27 ,26, 25, a23, a24, a25);
/-EMAX5AS-/             sparse_core1_1(28, 27, 28 ,27, 26, a24, a25, a26);
/-EMAX5AS-/             sparse_core1_1(29, 28, 29 ,28, 27, a25, a26, a27);
/-EMAX5AS-/             sparse_core1_1(30, 29, 30 ,29, 28, a26, a27, a28);
/-EMAX5AS-/             sparse_core1_1(31, 30, 31 ,30, 29, a27, a28, a29);
/-EMAX5AS-/             sparse_core1_1(32, 31, 32 ,31, 30, a28, a29, a30);
/-EMAX5AS-/             sparse_core1_1(33, 32, 33 ,32, 31, a29, a30, a31);
/-EMAX5AS-/             sparse_core1_1(34, 33, 34 ,33, 32, a30, a31, a32);
/-EMAX5AS-/             sparse_core1_1(35, 34, 35 ,34, 33, a31, a32, a33);
/-EMAX5AS-/             sparse_core1_1(36, 35, 36 ,35, 34, a32, a33, a34);
/-EMAX5AS-/             sparse_core1_1(37, 36, 37 ,36, 35, a33, a34, a35);
/-EMAX5AS-/             sparse_core1_1(38, 37, 38 ,37, 36, a34, a35, a36);
/-EMAX5AS-/             sparse_core1_1(39, 38, 39 ,38, 37, a35, a36, a37);
/-EMAX5AS-/             sparse_core1_1(40, 39, 40 ,39, 38, a36, a37, a38);
/-EMAX5AS-/             sparse_core1_1(41, 40, 41 ,40, 39, a37, a38, a39);
/-EMAX5AS-/             sparse_core1_1(42, 41, 42 ,41, 40, a38, a39, a40);
/-EMAX5AS-/             sparse_core1_1(43, 42, 43 ,42, 41, a39, a40, a41);
/-EMAX5AS-/             sparse_core1_1(44, 43, 44 ,43, 42, a40, a41, a42);
/-EMAX5AS-/             sparse_core1_1(45, 44, 45 ,44, 43, a41, a42, a43);
/-EMAX5AS-/             sparse_core1_1(46, 45, 46 ,45, 44, a42, a43, a44);
/-EMAX5AS-/             sparse_core1_1(47, 46, 47 ,46, 45, a43, a44, a45);
/-EMAX5AS-/ 
/-EMAX5AS-/             sparse_core2_1(48, 47, 48 ,47,     a44, a45);
/-EMAX5AS-/             sparse_core3_1(49, 48, 49 ,48,     a45);
/-EMAX5AS-/             // sparse_core1_1(48, 47, 48 ,47, 47, a45, a46, a47);
/-EMAX5AS-/             // sparse_core1_1(49, 48, 49 ,48, 48, a46, a47, a48);
/-EMAX5AS-/             // sparse_core1_1(50, 49, 50 ,49, 49, a47, a48, a49);
/-EMAX5AS-/             // sparse_core1_1(51, 50, 51 ,50, 50, a48, a49, a50);
/-EMAX5AS-/             // sparse_core1_1(52, 51, 52 ,51, 51, a49, a50, a51);
/-EMAX5AS-/             // sparse_core1_1(53, 52, 53 ,52, 52, a50, a51, a52);
/-EMAX5AS-/             // sparse_core1_1(54, 53, 54 ,53, 53, a51, a52, a53);
/-EMAX5AS-/             // sparse_core1_1(55, 54, 55 ,54, 54, a52, a53, a54);
/-EMAX5AS-/             // sparse_core1_1(56, 55, 56 ,55, 55, a53, a54, a55);
/-EMAX5AS-/             // sparse_core1_1(57, 56, 57 ,56, 56, a54, a55, a56);
/-EMAX5AS-/             // sparse_core1_1(58, 57, 58 ,57, 57, a55, a56, a57);
/-EMAX5AS-/             sparse_final1(  50, 49, 50, 49,c_index);
/-EMAX5AS-/             // sparse_final1(62,59,62,59,x);
/-EMAX5AS-/ 
/-EMAX5AS-/               
/-EMAX5AS-/               }
