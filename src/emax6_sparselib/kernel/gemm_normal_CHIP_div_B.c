...
//   size_t A_row_blk = params->A_row_blk_param;
//   size_t A_col_blk = params->A_col_blk_param;
//   size_t B_row_blk = params->B_row_blk_param;
//   size_t B_row_blk_tmp = 0,B_row_blk_tmp1 = 0;
//   size_t B_col_size_mul_A_row_blk = B_col_size*A_row_blk;
//   size_t B_col_size_mul_B_row_blk = B_col_size*B_row_blk;
//   size_t B_col_blk_mul_B_row_size = B_col_blk*(B_row_size+A_H_pad);
//   size_t A_row_size_mul_mul_A_col_blk = A_row_size*2*A_col_blk;
//   size_t A_col_size_mul_A_row_blk = (A_col_size+A_H_pad)*A_row_blk;
//   size_t A_row_size_mul_A_row_blk = A_row_size*A_row_blk;
//   size_t A_row_size_mul_8 = A_row_size*8;
//   size_t W_mul_8_64 =  (W*8)<<32|(W*8);
//   size_t cofs_init = (0-W*8)<<32|((0-W*8)&0xffffffff);
//   size_t rofs_init = (0-(A_col_size+A_H_pad)*4)<<32|((0-B_col_size*4)&0xffffffff);
//   size_t A_row_size_mul_8_64 = (A_row_size_mul_8)<<32|(A_row_size_mul_8);
//   size_t rofs_reverse = ((A_col_size+A_H_pad)*4)<<32|(B_col_size*4);
//   B_row_blk = 1;
//   // A_col_blk = 8;
