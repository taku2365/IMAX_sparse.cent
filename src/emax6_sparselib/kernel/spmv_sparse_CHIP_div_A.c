...
//     #define basecomponet()\
//             exe(OP_ADD,    &rofs, INIT0?rofs:rofs, EXP_H3210, 4*2*2LL<<32|4LL, EXP_H3210, 0LL, EXP_H3210, OP_AND, 0xffffffffffffffffLL, OP_NOP, 0LL);                                   \                    
...
//             mop(OP_LDR,  3, &BR[2][0][1], (Ull)a0_base[0], (Ull)a_rofs, MSK_W0, (Ull)a[0], A_row_size_mul_2_mul_A_col_blk, 0, Force, (Ull)NULL, A_row_size_mul_2_mul_A_col_blk);        \    
//             mop(OP_LDR,  3, &BR[2][1][1], (Ull)a1_base[0], (Ull)a_rofs, MSK_W0, (Ull)a[0], A_row_size_mul_2_mul_A_col_blk, 0, Force, (Ull)NULL, A_row_size_mul_2_mul_A_col_blk);        \    
//             exe(OP_ADD,    &c_index1, (Ull)c_index, EXP_H1010, 0LL, EXP_H3210, 0LL, EXP_H3210, OP_AND, 0xffffffff, OP_NOP, 0LL);           \
//             exe(OP_ADD,    &c_index2, (Ull)c_index, EXP_H1010, 4LL, EXP_H3210, 0LL, EXP_H3210, OP_AND, 0xffffffff, OP_NOP, 0LL);\
//             mop(OP_LDR,  3, &BR[3][0][1], (Ull)a0_base[1], (Ull)a_rofs, MSK_W0, (Ull)a[1], A_row_size_mul_2_mul_A_col_blk, 0, Force, (Ull)NULL, A_row_size_mul_2_mul_A_col_blk); \
//             mop(OP_LDR,  3, &BR[3][1][1], (Ull)a1_base[1], (Ull)a_rofs, MSK_W0, (Ull)a[1], A_row_size_mul_2_mul_A_col_blk, 0, Force, (Ull)NULL, A_row_size_mul_2_mul_A_col_blk); \
...
//             sparse_final(61,62,c_index1,c_index2);   
//             }
//         }
//     }
// //EMAX5A end
...
//             sparse_final(53,54,c_index1,c_index2);   
//             }
//         }
//     }
// //EMAX5A end
...
//             sparse_final(43,44,c_index1,c_index2);   
//             }
//         }
//     }
// //EMAX5A end
...
//             sparse_final(33,34,c_index1,c_index2);   
//             }
//         }
//     }
// //EMAX5A end
...
//             sparse_final(23,24,c_index1,c_index2);   
//             }
//         }
//     }
// //EMAX5A end
...
//             sparse_final(13,14,c_index1,c_index2);
