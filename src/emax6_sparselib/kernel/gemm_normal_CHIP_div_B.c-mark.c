...
/-EMAX5AS-/   /*2*/ for (INIT1=1,LOOP1=""B_col_blk"",rofs=""rofs_init""; LOOP1--; INIT1=0) { /* stage#0 *//* mapped to FOR() on BR[63][1][0] */
/-EMAX5AS-/     /*1*/ for (INIT0=1,LOOP0=""B_col_size/W/2"",cofs=""cofs_init""; LOOP0--; INIT0=0) {      /* stage#0 *//* mapped to FOR() on BR[63][0][0] */
/-EMAX5AS-/             exe(OP_ADD,    &cofs, INIT0?cofs:cofs, EXP_H3210, W_mul_8_64, EXP_H3210, 0LL, EXP_H3210, OP_AND, 0xffffffffffffffffLL, OP_NOP, 0LL);/* stage#0 */
/-EMAX5AS-/             exe(OP_ADD,    &rofs, rofs, EXP_H3210, INIT0?rofs_reverse:0, EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#0 */
/-EMAX5AS-/             exe(OP_ADD,    &oofs, rofs, EXP_H3210, cofs, EXP_H3210, 0, EXP_H3210, OP_AND, 0xffffffff, OP_NOP, 0LL);            /* stage#1 */
/-EMAX5AS-/ 
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[1][0][1],  (Ull)b0[0], (Ull)cofs, MSK_W1, (Ull)b[0], B_col_size, 0, 0, (Ull)NULL, B_col_size);             /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[1][0][0],  (Ull)b1[0], (Ull)cofs, MSK_W1, (Ull)b[0], B_col_size, 0, 0, (Ull)NULL, B_col_size);             /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[1][1][1],  (Ull)b2[0], (Ull)cofs, MSK_W1, (Ull)b[0], B_col_size, 0, 0, (Ull)NULL, B_col_size);             /* stage#1 */
/-EMAX5AS-/             mop(OP_LDR,  3, &BR[1][1][0],  (Ull)b3[0], (Ull)cofs, MSK_W1, (Ull)b[0], B_col_size, 0, 0, (Ull)NULL, B_col_size);             /* stage#1 2KB */
/-EMAX5AS-/             mop(OP_LDWR,1, &BR[1][2][1],  (Ull)a[0][CHIP],  (Ull)rofs, MSK_W1, (Ull)a0[CHIP], A_col_size_mul_B_col_blk, 0, 0, (Ull)NULL, A_col_size_mul_B_col_blk); /* stage#1 16KB */
/-EMAX5AS-/             exe(OP_FML, &AR[2][0], BR[1][0][1], EXP_H3210,  BR[1][2][1], EXP_H1010, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#2 */
/-EMAX5AS-/             exe(OP_FML, &AR[2][1], BR[1][0][0], EXP_H3210,  BR[1][2][1], EXP_H1010, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#2 */
/-EMAX5AS-/             exe(OP_FML, &AR[2][2], BR[1][1][1], EXP_H3210,  BR[1][2][1], EXP_H1010, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#2 */
/-EMAX5AS-/             exe(OP_FML, &AR[2][3], BR[1][1][0], EXP_H3210,  BR[1][2][1], EXP_H1010, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#2 */
/-EMAX5AS-/ 
/-EMAX5AS-/ 	    sgemm00_core1( 2,  1,  3);
/-EMAX5AS-/ 	    sgemm00_core1( 3,  2,  4);
/-EMAX5AS-/ 	    sgemm00_core1( 4,  3,  5);
/-EMAX5AS-/ 	    sgemm00_core1( 5,  4,  6);
/-EMAX5AS-/ 	    sgemm00_core1( 6,  5,  7);
/-EMAX5AS-/ 	    sgemm00_core1( 7,  6,  8);
/-EMAX5AS-/ 	    sgemm00_core1( 8,  7,  9);
/-EMAX5AS-/ 	    sgemm00_core1( 9,  8, 10);
/-EMAX5AS-/ 	    sgemm00_core1(10,  9, 11);
/-EMAX5AS-/ 	    sgemm00_core1(11, 10, 12);
/-EMAX5AS-/ 	    sgemm00_core1(12, 11, 13);
/-EMAX5AS-/ 	    sgemm00_core1(13, 12, 14);
/-EMAX5AS-/ 	    sgemm00_core1(14, 13, 15);
/-EMAX5AS-/ 	    sgemm00_core1(15, 14, 16);
/-EMAX5AS-/ 	    sgemm00_core1(16, 15, 17);
/-EMAX5AS-/ 	    sgemm00_core1(17, 16, 18);
/-EMAX5AS-/ 	    sgemm00_core1(18, 17, 19);
/-EMAX5AS-/ 	    sgemm00_core1(19, 18, 20);
/-EMAX5AS-/ 	    sgemm00_core1(20, 19, 21);
/-EMAX5AS-/ 	    sgemm00_core1(21, 20, 22);
/-EMAX5AS-/ 	    sgemm00_core1(22, 21, 23);
/-EMAX5AS-/ 	    sgemm00_core1(23, 22, 24);
/-EMAX5AS-/ 	    sgemm00_core1(24, 23, 25);
/-EMAX5AS-/ 	    sgemm00_core1(25, 24, 26);
/-EMAX5AS-/ 	    sgemm00_core1(26, 25, 27);
/-EMAX5AS-/ 	    sgemm00_core1(27, 26, 28);
/-EMAX5AS-/ 	    sgemm00_core1(28, 27, 29);
/-EMAX5AS-/ 	    sgemm00_core1(29, 28, 30);
/-EMAX5AS-/ 	    sgemm00_core1(30, 29, 31);
/-EMAX5AS-/ 	    sgemm00_core1(31, 30, 32);
/-EMAX5AS-/ 	    sgemm00_core1(32, 31, 33);
/-EMAX5AS-/ 	    sgemm00_core1(33, 32, 34);
/-EMAX5AS-/ 	    sgemm00_core1(34, 33, 35);
/-EMAX5AS-/ 	    sgemm00_core1(35, 34, 36);
/-EMAX5AS-/ 	    sgemm00_core1(36, 35, 37);
/-EMAX5AS-/ 	    sgemm00_core1(37, 36, 38);
/-EMAX5AS-/ 	    sgemm00_core1(38, 37, 39);
/-EMAX5AS-/ 	    sgemm00_core1(39, 38, 40);
/-EMAX5AS-/ 	    sgemm00_core1(40, 39, 41);
/-EMAX5AS-/ 	    sgemm00_core1(41, 40, 42);
/-EMAX5AS-/ 	    sgemm00_core1(42, 41, 43);
/-EMAX5AS-/ 	    sgemm00_core1(43, 42, 44);
/-EMAX5AS-/ 	    sgemm00_core1(44, 43, 45);
/-EMAX5AS-/ 	    sgemm00_core1(45, 44, 46);
/-EMAX5AS-/ 	    sgemm00_core1(46, 45, 47);
/-EMAX5AS-/ 	    sgemm00_core1(47, 46, 48);
/-EMAX5AS-/ 	    sgemm00_core1(48, 47, 49);
/-EMAX5AS-/ 	    sgemm00_core1(49, 48, 50);
/-EMAX5AS-/ 	    sgemm00_core1(50, 49, 51);
/-EMAX5AS-/ 	    sgemm00_core1(51, 50, 52);
/-EMAX5AS-/ 	    sgemm00_core1(52, 51, 53);
/-EMAX5AS-/ 	    sgemm00_core1(53, 52, 54);
/-EMAX5AS-/ 	    sgemm00_core1(54, 53, 55);
/-EMAX5AS-/ 	    sgemm00_core1(55, 54, 56);
/-EMAX5AS-/ 	    sgemm00_core1(56, 55, 57);
/-EMAX5AS-/ 	    sgemm00_core1(57, 56, 58);
/-EMAX5AS-/ 	    sgemm00_core1(58, 57, 59);
/-EMAX5AS-/ 	    sgemm00_core1(59, 58, 60);
/-EMAX5AS-/ 	    sgemm00_core1(60, 59, 61);
/-EMAX5AS-/ 
/-EMAX5AS-/ 	    /****final*****/
/-EMAX5AS-/ 	    sgemm00_final(61,     62);
/-EMAX5AS-/           }
/-EMAX5AS-/         }
/-EMAX5AS-/       }
/-EMAX5AE-/
